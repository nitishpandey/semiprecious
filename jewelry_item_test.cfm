              ...
              <tr valign="top" >
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="padding:1px" >
	                <tr  valign="middle" >
						...
						<cfif len(cart_msg)>
								<Div id="cart_summary" style=";margin-top:2px;border:2px solid red;padding:2px 1px 1px 1px;">
									<span style="width:460px;display:inline;background-color:##FDFDFD;;padding:2px;color:red;font-size:1.2em;font-weight:bold;">#cart_msg#&nbsp; </span>&nbsp;
									</div> 
					...
					<img   id="mainimage" style="display:inline;" src ='/images/#folder#/#width#/#imagename#'   alt="unique #subcategory# #category# Jewelry"  border="0" />
						  ...
						  <span id="cart_form" >&nbsp;
						  <span class="greenbutton" style="border-bottom: purple 2px outset; border-left: purple 2px outset; background-colo: white; width: 150px; height: 28px; border-top: black 2px outset; top: 8px; font-weight: 800; border-right: purple 2px outset; padding-top: 4px; left: 2px; ">
				...
				style="border-bottom: purple 2px outset; border-left: purple 2px outset; background-colo: whit; width: 200px; height: 28px; border-top: black 2px outset; top: 8px; font-weight: 800; border-right: purple 2px outset; padding-top: 4px; left: 2px; positio: absolute;"
...
--->        
		  ...
		  <cfelse> <!--- if width variable set by cfinvoke add is set to thumb then next column --->
             <!--- End right side? --->
			  <!--- 4th column --->
