...
<CFINCLUDE TEMPLATE="setup.cfm">
		...
		<cfelse>
			<cfif dateformat(now(),"dddd") eq "Sunday" or dateformat(now(),"dddd") eq "Friday"
			or dateformat(now(),"dddd") eq "Thursday">
...
orderbuy, disporder, newitem, CAT, style, subcat, datetaken,  NameID,     price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
   buylink ,  orderprice from (SELECT top 5 0 as orderbuy,  lastbought, restockdate, disporder, newitem, CAT, style, subcat, datetaken,   NameID,     price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
...
orderbuy, disporder, newitem, CAT, style, subcat, datetaken,  NameID,     price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
   buylink ,  orderprice from (SELECT 0 as orderbuy, lastbought, restockdate, disporder, newitem, CAT, style, subcat, datetaken,   NameID,     price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
   buylink , case status when 3 then saleprice else price end as orderprice from items 
   <cfif groupname neq ""> inner join  (select itemid from itemsbyGroup  where groupname='#groupname#') igr on newitem=itemid </cfif> 
				...
				<table align="center" cellspacing="0" border="0" cellpadding="3" style="margin-top:1px;background-color:##FFFFFF;">
					...
					<tr class="greenbutton"  align="center">
						<td colspan=1 align="left" style="border-top:2px ridge #dark#">
							...
							<a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=lastbought'>Purchased by others</a>
							<cfelse>
							<a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=pricedesc'>Premium First</a>
							</cfif>
							
						</td>
						<td style="border-top:2px ridge #dark#">&nbsp;
...
<select name="color" onChange="javascript:submit(this.form);">  <option selected value="">colored</option>
      ...
      <OPTION value="yellow">Yellow</option>
		...
		<cfif subcat neq ""><br>#subcat#</cfif> <cfif #style# contains "silver">92.5% Silver</cfif><br>
			<cfset column = columns />
													<cfswitch expression="#status_array[column]#">
														<cfcase value="1">
															<b><a>Description</a></b>&nbsp;&nbsp;&nbsp;#price_array[column]#&nbsp;&nbsp;<a href='gem_stone_#cat#.cfm/#item_array[column]#.htm' ><b>Zoom</b></a>
															<br /><br>
														</cfcase>
														<cfcase value="0">
															<a>Description</a>&nbsp;&nbsp;&nbsp;#price_array[column]#</font>&nbsp;Sold!
														</cfcase>
														...
														<cfdefaultcase>
															...
															<br /><a href='gem_stone_#cat#.cfm/#item_array[column]#.htm' ><font color="##CC3300">Zoom</font></a>
														</cfdefaultcase>
													</cfswitch>
		</cfsavecontent>
								...
								<div id="div#itemCount#" class="rowb" style="position:absolute; display:none; background-color:white; border:2px solid black; padding:4px;">
									<table cellpadding="2" cellspacing="0" border="0" width=300>
										<tr valign="top">
											...
											<td align="center">
												#smallContent#
														<br><br><span onMouseOver="div#itemCount#.style.display='none';"><a>CLOSE</a></span></BR>
											</td>
											</cfif>
											<td width="300">
											<a href='gem_stone_#cat#.cfm/#item_array[columns]#.htm'>Details/Buy Page</a><br><br>
											<!---
												...
												<div aligh=left class="listdescr">
													...
													<br><br><br><br><br><span onMouseOver="div#itemCount#.style.display='none';"><a><font size=-1>close</font></a></span></BR>			
