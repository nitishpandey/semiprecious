...
<!--- ,<cfoutput>#itemnumber#</cfoutput>
 --->
  ...
  Select storage, imagelink, inventory, price, status, saleprice,clustercount,wholesaleprice, newitem, itemnumber as optcount,description, NameID, newitem, subcat, cat from 
...
<cfif details.storage EQ 'pippin'>
               <img  src ='#details.imagelink#' alt="Cheap #tcase(subcategory)# #Tcase(category)#" border=0>
<cfelse>
               <img width="#width#"  src ='/images/#folder#/<CFIF #NameID# is "">#newitem#.jpg<CFELSE>#NameID#</CFIF>'  alt="Cheap #subcategory# #category#"  border="0">
</cfif>
...
Allow 2-4 weeks for shipping<br>
           ...
           <div id="totalqty" class="" align="center">Can Change Later</div>
			...
			<a href=gemstone_jewelry_gallery.cfm?cat=#category#&subcat=#subcategory#>More <cfoutput>#subcategory# #category#</cfoutput></a>
                <!---                Shop By<br>
                Item No.: <br>
 	...
 	<a href='/jewelry_item.cfm/#nextpos#_#catn#.htm?thiswidth=#width#'  ><img  src="/images/#catn#/thumb/#nextpos#.jpg" border="1"  name="nimg" hspace="0" vspace="0"   alt="Next" height="#variables.ht#"   >
            ...
            <tr valign="bottom" > 
              <td valign="top" align="center"   colspan="1" ><a href="/jewelry_item.cfm/#prevpos#_#catp#.htm"><img border="0" src="/images/prev.gif" hspace="0" vspace="0"   align="absbottom" width="18" height="18" />PREV</a> <!--- <br> <br> <a href="/detailemailer3.cfm?description=#urlencodedformat('visit www.semiprecious.com for more details')#&newitem=#newitem#&cat=#category#&from=#cgi.HTTP_REFERER#" ><font face="Calisto MT" style="bold">Tell 
                a Friend</font></a> ---></td>
              <td align="left" valign="top" > <div align="justify"  >#description#
...
<cfelse>
	...
	<cfif category eq "necklaces"><a href='http://www.qvc.com/jw/jw_necksizeguide.html' class="highlightred">Necklace Size Guide by QVC</a> 
        ...
        <br />
	  	...
	  	<tr><td  align="Left"><cfif stonename NEQ ""><a href='/<cfoutput>#stonename#</cfoutput>.htm'><i>Learn more about this and other semi precious stones</i></a></cfif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  style="color:maroon;font-size:11px;">For more information or to order by phone:<cfoutput>#Application.tollfree#</cfoutput></span></td></tr>
