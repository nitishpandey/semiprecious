...
session_start();
	 	...
	 	$stoneURL="http://www.essentialsjewelry.com/stock/sterling-silver-pendants.html";
		...
		$output = str_ireplace("<br />", "", $output);
		$output = str_ireplace('<h2 style="padding-left:15px;">', '<h2 style="padding-left:15px;height:10;margin:0;padding:0;">', $output);
		$output = str_ireplace('<tr><td></td></tr>', '', $output);
				
		$output = str_replace('class="style11">Individual', 'class="style11" style="position:absolute;left:35%;">Individual', $output);
		...
		$output = str_replace('Essentials Jewelry', 'semipreciouswholesale.com', $output);
...
//		$output = str_replace('id="innercontent", 'id="innercontent;" style="position:absolute;top:150px;"', $output);
		...
		//$output = str_replace('essentialsjewelry.com/stock/', 'semipreciouswholesale.com/silver_gemstone_pendants.php?stone=', $output);
