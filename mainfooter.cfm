...
<a href="/origin_history.htm">History & Origin</a> <br><BR></cfif> 
			...
			<a href='/Jewelry_Free_Shipping.cfm'>Shipping/Return 
              Policy</a> 
		| <a href="http://www.semipreciousWholesale.com">SemipreciousWholesale</a>	</cfif> |
...
=======
<center>
	<a href='http://www.elinamira.com'>
		<img src='/ads/elinamira_curated_jewelry.jpg'>
	</a>
</center>
<br />
<cfif cgi.server_name contains 'wholesale'>
...
<cfelse> <!--- wholesale else block starts here (not wholesale then this part) --->
	<cfif session.tld is '.semiprecious.in'>
		~</div>
	</cfif>
	<cfif session.cartid GT 0>
	...
	<article class="wrapper">
		...
		<footer class="footer">
			<h3>
				Copyright 2015 Semiprecious. All rights reserved.
			</h3>
			<ul>
				<li>
					<a href="/healing_properties.htm">
