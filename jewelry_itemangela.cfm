...
<cfelse>
               <img width="#width#"  src ='/images/#folder#/<CFIF #NameID# is "">#newitem#.jpg<CFELSE>#NameID#</CFIF>'  alt="Cheap #subcategory# #category# Jewelry"  border="0">
</cfif>
    ...
    <cfset catp =	session.filterarray[prevpos][2]>
 	...
 	<a href='/jewelry_item.cfm/#nextpos#_#catn#.htm?thiswidth=#width#'  ><img  src="/images/#catn#/thumb/#nextpos#.jpg" border="1"  name="nimg" hspace="0" vspace="0"   alt="Next" height="#variables.ht#"   >
            ...
            <tr valign="bottom" > 
			  ...
			  <cfif details.storage is 'angela'><a href='designer_jewelry_angela.cfm'>See more by Angela.</a></cfif>
