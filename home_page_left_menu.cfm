...
<cftry>
	...
	<cfif category neq 'chains' and category neq 'brooches'>
		...
		<cfset style="">
		<cfquery name="stonelistpopular" datasource="gemssql"  cachedwithin="#createtimespan(0,10,0,0)#">
						...
						<cfelse>
							<cfif category eq "" or category eq "ALL" or category eq "jewelry">
								<cfif style neq "">
									...
									<li><a  title="Jewelry in #subcat3# semiprecious stone" href="/#lcase(subcat3)#_jewelry.cfm" id="#subcat2#" > <cfelse> <li><a href="/#lcase(subcat3)#.cfm" id="#subcat2#" > </cfif>
								</cfif>
								#subcat2#<cfif style neq "">-#style#</cfif></a></li>
							<cfelse>
								<li>
									<a  title="#category# in #subcat3#"  href='/#subcat3#_#category#.cfm' id="#subcat2#" >
										#subcat2#
									</a>
								</li>
							</cfif>
					...
					<CFIF subcat2 neq "">
						...
						<cfif CGI.PATH_INFO contains "gem-stone-">
							<cfif category eq "" or category eq "ALL">
								<cfif style neq "">
									<li>
										<a  title="#categ# in #subcat3#" href='/#subcat3#_#categ#.cfm?style=#style#' id="#subcat2#" >
										<cfelse>
									<li><a title="#categ# in #subcat3#" href="/#lcase(subcat3)#_#categ#.cfm" id="#subcat2#" >
								</cfif>
