...
<cfoutput>
    ...
    <li><a title="Daily Deals on Semiprecious Jewelry" href="/daily_deals/daily_deals.cfm">Real Deals</a></li>
	<cfloop query="temp_stonelist" startrow="1" endrow="#counter1#">
		<CFIF subcat2 neq "">
			...
			<cfif CGI.PATH_INFO contains "gem-stone-">
             <li>  <a href=" <cfif category eq "" or category eq "ALL">
                    <cfif style neq "">
			...
			/#lcase(subcat3)#_#categ#.cfm"
                ...
                <cfelse>
                    /#subcat3#_#category#.cfm<cfif style neq "">?style=#style#</cfif>"
                </cfif>
                id="#subcat2#" >#subcat2#
                </a>
                </li>
...
<cfloop query="temp_stonelist" startrow="#evaluate(temp_stonelist.recordcount/2+1)#" endrow="#temp_stonelist.recordcount#">
	  ...
	  <li><a href=/rare-stones/rare-gems-<cfoutput>#categ#</cfoutput>.cfm>Other Gemstones</a>
