...
Shipping Discount for Orders over #format(application.retail_free_shipping)# [Free within US].<br />
 ...
 <tr><td colspan=2><a href="cart.cfm?country=usa&checkout=yes">
 <font size=+2>START CHECKOUT</font></a></td></tr></table>
		<cfabort>
		</cfif>
...
<br />		 
   <img src="/images/moreshopping.gif" style="border:2px gray ridge;width:120px;cursor:pointer" onClick="javascript:goProcess('buy more')" > &nbsp;
		...
		<tr ><td colspan=2 align="center">	 <tr ><td colspan=2 align="center">   <img src="/images/moreshopping.gif" style="border:2px gray ridge;width:120px;cursor:pointer" onClick="javascript:goProcess('buy more')" > &nbsp;
				...
				<tr>
                  <td  colspan=2 align="center">
					Shipt to Country:<cfinclude template="/includes/countries_drop_down.htm" />&nbsp;
					</td>
                </tr>
			</cfif>	
              ...
              <cfoutput>
               ...
               <input type=hidden name="zip" value="#session.address.zip#" size="15">
				...
				<tr><td colspan="2" bgcolor="##633096" >&nbsp;</td></tr>
				  ...
				  <tr>
                  <td  align="right"><font size=+1><p>Ship to country:</font></td>
      ...
      <tr>
	    ...
	    <cfoutput>
			...
			<tr><td align=right style="padding-top:4px;"><b> <!--<font size=+1>Grand Total:</font>--></b> </td><td align='left'>
                ...
                <input class="inputtext" name="GrandTotal" type="hidden" id="grandtotal"  value="#decimalformat(subTotal + shipping)#" size="6" maxlength="9"> <span class="green_band" style="padding-top:0px;">Discounts, If Applicable, Will Be Calculated On Confirmation Of Cart &nbsp;&nbsp;</span>
           </cfoutput>     
                <cfset session.grandtotal = subTotal  />
		...
		<input type="submit" style="font-weight:bold;font-size:1.1em;display:inline;cursor:pointer;padding:4px;height:34px;" class="action_button" onlick="javascrip:goProcess('Proceed to Checkout')" value=" Confirm Cart and Select Payment Method&rarr; " />   
		         </cfif>
