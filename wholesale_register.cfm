...
<div  style="width:904px;padding-top:20px;" align="center">
 ...
 <cfif not isdefined("form.state")>
				...
				AND MINIMUM PURCHASE IS REQUIRED.
				  IF YOU ARE NOT A RESELLER, <a class="side_link" href="http://www.semiprecious.com">Buy From our Retail Store</a><p />
				</div>
...
<br>
											              ...
											              <input name="submit" type="submit"   size=20 class="action_button" value="      Register       ">			Already registered? <a class="login_link" href="/simpleloginform.cfm">click here to start shopping</a> 
