...
<CFINCLUDE TEMPLATE="setup.cfm">
		...
		<cfelse>
			<CFPARAM NAME="url.sortorder" DEFAULT="datetakendesc" >
		</cfif>
...
Select disporder, newitem, m.CAT, subcat, datetaken, price, saleprice, status, wholesaleprice,  inventory, storage, thumblink, imagelink,
   buylink from items m, ltbstones s where s.cat = m.cat and s.stone=m.subcat and 
	newitem =(select top 1 newitem from items where cat=m.cat and subcat=m.subcat and inventory>0 and subcat2 is null and subcat3 is null and (STATUS = 0 OR STATUS=3)   <CFIF CATEGORY EQ "ALL"> AND M.CAT <> 'BEADS' AND M.CAT <> 'HEALING'</CFIF> <cfif category neq "all">and m.cat='#category#'</cfif> <CFIF isdefined("session.bulkbuyer.id")> AND (Storage <> 'pippin') and (storage not like 'CM%')</CFIF>
<cfif cgi.server_name IS "www.wholesale-gemstone-jewelry.com" or cgi.server_name IS "wholesale-gemstone-jewelry.com">
And storage <> 'Angela'</cfif>
order by price desc) order by subcat
...
<meta name="description" content='Affordable gem stone necklaces in sterling silver in over 20 semiprecious stones. Semiprecious stones set in silver, or strung with bali silver beads to offer variety for a one stop shoppping convenience.  Some of necklaces are made in USA and some in India.' >
</cfoutput>
...
<tr  class="greenbutton"  align="center"><td colspan=2 align="left" style="border-top:2px ridge #dark#"> <cfif  start GT 1>
		...
		<cfelse>&nbsp;</cfif>[#getlist.recordcount# Designs]</td><td><cfif category is 'necklaces'>Special: <a href=http://www.semiprecious.com/silver_bead_necklaces.cfm>Bali Necklaces</a></cfif></td><td colspan="3" align="center"  valign="middle"  class="greenbutton" style="border-top:2px ridge #dark#">          
...
<b>#subcat# <cfif category is 'all'>Jewelry<cfelse>#category#</cfif></b><br>
          <cfset item_array[columns] = '#newitem#_#cat#_#replace(replace(subcat," ","","All"),",","_","All")#'>
 <a href='gemstone_jewelry_gallery.cfm?subcat=#subcat#&category=#category#' > 
              <img src ='images/#getlist.cat#/thumb/#newitem#.jpg' longdesc="http://www.semiprecious.com/longdesc.cfm?newitem=#newitem#" border='0' bordercolor='black'  name="img#newitem#" title="#subcat# #category#" <cfif category is 'bracelets'>width="100"</cfif>></a>

 </td>
        	<td class="rowb"><cfset column = columns />
			
			<div  class="listdescr">
<a href='gemstone_jewelry_gallery.cfm?category=#category#&subcat=#subcat#'>Show all #subcat# <cfif category is 'all'>Jewelry<cfelse>#category#</cfif></a><p>
<cfif category neq "all"><a href='gemstone_jewelry_gallery.cfm?subcat=#subcat#'>Show all #subcat# Jewelry</a></cfif>
...
<tr bgcolor="white"  >
    ...
    <td align="center" valign="middle"  > 
        <cfinclude template="adminfooter.cfm">
          ...
          <a href='http://www.affiliatecurry.com/affiliate/trackingcode.php?aid=1244&linkid=B11'><img src='http://www.affiliatecurry.com/images/banner1.gif' border='0'></a><cfelse> <cfinclude template="googleadsforlist.htm"></cfif>
             </td> </tr></cfif>
    </table>
