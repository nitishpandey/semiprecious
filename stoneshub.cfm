...
<cfif cgi.server_name contains "semipreciouswholesale">
...
<cfif contentbypage.recordcount GT 0>
  <cfif cgi.server_name contains 'semipreciouswholesale.com'>
    ...
    <cfset metadescription="#lcase(subcat)# jewelry pendants necklaces rings bracelets jewellery beaded and silver, beads and healing crystals. #contentbypage.metadescription#">    <cfset metakeywords="#contentbypage.keywords#">
...
<CFOUTPUT>
  <cfif category is "ALL" or category is "">
    ...
    <cfsavecontent variable="title">
           ...
           Silver and  #titleCase(subcat)#  gem stone #titlecase(p)# in #titleCase(color)#  #style#  
              </cfif>
  </cfsavecontent>
...
<table cellspacing="0" cellpadding="2" border="0" >
  ...
  <td valign="top"  align="left" width="170px"><!--- BEGIN LEFT SIDE STUFF --->
    <cfset leftgemstonedisplay="inline" />
		<cfcache action="serverCache" timespan="5">
  <CFINCLUDE TEMPLATE="leftmenus.cfm"></cfcache>
    <!--- END LEFT SIDE STUFF --->
  </td>
  <td align="right" valign="top" style="border:1px ##DDDDDD ridge;">
  
  <cfset rowsdisplayed = 0>
  <table style="margin-left:0px;text-align:center;horizontal-align:center;margin-top:2px;padding:5px 5px 5px 10px"  border="0" cellspacing="0"  cellpadding="0">
    <!--- stone type image --->
    ...
    <tr>
     ...
     <tr> 
      <td align="left" valign="top" colspan="2" ><cfoutput> <img src="/images/stoneshub/#subcatunspaced#.jpg" style="float:left;padding:10px" > <span style='font-size:10pt;font-family:"Palatino Linotype","serif";color:black'>
          <h1><font color=gray face='verdana'>#ucase(subcat)# <cfif cgi.server_name contains ".in"> JEWELLERY<cfelse> JEWELRY</cfif></h1><cfoutput>#pagedescription#</cfoutput>
    ...
    <cfif pagedescription neq "" or session.mail is 'acemat@vsnl.com'>
      <Tr valign="middle">
        <td valign="middle" style="color:##666600;" class="rowb"  colspan="2">
    ...
    <tr  bgcolor="white">
      <td align="center" height=30  colspan="2"><cfoutput><a href=#subcat3#_jewelry.cfm>SEE RANDOM #subcat# JEWELRY</cfoutput></a></td>
    </tr>
    <!--- End Matt Bayuk - SGM --->
...
<cfset start=1>
 ...
 <cfcache  action="cache" timespan="#createtimespan(0,3,0,0)#">
