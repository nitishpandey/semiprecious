...
<cfinclude template="/includes/getrecordsnotclustered.cfm">
</cfquery>
  <!---<cfcatch type="database">
    ...
    <td class="rowb" style="border-left:0px solid black;" width="20%" valign=top><cfsavecontent variable="smallContent">
	 ...
	 <cfif cgi.server_name contains "wholesale-gemstone-jewelry.com">
        ...
        <br />
           ...
           <font face="arial, verdana" color="##666633" size="2">#IIF(session.desc_flag ,DE(left(description, 70) & ".."),DE("<a href='/gem_stone_#lcase(cat)#.cfm/#item_array[columns]#.htm' class='side_link'>Zoom</a>"))#</font>
		   </cfif>
