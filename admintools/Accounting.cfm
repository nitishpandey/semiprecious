...
<body lang="en-US">
<cfoutput><a href="?month=#evaluate(month-1)#">Previous || </a> <a href="?month=#evaluate(month+1)#"> || Next</a>
#month#</cfoutput>

<cfset commission="0" />
<cfif month GT month(now())>
<table style="border:1 ridge brown;"><tr style="background-color:#DEF;"><td>Channel</td><td>Type</td><td>Gross Sales</td><td>Profit Margin</td></tr>
