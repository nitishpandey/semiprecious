...
<cfquery name=categories datasource=gemssql>
...
<cfquery name=stonecat datasource=gemssql>
...
<cfsilent><!--- color pages --->
 ...
 <!---color-category pages  Priority 1 --->
  <cfset colorlist ="orange,purple,white,pink,red,blue,gray,grey,black,green,brown,yellow,multi-color">
  <cfset catlist ="jewelry,jewellery,beads,necklaces,pendants,earrings,brooches,rings,healing,bracelets">
 ...
 <cfsilent>
 <!---groups  Priority 1 --->
<cfquery name=group datasource=gemssql>
...
<cfquery name=groupcat datasource=gemssql>
...
<cfquery name=items datasource=gemssql>
