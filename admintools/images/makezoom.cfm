...
<cfparam name="imagesize" default="">
...
<body> 
 ...
 <cfif image neq "">
            ...
            select cat from items where newitem=#newitem#
 			 			 ...
 			 			 <cfhttp method="Get" url="#image#" path="d:\inetpub\semiprecious\images\#getcat.cat#" file="#newitem#.jpg">		
						 				 IMAGE UPDATED!
<cfelse>
<a href="javascript:picmeleoApi.open('http://www.semiprecious.com/images/<cfoutput>#cat#/#newitem#</cfoutput>.jpg')">Open Picmeleo editor to re-make zoom</a>

<script type="text/javascript">
	var picmeleo = {
		key: "a96e8f65c24c3f7d782cce281281cea52212",
		receiver: "http://www.semiprecious.com/admintools/images/makezoom.cfm?newitem=<cfoutput>#newitem#</cfoutput>"
	}
</script>
<script type="text/javascript">
