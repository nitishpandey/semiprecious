...
<CFINCLUDE TEMPLATE="/setup.cfm">
 		<cfif cgi.server_name IS "www.wholesale" or cgi.server_name IS "wholesale">
...
// cgi.QUERY_STRING = cgiqstring; 
  ...
  session.gallery = 'list' ;  // used to determine on cart page whether the buyer should be routed to badpics.cfm or gemstone.cfm when he clicks on continue shopping 
...
Select  getdate() as lastbought, case 	when inventory>0 then '0' else '1'
   ...
   buylink ,  orderprice from (SELECT top 8 0 as orderbuy,  lastbought, restockdate, disporder, newitem, CAT, style, subcat, subcat2, datetaken,   NameID,     price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
   buylink , case status when 3 then saleprice else price end as orderprice from items  
	...
	<CFIF cgi.server_name IS "www.wholesale" or session.bulkbuyer.id neq ""> AND WHOLESALEPRICE >0 and (storage not like 'CM%')
	<CFELSE>
	and price>0 
	</CFIF>
	  <cfif subcat is not "">
...
orderbuy, disporder, newitem, CAT, style, subcat, subcat2, datetaken,  NameID,     price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
   ...
   <cfif url.sortorder is "datetaken desc" and subcat is "" and groupname is "" and color is "" and priceless is "" and style is ""> 
   (select top 40 * from items where (1=1)  and <CFIF category NEQ "ALL">
...
<cfif metatitle neq "">#metatitle#<cfelse>
			#titleCase(color)# #titleCase(subcat)# #style#  #titlecase(p)# gem stone  </cfif>
	</TITLE>
	
	<meta name="keywords" content=	<cfif cgi.server_name contains "wholesale">Wholesale </cfif><cfif metakeywords neq "">"#metakeywords#"<cfelse>"Affordable #color# #subcat#, Gem stone,  #p#"</cfif>>
	<meta name="author" content="Anup Pandey" />
	<meta name="description" content= 	<cfif cgi.server_name contains "wholesale">Wholesale</cfif> <cfif metadescription neq "">"#metadescription#"<cfelse>'#subcat# #style# #p# gem stone jewelry, retail and wholesale. <CFLOOP QUERY="Getlist" startrow="#start#"
	...
	<table style="margin-left:0px;width:800px;background-color:##EDEDED;text-align:center;horizontal-align:center;margin-top:2px;"  border="0" cellspacing="0"  cellpadding="0">
		<tr style="width:800px;">
			<td valign="top" align="center" width="800px" nowrap class="grayplacard">
				...
				<cfif len(advancedsearch)><cfelse><!--- Selection:  ---><Cfif isnumeric(priceless)>&nbsp;Around #format(priceless)#<img src="/images/arrow_right.gif" style="display:inline;" border="0" hspace="0" vspace="0" align="absmiddle"  title="jewelry gem stone selection" width="15" height="15" /><a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&priceless=#priceless#&color=#color#&category=pendants" id="pendants_horiz">Pendants</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&priceless=#priceless#&color=#color#&category=rings" id="rings_horiz">Rings</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&priceless=#priceless#&color=#color#&category=Earrings" id="earrings_horiz">Earrings</a>&nbsp;<a href="badpics.cfm?priceless=#priceless#&color=#color#&category=Bracelets&sortorder=#urlencodedformat(sortorder)#" id="bracelets_horiz">Bracelets</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&priceless=#priceless#&color=#color#&category=Necklaces" id="necklaces_horiz">Necklaces</a>&nbsp;
				...
				<cfelseif  color neq "">In #color#<img src="/images/arrow_right.gif" style="display:inline;" border="0" hspace="0" vspace="0" align="absmiddle"  title="jewelry gemstone selection" width="15" height="15" /><a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&color=#color#&category=pendants" id="pendants_horiz">Pendants</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&color=&category=rings" id="rings_horiz">Rings</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&color=#color#&category=Earrings" id="earrings_horiz">Earrings</a>&nbsp;<a href="badpics.cfm?color=#color#&category=Bracelets&sortorder=#urlencodedformat(sortorder)#" id="bracelets_horiz">Bracelets</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&color=#color#&category=Necklaces" id="necklaces_horiz">Necklaces</a>&nbsp;
				<cfelseif  salestatus is 3 ><span style="color:red ;font-size:12px;font-family: Arial;">On Sale</span><img src="/images/arrow_right.gif" style="display:inline;" border="0" hspace="0" vspace="0" align="absmiddle"  title="jewelry gemstone selection" width="15" height="15" /><a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&salestatus=#salestatus#&category=pendants" id="pendants_horiz">Pendants</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&salestatus=#salestatus#&category=rings" id="rings_horiz">rings</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&salestatus=#salestatus#&category=Earrings" id="earrings_horiz">Earrings</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&color=#color#&salestatus=#salestatus#&category=Bracelets" id="bracelets_horiz">Bracelets</a>&nbsp;<a href="badpics.cfm?sortorder=#urlencodedformat(sortorder)#&salestatus=#salestatus#&category=Necklaces" id="necklaces_horiz">Necklaces</a>&nbsp;</cfif><cfif category EQ "All" ><span style="color:maroon;background-color:#light#;font-size=12 px;">All</span>&nbsp;</cfif></cfif>&nbsp;
				</font>
			</td>
		</tr>
	</table>
...
<cfif cgi.server_name does not contain "wholesale" or category eq "beads">
       ...
       <a href="/designer_jewelry_angela.cfm" class="headerfont" id="beads">Best Picks</a> </td></tr><tr><td>
...
<cfif cgi.server_name neq "63.135.126.234">
	...
	<a href="/healing.cfm" class="headerfont" id="healing" title="healing and decorative items">Healing</a>  </td></tr>
		...
		<cfif subcat neq "bulk lots" and (cgi.server_name contains "wholesale" or session.bulkbuyer.id neq "")>
					<tr><td colspan="<cfoutput>#displaycolumns#</cfoutput>" ><a href=index.cfm>HOME PAGE</a>&nbsp;&nbsp;&nbsp;<font color=red><b>FOR BULK LOTS CLICK</b></font>	 <a href=bulklots.cfm>HERE</a></font></td></tr>
		</cfif>
		<cfif category eq "rings">
					<tr><td colspan="<cfoutput>#displaycolumns#</cfoutput>" ><font color=orange><b>All SIZES NOW AVAILABLE IN MOST RINGS (besides the adjustable ones)!</b></font></td></tr>
		</cfif>
					<tr class="greenbutton"  align="center">
						...
						align="center" style="border-top:2px ridge #dark#">
							<cfif start GT 1>
								...
								<a href='badpics.cfm?category=#category#&start=#newstart#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(urldecode(advancedsearch))#&style=#style#&groupname=#groupname#' ><img src="/images/prev.gif" name="prev" hspace="0" vspace="0" height="8"  border="0" align="absmiddle"></a>&nbsp;&nbsp;
							<cfelse>
								&nbsp;
							</cfif>
						<!---		<cfif url.sortorder neq "lastbought desc">--->
							<a href='?category=#category#&sortorder=lastbought'>Most Popular</a> ||
						<!---		<cfelse>--->
							<a href='?category=#category#&sortorder=pricedesc'>Premium </a> || &nbsp;&nbsp;
						<!---	</cfif>--->
											
					<!---	<cfif url.sortorder neq "datetaken desc">--->
							<a href='badpics.cfm?category=#category#&sortorder=datetaken'>New Arrivals</a> || &nbsp;&nbsp;
							<!---<cfelse>--->
							<a href='cheap<cfif category is "All">jewelry<cfelse><cfoutput>-#category#</cfoutput></cfif>.cfm'>Show Cheaper <cfif category is "All">Jewelry<cfelse><cfoutput>#category#</cfoutput></cfif></a> || 
							<!---</cfif>--->
&nbsp;&nbsp;&nbsp;				
	<cfif subcat is "pearl">Pearl and...
<form action="badpics.cfm" name="pearlform" method="get" style="display:inline;">
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href='badpics.cfm?category=#category#&start=#evaluate(start + display)#'><img src="/images/nextlist.gif"  name="next" border="0" align="absmiddle" vspace="0" hspace="0" width="30" ></a>
	<cfelse>	&nbsp;			</CFIF>
						</td>
					</tr>
					...
					<CFIF getList.recordcount is 0>
						<div style="margin-top:10px;border : 1px solid ##ECCCC;	width:607px;text-align:justify;font-size:12px;color:maroon;"> 
							...
							<cfif isdefined("url.relocated")>
								 <!--- To see and order any out of stock items please click here <a href="badpics.cfm?invstatus=-3&color=#color#&category=#category#&subcat=#subcat#&priceless=#priceless#">SEE 
							...
							<form action="" method="post"  style="display:inline;" ><br>
...
-->						
		...
		<br /><img src='/magnify.gif' onClick="javascript:zoomImage('/images/#getlist.cat#/#newitem#.jpg')" width="16" height="16"/>&nbsp;&nbsp;&nbsp;<!---<a href="javascript:showDetails('#itemCount#');">Info</a>---><br><a href='/gem_stone_#cat#.cfm/#item_array[columns]#.htm'>Details /  Buy</a>

		<cfif subcat neq ""><br>#subcat#</cfif><cfif subcat2 neq "">-#subcat2#</cfif> <cfif #style# contains "silver">92.5% Silver</cfif><br>
										...
										<tr valign="top">
											...
											<!---
												...
												<div aligh=left class="listdescr">
														<cfif cgi.server_name contains "wholesale">Wholesale</cfif> #left(description, 700)# 
...
<tr>
			  ...
			  <CFIF start is not "1">
                  <a href='badpics.cfm?category=#category#&start=#newstart#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#&style=#style#&groupname=#groupname#' ><img src="images/prevlist.gif" name="prev"  align="absbottom" border="0" style="display:inline;" width="80" height="31" /></a>
...
&nbsp;</td><td align=left valign="top" colspan="2" border=0> 
    <a name="byprice"></a><span class="category">#p#</span>:  
            <cfinclude template="/searchforms.cfm"/> 
				   ...
				   <a href='badpics.cfm?category=#category#&start=#evaluate(start + display)#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#&style=#style#&groupname=#groupname#' ><img src="images/nextlist.gif"  name="next"  border="0" align="absbottom" style="display:inline;" width="80" height="31"  /></a> 
     	
</CFIF>   </td> </tr> 

<cfif subcat is 'turquoise'><tr><td bgcolor='lightyellow' colspan=5 align=center>For more on turquoise, visit <a href=http://www.TurquoiseJewelry.com>TurquoiseJewelry.com</a></td></tr></cfif>	
<cfif subcat is 'Ruby'><tr><td bgcolor='lightyellow' colspan=5 align=center>
<a href=" http://www.angara.com/shop.do?cID=1890&landing=loose_gemstones"  target="_blank" title="Loose Gemstone" > Loose Gemstones</a> Choose from the exquisite Angara collection of 100% natural gemstones including Ruby, Sapphire, Aquamarine, Tanzanite, Emerald and Citrine  in a variety of shapes.
</td></tr></cfif>	
...
<!---
				   <tr><td colspan="4" align="center"  class="biggreenwhite" >Random Picks from Top  Selling Designs  Shown Below</td>  <td  align="center"><a href='badpics.cfm?category=#category#&start=#evaluate(start + display)#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#&style=#style#&groupname=#groupname#' ><img src="images/nextlist.gif"  name="next" border="0" align="absmiddle" vspace="0" hspace="0"></a></td></tr--->
...
<tr bgcolor="white"  >
      <td align="center" valign="middle"   >&nbsp;  <a href="http://www.myexhibition.com" class="error1" target="artwindow">Host Art Your Work Online</a> </td>
