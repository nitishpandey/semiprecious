      ...
      <Select NAME="material">
	   ...
	   <option value="Copper" >Copper</option>
        <option value="White Metal" >White Metal</option>
				        <option value="Gold Polish" >Gold Polish</option>
        <option value="Gold Plated 925 Silver" >Gold Plated 925 Silver</option>
...
<p>  <INPUT TYPE="button" VALUE="UPDATE" onClick="javascript:verifyinput()"><br>
  ...
  <input type='button' onClick="javascript:calcprices()">  <br>  <td>
  	<!--- Changes By Ankur --->
  	<span
...
</cfif>    &nbsp;&nbsp;&nbsp;<cfoutput>Base Price ($): <span id="basecostus"><CFOUTPUT>#Round((EditItem.BaseCost/58)*100)/100#</CFOUTPUT></span> </cfoutput><br />
    <script language="javascript">
	<!--
	   <cfoutput>
...
&nbsp;    Size:
   ...
   <br> Make On Order? (1 for yes, 0 for no):
    ...
    <br>
  </cfoutput> Current Group(s): <font color=blue><cfoutput query="groupassigned">#Groupname# <a href='deletefromgroup.cfm?grouping=#urlencodedformat(groupname)#&groupdel=#newitem#'>X</a>,</cfoutput></font> Group Item in (submit multiple times to assign to more groups): <br>
