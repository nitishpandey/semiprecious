		<cfif #cgi.server_name# contains "forcesofindia" or #cgi.server_name# contains "semiprecious.in">
...
<cfheader name="Location" value="#newurl#"> 
      ...
      <cfif Find('/', pattern) gt 0>
        <cftry>
          ...
          <cfcatch type="any" >
           ...
           Error line 81 <!---  ERROR CAUTH --->
          </cfcatch>
        </cftry>
      </cfif>
    <cfelse>
        <cfif isdefined("url.itemnumber")><cfset newitem = url.itemnumber>
    ...
    <CFPARAM NAME="wd.height" DEFAULT= "400" />
    ...
    <cfif testing is "yes">
          <CFQUERY datasource="gemssql" name="detailsinmemory" >
              Select material, grouping, itemnumber, size, weight, supplier, style, color, storage,storageindia, imagelink, inventory,
            ...
            <cfelse> 
          <CFQUERY datasource="gemssql" name="detailsinmemory" 		cachedwithin="#createTimespan(0,0,5,0)#">
              Select  material, grouping, itemnumber, size, weight,supplier, style, color, storage,storageindia, imagelink, inventory,
                 orderonrequest, price, status, saleprice,clustercount,basecost, wholesaleprice, newitem, itemnumber as optcount,description,
                  NameID, newitem, subcat, subcat2, cat, morepics from 
              items where cat<>'ornaments'  and (status =0 or status=3)
            ...
            <cfquery name="details" dbtype="query" >
                 ...
                 orderonrequest, price, status, saleprice,clustercount,basecost, wholesaleprice, newitem, optcount,description,
                  NameID, newitem, subcat, subcat2, cat, morepics from 
              detailsinmemory where newitem=#itemnumber# </cfquery>
          ...
          <cfif session.bulkbuyer.id neq ""  >
              ...
              <CFSET invent = details.inventory>
                <cfset description = description & '<p><b>Metal: </b>'  & details.style & ' on/with ' & details.material>
        ...
        <table width="930px" id="container1" cellpadding="0"  cellspacing="0" >
            <tr valign=top>
                ...
                <td valign=top align="center" >
                    <table border="0" cellspacing="0"  bgcolor=white width="928px" cellpadding="0" style="margin-top:0px;" align="left">
                        <tr  valign="top" >
                            <td   valign="top" align="Center" >
                    ...
                    onClick="document.getElementById('cart_form').innerHTML=document.getElementById('easy_form').innerHTML;"  onClik="goProcess('cart summary');return;">&nbsp;<a title="Check Cart and start checkout" href="/#session.cart#?country=#urlencodedformat(session.address.country_code)#&amp;php=1.2210&amp;cartid=#session.cartid#" >Start Checkout &rarr;</a>&nbsp;
                             ...
                             <table border="0">
                                <tr>
                                    <cfif video.recordcount is 1>
																		<td><div id="showvideobutton" onclick="showvideo()"><img src ='/images/#folder#/#newitem#.jpg'  height="70px" border="1" ></div>
																		<div id="playbutton" style="position:relative;top:-40px;left:40px;height:10px;" onclick="showvideo()"><img src="/images/playvideo.gif" height=20px  alt="play video"><br>play video</div>
                                    </td></cfif>
																		<td valign="top">
                        ...
                        <cfif wd.height GTE wd.width and wd.height GT 450>
                          <img height="450px" id="mainimage" style="display:inline;vertical-align:top" src ='/images/#folder#/#width#/#imagename#'   alt="unique #subcategory# #category# Jewelry"  border="0" />
                          <cfelseif wd.width GTE wd.height and wd.width GT 450>
                            <img  width="450px" id="mainimage" style="display:inline;vertical-align:top" src ='/images/#folder#/#width#/#imagename#'   alt="unique #subcategory# #category# Jewelry"  border="0" />
                          <cfelse>
                            ...
                            <h3>#description#</h3>&nbsp;<br>
                                ...
                                <b>Size:</b>
                                    ...
                                    <cfif details.size GT 0 and details.size lt 1 and category is 'rings' and details.storage neq 'Angela' and cgi.server_name does not contain 'wholesale'>
                                                                    ...
                                                                    Pick size from drop down if avaiable 
                                    <cfelse>
																		#details.size#
...
<br>
    ...
    Ships in 6 Days <br><font color=gray size=-1>(50% of our items ship in 48 hrs)</font>
                                    <cfelseif details.storage contains 'inpr'>
    Arrives in 30 Days

    <cfelseif  details.storage contains 'mma' or details.cat eq 'rings'>																
...
union
            ...
            No:                    <input type="RADIO" name="mask" value="N" onClick="javascript:custom_select(#newitem#,'unmask');" >
                      ...
                      <div align="center">
                        ...
                        <CFIF price eq 0 and (len(session.bulkbuyer.id) is 0 )>
                          ...
                          <cfif status eq 0 or status eq 3 >
                            ...
                            <CFIF  status eq 3 and not len(session.bulkbuyer.id)><b> <strike>#format(price)#</strike></b><cfelse>
                                                    <b>#format(price)#</b>
                                                    </cfif>
                            </FONT>
                            </div>
                      ...
                      <div align="center" style="margin:4 0;">
                              <cfif not len(session.bulkbuyer.id)>
                                <CFIF  status eq 3>
                                  <b><font color="red"><cfif details.wholesaleprice eq details.saleprice>CLEARANCE!<cfelse>Mother's Day Sale!</cfif></font>:#format(saleprice)#</b><br />
                                <cfelse>
                                <br />
                                </CFIF>
                              </cfif>
    ...
    <br><a href="http://en.wikipedia.org/wiki/Ring_size">Sizing Guide</a> </cfif>
                                <input style="width:101px;height:22px;margin-top:2px;font-weight:800;" class="action_button_cart" type=submit value="Add to Cart" name="Add to cart">
        <!---                        <img src=/images/addtocart.gif d="a2cb"  onClick="javascript:goProcess('add')" >   --->
                                <input type="button" class="hidden" id="a2cw" value="Wait..." >
                              </cfif>
                              <!--- Angela --->
                             <cfif not len(width)> <INPUT TYPE="button"id="a2w1" style="color:black;width:100px;margin-top:12px;border:1px gray solid;"  onClick="javascript:goProcess('Add to Wish List')" VALUE="Add To Wish List" >
    ...
    Item Not Available.
                    ...
                    <INPUT TYPE="button" class="greenbutton" onClick="javascript:goProcess('Show Next')" VALUE="Show" >--->
                                    ...
                                    than available?<br> Call/email us</font>
                             <cftry>
    ...
    <!--- unclutter the zoom page --->
                      ...
                      <cfif category is  "beads" and len(session.bulkbuyer.id)>
                        <a href="/semiprecious-stone-beads.cfm?category=#category#&subcat=#subcategory#" ><cfoutput>#subcatcatcount.sccount# more #subcategory# #category#</cfoutput></a>
                 ...
                 <!--- End right side? --->
                  <!--- 4th column --->
                     ...
                     <td align="center" ><br><br><br>
										 <cfif video.recordcount is 1>
												 <div id="videodiv" style="position:absolute;top:200px;left:330px;z-index:2;display:none;"><iframe id="videofram" width="480px" height="360px" style="display:none" src="http://www.youtube.com/embed/<cfoutput query=video>#videocode#</cfoutput>?rel=0" frameborder="2" allowfullscreen></iframe>
												 <br><div  style="background-color:black;font-color:red;font-weight:bold;font-face:arial;size:14;"  onclick="hidevideo()"><div style="color:red;">CLICK TO CLOSE VIDEO SCREEN</div></div>
												 </div>
										 </cfif>
                        ...
                        <cfif groupitems.recordcount GT 0 and  len(findGroup.groupname)>
                         ...
                         <cfoutput query="groupitems" >
                                <a href=/detail.cfm?newitem=#itemid#><img src=/images/#category#/thumb/#itemID#.jpg border=0 width=70 height=70></a><br />
                            </cfoutput>
                            <cfoutput>
     ...
     <table border=0 cellpadding=4 style="border-collapse:collapse" width="180px" align="right">
                                    <tr>
                                        <td align=center>
                                            ...
                                            <strong><font size=+1 color=black>Matching Accessories&dArr;</font></strong>
                                        </td>
                                    </tr>
                                        <tr>
                                            <td align="right">
                                    ...
                                    <cfoutput query="getcluster">
                                                <a title="#lcase(subcat)# #lcase(cat)#" href="/jewelry_item.cfm?newitem=#itemid#" >
                                                    <img border=10 bordercolor=white  title="#lcase(subcat)# #lcase(cat)#" alt="#lcase(subcat)# #lcase(cat)#" src="/images/#cat#/thumb/#itemid#.jpg" border=0 height=80 width="80"><br>
                                                </a>
