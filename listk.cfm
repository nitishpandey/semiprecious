...
<cfif category is 'ornaments'>
   ...
   <table  cellspacing="0" cellpadding="1" style="margin-left:93px;display:block;width:707; border-right:1px groove ##666600;border-bottom:1px ridge ##CCCCCC;border-top:1px ridge ##CCCCCC;background-color:##FFFFFF;">
	...
	<CFELSE>
          ...
          <CFIF Edit Is "MAMAMIA">
        	...
        	<td class="row2">  <cfset column = columns /><cfswitch expression="#status_array[column]#">
				  <cfcase value="1">
				  <font color="###l#">
...
<font color="##000099" ><s>#price_array[column]#</s>&nbsp;&nbsp;&nbsp;<a href='detail.cfm/#item_array[1]#.htm' ><b>#status_array[column]#</b></a> </font>
      		   </cfdefaultcase>
				  </cfswitch><br />

		#descr_array[columns]#</td>	
...
<cfif isdefined("url.silverjewelry")>
  ...
  <!---  <script type="text/javascript"><!--
   ...
   --->            </td> </tr></table>
	...
	<table style="position:absolute;top:150px;left:0px;display:inline;border-top:1px black ridge;background-color:##DADAAA" cellspacing="1"  cellpadding="0"><tr align="center" ><td  style="background-color=##DADA99;border-right:1px black ridge;border-bottom:1px black ridge;">
