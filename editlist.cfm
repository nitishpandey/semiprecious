...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
 ...
 <CFPARAM NAME="edit" DEFAULT= "mamamia">
...
<b>Sort or Order by:  <a href='editlist.cfm?category=#GetList.cat#&sortorder=price&subcat=#URLEncodedformat(subcat)#&color=#color#'>Price</a> | <a href='editlist.cfm?category=#GetList.cat#&sortorder=datetaken&subcat=#URLEncodedformat(subcat)#&color=#color#'>New to Old</a> | <CFIF #Evaluate(start + display-1)# LT #GetList.Recordcount#>

<a href='editlist.cfm?category=#GetList.cat#&start=#evaluate(start + display)#&sortorder=#sortorder#&subcat=#URLEncodedformat(subcat)#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#'><b><font size=4>Next</font></b></a></cfif></td><td align=CENTER>
...
<a href='editlist.cfm?category=#GetList.cat#&start=#evaluate(start + display)#&sortorder=#sortorder#&subcat=#URLEncodedformat(subcat)#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#'><b><font size=4>Next</font></b></a>

<CFELSEIF start is not "1">

<a href='editlist.cfm?category=#GetList.cat#&start=1&sortorder=#sortorder#&subcat=#URLEncodedformat(subcat)#&color=#color#&&priceless=#priceless#&pricegreater=#pricegreater#'><b>Show First Page</b></a>
...
<a href='detail.cfm?category=#getList.cat#&newitem=#newitem#&price=#price#&saleprice=#saleprice#&description=#URLEncodedFormat(description)#&newitem=#newitem#'>
<CFELSE>
<a href='detail.cfm?category=#getList.cat#&newitem=#newitem#&price=#price#&description=#URLEncodedFormat(description)#&newitem=#newitem#'></CFIF><font verdana size='2'><b>Zoom/Detail</b></font></a>&nbsp;<CFIF #Edit# Is "MAMAMIA">[#inventory#]<a href='edititem.cfm?newitem=#newitem#'>Edit</a><font color='red'><CFIF #status# is "1">Inactive<cfelseif #status# is "2">Discont.<cfelseif #status# is "4">Free<cfelseif #status# is "3">Sale<cfelseif #status# is "5">Picture</cfif></font></CFIF></font>
...
<CFIF #Evaluate(start + display-1)# LT #GetList.Recordcount#>
<a href='editlist.cfm?category=#GetList.cat#&start=#evaluate(start + display)#&sortorder=#sortorder#&subcat=#URLEncodedformat(subcat)#&color=#color#&&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#'><b><font size=4>>>>>Click here for <i>#evaluate(GetList.recordcount-enddisplay)#</i> <font color=red>more</font></font><b></a>
<CFELSEIF start is not "1">
<a href='editlist.cfm?category=#GetList.cat#&start=1&sortorder=#sortorder#&subcat=#URLEncodedformat(subcat)#&color=#color#'>Show First Page</a>
</CFIF>
</td></tr></table>
