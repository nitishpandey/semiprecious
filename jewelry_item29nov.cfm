...
<BODY BGCOLOR="white" link="black" topmargin='0'   >
<div align="center">
<cfinclude template="headerforlist.cfm">
<h3><cf_steps step="2" /></h3>
 <table border="0"  align='center' width="800"  cellspacing="0"  cellpadding="0" style="background-color:white;margin-top:1px;" >
 ...
 <CFFORM ACTION="/cart.cfm" METHOD="POST" NAME="wishbuy" onSubmit="javascript:goProcess('add');return false;"> 
		<table   cellspacing="0" align="center"  border="0"  style="width:800px;padding-0px;" cellpadding="0">
        <!--DWLayoutTable-->
         <cfoutput>   
			<input type="hidden" name="ajaxcheck" value="#session.ajaxcheck#"  id="ajaxcheck"/>

 <tr valign="top" bgcolor="white"  style="width:800px;" > 
            <td    rowspan="3"   align="center" valign="middle" style="background-color:white;text-align:justify;padding:0px;padding-left:1px;font-weight:bold;"   > 
	...
	<cfelse>
			...
			<cfset width = 350>
             ...
             <div align="center"><img width="#width#"  src ='/images/#folder#/<CFIF #NameID# is "">#newitem#.jpg<CFELSE>#NameID#</CFIF>' alt="100% Satisfaction Guaranteed"  border="0"> <div  align="justify" >#description#</div></div>
			  
            </td>
   <td  align='center' valign="top"   nowrap class="details"  >
  <strong  > Item Id: #newitem# </strong>
  <cftry> 
...
update items set clustercount =  0  where newitem = #details.newitem#
 </cfquery></cfcatch></cftry></td><td rowspan="1" valign="top" align="center"  bgcolor='##ffffff'> <!--- the left blank column of the image tab --->
        <cftry> 	
 ...
 <td valign="top" align="center" colspan="2" nowrap  style="padding-bottom:4px;padding-top:2px" bgcolor="##FFFFFF">
			   <div id="ajaxoutput" align="center" >		  <div class="details" align="left">
	           ...
	           <cfif not isdefined("session.bulkbuyer.id")>  
            	    ...
            	    <CFIF invent LTE 0>
                  <span class="error1">Sold out!</span><br>
              Allow 2-4 weeks for shipping<br>
                </cfif> 	
             <span id="erroraddingitem"  class="hidden" >Add To Cart Failed!</span></div> 
			     <INPUT TYPE="hidden" NAME="bought" VALUE="buy">   
              <CFINPUT  type="text" SIZE="2"  id="quantity" Name="quantity" VALUE="#existqty#" REQUIRED="yes" Message="Please enter quantity" VALIDATE="integer" />&nbsp;<INPUT TYPE="button"  id="a2cb" class="greenbutton" onClick="javascript:goProcess('add')" VALUE="Add to Cart" /><input type="submit" class="hidden" id="a2cw" value="Adding..."  />
    <br><cfif optcount>
                  ...
                  </cfquery><span class="optionsinline"> <select id="optionid" name="optionid"  style="display:inline;backgroun-color:orange;">
                    <cfloop query="opts">
<cfif url.optionid eq opts.optionid>
      <option value="#opts.optionid#" selected>
<cfelse>
      <option value="#opts.optionid#">
</cfif>#description#. Charge $#_valueadd#</option></cfloop>
                  </select></span><br>
<cfelse>
...
Item Not Available.
				Need it? Email us.<br>
				</cfif> <INPUT TYPE="hidden" NAME="cart" VALUE="#cart#">
 ...
 <br>
     ...
     <div id="totalqty" style="display:inline;color:maroon;"  align="center"> </div>
        <br>		</div>
...
<a  href="/wish.cfm"   style="color:black;margin-bottom:8px;">Wish List</a><br /><br>
    ...
    <cfset catp =	session.filterarray[prevpos][2]>
            ...
            <!---                              <cfset imgname ="d:\inetpub\semiprecious\images\#catp#\#prevpos#.jpg">
              ...
              </cfoutput> <td  valign="bottom" align="center"  height="30px" >&nbsp;
 	...
 	<a href='/jewelry_item.cfm/#nextpos#_#catn#.htm?thiswidth=#width#'  ><img  src="/images/#catn#/thumb/#nextpos#.jpg" border="0"  name="nimg" hspace="0" vspace="0"   alt="Next" height="#variables.ht#"   >
								</a></cfoutput>
					<!--- 	<cfelse>
            ...
            <cfoutput>  
              ...
              <td align="justify" valign="top" >&nbsp;&nbsp;&nbsp;<span id="qtyincart" > </span>&nbsp;&nbsp;&nbsp;
	...
	<cfif category eq "necklaces"> <a href='http://www.qvc.com/jw/jw_necksizeguide.html' class="highlightred">Necklace Size Guide by QVC</a> 
      <br /><cfelseif category is 'pendants'>
			...
			</td><td valign="top" align="center"   colspan="1" ><a href="/jewelry_item.cfm/#prevpos#_#catp#.htm" ><img border="0" src="/images/prev.gif" hspace="0" vspace="0"   align="absbottom" width="18" height="18" />Prev</a> <!--- <br> <br> <a href="/detailemailer3.cfm?description=#urlencodedformat('visit www.semiprecious.com for more details')#&newitem=#newitem#&cat=#category#&from=#cgi.HTTP_REFERER#" ><font face="Calisto MT" style="bold">Tell 
                a Friend</font></a> ---></td>
              <td  align='center' valign="top"    nowrap  > 
                <a href="/jewelry_item.cfm/#nextpos#_#catn#.htm?thiswidth=#width#"  style="border:0px;">Next<img  border="0" src="/images/next.gif" hspace="0" vspace="0"  align="absbottom" width="18" height="18" /></a><!--- <br /> <br /> <a href="/gift_certificatenew.cfm?description=visit%20www.semiprecious.com%20to%20know%20more">Gift 
                Certificate </a> ---> </td></cfoutput>
          </tr>
     	    </table> </CFFORM>
		</TD>
      </tr>
	  	<tr><td  align="Left"><a href='/agate.htm'><i>Learn more about this and other semi precious stones</i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  style="color:maroon;font-size:11px;">In case of any problem,query or to order online call 1-512-589-9009</span></td></tr>
...
<div  id="howto" style="visibility:hidden;position:absolute;top:90px;left:120px;color:##666600;background-color:white;z-index:2;width:300px;"><div class="noticebox">
 Enter the number of  pieces (1 or more) you wish to buy  in the text box shown before the 'Add to Cart' button and click on the 'Add to Cart' button. Your cart will be filled by the desired number of this item.  If the item is already there in the cart, the quantity in cart is updated to the number you have just entered. You will get a message of   items' qty in the cart after addition.
<ul><li> <span class="optionsinline">Options</span>:Before adding/changing the quantity please see if any options/modification  are available for the jewelry. 
 ...
 </div><a onClick="MM_showHideLayers('howto','','hide');" style="color:black">Close Help</a>
 <span style="color:red;border:1px maroon dashed;"><br />
Our site uses the latest AJAX web technology for best user experience. Some browser versions may encounter problem.  For help just drop us an email or call us.</span></div>
