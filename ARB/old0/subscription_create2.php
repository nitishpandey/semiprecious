...
<table width="500" align="center" cellpadding="4" cellspacing="0" class="border_configuration">
	...
	<tr align="left" valign="top" bgcolor="f0f0f0"> 
  	...
  	<tr align="left" valign="top" bgcolor="f0f0f0"> 
    	...
    	<td width="361" colspan="2"><?php echo "$".3*$amount; ?></td>
  	</tr>	
...
<?php
	if ($code == "I00001") //Send the user to cfm page, from where he's sent a receipt and inventory indented.
			{
				...
				location.href='http://www.semiprecious.com/ARB/arbmailer.cfm?invoiceNumber=$inVoiceNumber&amount=$amount&subscriptionId=$subscriptionId&email=$email'
				\"></p></p></p></center>";
			}
