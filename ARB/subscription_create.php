...
/* if ($code == "I00001") $x_response = "PENDING";
else $x_response = ""; */

/*mysql_query("REPLACE INTO cartARB VALUES ('$invoiceNumber', now(), '$amount', '$length', '$startDate', '$totalOccurrences', DEFAULT, '$x_response', '$cardNumber_last4',
...
/*
mysql_query("INSERT INTO cartARB (	invoiceNumber, date_time, amount, ARB_length, ARB_startDate, ARB_totalOccurrences,
									ARB_cardNumber, ARB_expirationDate, email, phoneNumber,
									billTo_firstName, billTo_lastName, billTo_address, billTo_city, billTo_state, billTo_zip,
									billTo_country, shipTo_firstName, shipTo_lastName, shipTo_address, shipTo_city, shipTo_state,
									shipTo_zip, shipTo_country )
			VALUES ('$invoiceNumber', now(), '$amount', '$length', '$startDate', '$totalOccurrences', '$cardNumber_last4',
			'$expirationDate', '$email', '$phoneNumber', '$billing_firstName', '$billing_lastName', '$billing_address','$billing_city',
			'$billing_state', '$billing_zip', '$billing_country', '$shipping_firstName', '$shipping_lastName', '$shipping_address',
...
<table width="500" align="center" cellpadding="4" cellspacing="0" class="border_configuration">
	...
	<tr align="left" valign="top" bgcolor="f0f0f0"> 
  	...
  	<tr align="left" valign="top" bgcolor="f0f0f0"> 
    	...
    	<td width="361" colspan="2"><?php echo "$".round(($amount*3), 2); ?></td>
  	</tr>	
 		...
 		if ($code == "I00001")
 			{
 				echo"<tr align=\"left\" valign=\"top\" bgcolor=\"f0f0f0\"> 
  				...
  				mysql_query("REPLACE INTO cartARB (	invoiceNumber, date_time, amount, ARB_length, ARB_startDate, ARB_totalOccurrences,
									ARB_cardNumber, ARB_expirationDate, email, phoneNumber,
									billTo_firstName, billTo_lastName, billTo_address, billTo_city, billTo_state, billTo_zip,
									billTo_country, shipTo_firstName, shipTo_lastName, shipTo_address, shipTo_city, shipTo_state,
									shipTo_zip, shipTo_country, response_result, response_code, response_text, response_subscriptionID, x_response )
							VALUES ('$invoiceNumber', now(), '$amount', '$length', '$startDate', '$totalOccurrences', '$cardNumber_last4',
							'$expirationDate', '$email', '$phoneNumber', '$billing_firstName', '$billing_lastName', '$billing_address','$billing_city',
							'$billing_state', '$billing_zip', '$billing_country', '$shipping_firstName', '$shipping_lastName', '$shipping_address',
							'$shipping_city', '$shipping_state', '$shipping_zip', '$shipping_country', '$resultCode', '$code', '$text', '$subscriptionId', 'PENDING')")
	...
	<tr align="left" valign="top" bgcolor="f0f0f0" > 
    	...
    	<td width="361" colspan="2"><?php
    									...
    									elseif ($code == "E00012")
  											{
  												echo "<b>Order already pending subscription approval.</b><br>
  												<i>".$text."<i></td></tr>";
  											}
	...
	if ($code == "I00001")
			{
				...
				<p><p><input type=\"button\" name=\"Continue\" value=\"CONTINUE\" onClick=\"location.href='http://www.semiprecious.com/ARB/arbmailer.cfm?cart=$cart&invoiceNumber=$invoiceNumber&amount=$amount&subscriptionId=$subscriptionId&email=$email'
				\"></p></p></p></center>";
			}
