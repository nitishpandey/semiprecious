				...
				<tr>
					<td>
						<table id="container3" width="100%" cellspacing="0" cellpadding="0" border="0"  style="padding:0 2px 0 2px" align="center">
							<tr>
								<td valign="top" style="width:<cfif mobile>100%<cfelse>184px</cfif>;">
									...
									<div id="semiprecious_gallery"  >
										...
										<h1 class="form_heading">
											<cfoutput>
												...
												#titlecase(url.style)#
												<cfif len(category) GT 3>
													#titlecase(category)#
												<cfelse>
													Items
												</cfif>
												<cfif pricegreater neq "0">
													Over #format(pricegreater)#
												</cfif>
												<cfif priceless neq "">
													Under #format(priceless)#
												</cfif>
											</cfoutput>
											Designs
										</h1>
										...
										<cfif		((category neq "jewelry" and category neq "All" and (not findnocase(category,GetFileFromPath(GetBaseTemplatePath())))) or (subcat neq "" and (not
											...
											findnocase(color,GetFileFromPath(GetBaseTemplatePath())))))>
											<a class="link reg_price" href=
											<cfoutput>
											...
											<cfif session.cartitem[1][1] is 0>
												...
												<cfif subcat is 'pearl'>
													<font color=gray size="-1">
														Our Pearls are good quality Freshwater Cultured Pearls, come with a 100% money back guarantee.
													</font>
												<cfelse>
													<cfoutput>
														#pagedescription#
						...
						<tr>
							<td>
								<table id="container5"  cellspacing="0" cellpadding="0" border="0"  style="padding:0 2px 0 <cfif mobile>0<cfelse>150</cfif>px" align="center">
									<tr>
										<td>
