...
<cfparam name="multiplier" default="1.3">
...
<cfset newpage1="http://" & cgi.server_name & "/essentials/index.cfm?wholesalejewelry=#getdirectoryfrompath(wholesalejewelry)##page1#">
...
<cfset newcontent=replace(newcontent,oldprice,newprice& '<br><font color=red><b><a href=/faxorder.cfm>SPECIAL SECTION ORDERING</a></b></font>')>
</cfif>
...
<cfset newcontent=replace(newcontent, '<span class="imprtant">Silver Going Down </span> <img src="http://www.essentialsjewelry.com/images/15.gif" width="161" height="56" />','<b><br>All 92.5% Sterling Silver</b>. <font size=+1 color=red><b><font color=red><b><a href=/faxorder.cfm>SPECIAL SECTION ORDERING</a></b></font></font></b>')>
<cfset newcontent=replace(newcontent, '<div id="space"></div>', '<p><b>All 92.5% Sterling Silver</b> <font color=red><b><a href=/faxorder.cfm>SPECIAL SECTION ORDERING</a></b></font>')>
<cfset newcontent=replace(newcontent, '<div id="basenav">', '<p><b>All 92.5% Sterling Silver</b> <font color=red><b><a href=/faxorder.cfm>SPECIAL SECTION ORDERING</a></b></font><div id="basenav"> ')>

<center><div style="position:relative;top:-190px;z-index:3;">
<cfoutput>
  #newcontent#
</cfoutput>
</div>
