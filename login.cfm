			        ...
			        <CFOUTPUT>
			          <CFIF login.recordcount IS "0">
			            ...
			            <CFELSE>
						            ...
						            <div id="container3" >
						            <div class="form_heading">Your Profile &amp; Shopping History</Div>

									<div style="float:left;margin-top:4px;text-align:left;">	Name:					         #login.firstname# [<a href="logout.cfm" style="color:red">Click Here To Logout</a>]<br />
                            						              <cfset session.name = replace(login.firstname,'password','') />
                            						              Email Id:#login.email#<br />
                            									  <cftry>
...
<li>Read the <a href="newsletters/nlviewerwithurlid.cfm?id=#login.nlstatus#&customer=#login.firstname#">latest newsletter</a>. </li>
	...
	TEXT="#wishlist.dateadded#">
         ...
         <cfif buyingrecord.recordcount neq 0>
           ...
           <div align="left"class="grayplacard" style="font-size:1.2em;text-align:left;width:100%">Designs bought or liked by you in the past 1 year </div>
