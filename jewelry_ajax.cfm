...
<cfinclude template="headerforlist.cfm">
 ...
 <INPUT TYPE="button" class="greenbutton" onClick="javascript:goProcess('Add to Wish List')" VALUE="Add To Wish List">
                <br><a accesskey="Z" href="/wish.cfm"  class="wishlist">See Wish List</a>
...
<!-- 			<td background="/images/lg2whitebg.jpg" rowspan="2">&nbsp;</td> -->
   ...
   <table cellspacing="0" cellpadding="0"><Tr><Td align="center">
      <cftry> 	
		...
		<span  class="look">
		<a href="/gemstone.cfm?itemid=#newitem#&type=look" >More Items <br>Like This</a></span>
  </cfif>
			<cfcatch type="any">
...
Allow 2-4 weeks<br>
 for shipping<br>
			     ...
			     <INPUT TYPE="hidden" NAME="bought" VALUE="buy">
                                 <INPUT TYPE="button" class="greenbutton" onClick="javascript:goProcess('add')" VALUE="Add to Cart" /><CFINPUT type="text" class="inputtext" SIZE="2"  id="quantity" Name="quantity" VALUE="#existqty#" REQUIRED="yes" Message="Please enter quantity" VALIDATE="integer" />
           <div id="qtyincart" class="hidden">Can Change Later</div>
