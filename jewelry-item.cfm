...
If you have the jewelry item number handy please fill it and click on 'Details': 
 ...
 <tr valign="top" height=450> 
		...
		<!--   <td rowspan="2" align="left" background="/images/dg2lgbg.jpg">&nbsp;</td> -->
            </td><td    rowspan="3"   align="center" valign="center" height=450  > 
...
<br><a href="/edititem.cfm?newitem=#newitem#"  />EDIT</a>
<cfelse><br>
...
Item Id: #newitem# <br><br>
			...
			<!---		    <cfif session.bulkbuyer.id is "">
				  ...
				  <cfif cgi.server_name neq "63.135.126.234">
						 ...
						 <cfif cgi.server_name contains  "semiprecious.in"> 
						 	   Ships in 24 hrs
							 <cfelse>
							   <cfif details.storage contains 'IN'><b><font color="red">Ships in 6-8 days</b><cfelse><b>Ships within 2 days</font></b></cfif>
							  </cfif>
							   <br>
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	<INPUT TYPE="button"  id="a2cb" class="greenbutton" onClick="javascript:goProcess('add')" VALUE="Add to Cart" /><input type="button" class="hidden" id="a2cw" value="Wait..." />
			 ...
			 <INPUT TYPE="button" id="a2wl" class="greenbutton" onClick="javascript:goProcess('Add to Wish List')" VALUE="Add To Wish List">
				<br>&nbsp;&nbsp;&nbsp;&nbsp;<a accesskey="Z" href="/wish.cfm"  >See Wish List</a><br>

	  <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=http://www.semiprecious.com/viral/tellafriend.cfm?item=#newitem#><img src="../images/speaker.jpg" border="0"></a><br>
...
&nbsp;&nbsp;&nbsp;		<a href="http://www.addthis.com/bookmark.php?v=20" onClick="return addthis_open(this, '', '[URL]', '[TITLE]')" onMouseOut="addthis_close()"><img src="http://s7.addthis.com/static/btn/sm-share-en.gif" width="83" height="16" alt="Bookmark and Share" style="border:0"/></a><script type="text/javascript" src="http://s7.addthis.com/js/200/addthis_widget.js"></script>
<!-- AddThis Button END -->
...
<td align="center"><a onClick="MM_showHideLayers('howto','','show');" style="color:maroon;margin-bottom:2px;"><img src="/images/help.gif" border="0" vspace="0" hspace="0" align="absmiddle" width="43" height="30" /></a></td>              	
    ...
    <cfset catp =	session.filterarray[prevpos][2]>
 	...
 	<a href='/jewelry_item.cfm/#nextpos#_#catn#.htm?thiswidth=#width#'><img  src="/images/#catn#/thumb/#nextpos#.jpg" border="1"  name="nimg" hspace="0" vspace="0"  alt="Next" height="#variables.ht#"   >
		  ...
		  <table><tr><td>  
<img src=/images/#category#/thumb/#newitem#.jpg>
</td><td>
...
<cfoutput>#Ucase(groupname)#</cfoutput></cfloop> <cfif category neq 'healing'>#ucase(left(Category,len(category)-1))#<cfelse>#ucase(category)#</cfif>:</cfif> <CFIF invent LT 1 and details.storage neq 'angela'>This is out of stock, we restock most items within 6 weeks</font></cfif> #description# 
			  <cfif details.size neq "" and details.size GT 0><b>Size:</b>

<cfif details.size LT 100><cfif details.size LT 0.2>Adjustable<cfelse>#details.size# </cfif><cfif category is "necklaces" or category is "bracelets" or category is "bags">inches<cfelseif (category is "pendants"or category is "earrings" or category is "brouches") and details.size LT 5>inches<cfelseif details.size GT 0.2>mm</cfif><cfelse> #Round(evaluate(details.size/25.4))# inches</cfif>  </cfif>
