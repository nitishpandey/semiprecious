	...
	{ 
		for (var x = 0; x < line.length; x++){
		 ...
		 //now get decimal values
			...
			px.style.top = Math.floor(pixel_count/png.width);
			px.style.left = (pixel_count % png.width)-1;
			px.innerText = 	oldhsv.h;
...
<img id="nativeimage"  style="position:absolute;top:0;left:0;" src="data:image/png;base64,#b#" />
