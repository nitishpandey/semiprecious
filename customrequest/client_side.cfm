...
<cfquery name="texture_stone" datasource="sptm">
	select texture, stone from custom_items where imageid = #url.image# 
</cfquery>
...
//	document.getElementById('nativeimage').src = document.getElementById('place').firstChild.src;
	...
	var simg2 = document.getElementById('image2');
	simg.innerHTML = '';
	simg2.innerHTML = '';
	//	limg.innerHTML = '';
...
<img id="nativeimage" onClick="javascript:capture_click(e);"  style="border:1px gray solid;position:absolute;top:0;left:0;" src="images/#url.image#.png" />
	<div style="position:absolute;top:0;left:0;z-index:3;" id="image" >
#texture_stone.texture#
	</div>
    	<div style="position:absolute;top:0;left:0;z-index:5;" id="image2" >
#texture_stone.stone#
	</div>
</div>
</cfoutput>
