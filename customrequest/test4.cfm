	...
	{ 
		for (var x = 0; x < line.length; x++){
		 ...
		 //now get decimal values
			 ...
			 if (((oldhsv.h > 0.38) && (oldhsv.s > 0.09 || oldhsv.v < 245)) && !(_dgb < 10 &&  _drg < 10 && _drb < 10) )
			 {
...
<img id="nativeimage" onClick="javascript:capture_click(e);"  style="position:absolute;top:0;left:0;" src="data:image/png;base64,#b#" />
