...
<CFOUTPUT >
<TITLE style="text-transform:capitalize;">   <cfif category is "ALL" or category is "">    <cfset p = "jewelry">    <cfelse><cfset p = category>   </cfif> #color# #subcat# #p# Semi precious Gem stone Sterling Silver Jewelry and Jewels </TITLE>
...
<CFINCLUDE TEMPLATE="headerforgemstone_jewelry_gallery.cfm"> 
	  <cfif isdefined("url.silverjewelry")>
			  ...
			  <cfquery dbtype="query" name="Getlist2">
			  select Getlist.* from Getlist where  Getlist.subcat like '%silver%' or Getlist.subcat like '%vermeil%' 
			  </cfquery>
				  			  <cfelse>
			  <cfquery dbtype="query" name="Getlist2">
...
</td><td width="612px" align="center" valign="top" style="border:1px ##DDDDDD ridge;"><table id="infotable" align="center" cellspacing="0"  cellpadding="1">
...
<cfset rowsdisplayed = 0>
   <table align="center" cellspacing="1" cellpadding="3" style="margin-top:1px;background-color:##FFFFFF;">
<tr  class="greenbutton" align="center"><td align="left"> <cfif  start GT 1>
		...
		<cfelse>&nbsp;</cfif>[#getlist.recordcount# Designs]</td><td colspan="2" align="center"  valign="middle"  class="greenbutton" >          
		<cfif find('price',url.sortorder)>
<a href='gemstone_jewelry_gallery.cfm?priceless=#priceless#&#sj#&category=#category#&sortorder=datetaken&subcat=#subcat#&color=#color#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#'><font color="#dark#">Latest Additions</font></a><cfelse><a href='gemstone_jewelry_gallery.cfm?priceless=#priceless#&#sj#&category=#category#&sortorder=price&subcat=#subcat#&color=#color#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#'><font color="#dark#">Sort On Price</font></a></cfif>&nbsp;&nbsp;&nbsp;<a href="##" onMouseDown="ShowHide('jumpstart'); return false;" style="color:#dark#;">Index To Pages</a>
</td><td align="right"><CFIF #Evaluate(start + display - 1)# LT #GetList.Recordcount#><!--- #Ceiling(evaluate(GetList.recordcount-enddisplay)/9)# --->
...
#session.mail#,#cgi.QUERY_STRING# .
  ...
  <cfset salestatus = 3>
      ...
      where (1=1       <cfif advancedsearch is "">
        and (CAT = '#category#' 
         )
      </cfif>
      <CFIF salestatus is 3>
...
<a href="np/match/cluster.cfm?list=1&target=#newitem#&category=#cat#">Ad2Clus</a>
			...
			<cfswitch expression="#status_array[column]#">
				  ...
				  <br /><a href='jewelry_item.cfm/#item_array[column]#.htm' ><font color="##CC3300">Buy</font></a>
                    </cfcase>
               <cfdefaultcase >
			   <a href='jewelry_item.cfm/#item_array[column]#.htm'  > 
...
<br /><a href='jewelry_item.cfm/#item_array[column]#.htm' ><font color="##CC3300">Buy</font></a></cfdefaultcase>
				  </cfswitch><div  align="justify"  class="listdescr">#description#</div></td>	
	...
	<td class="rowb" colspan="2">&nbsp;</td></tr> </cfloop>
 <cfset rowsdisplayed = rowsdisplayed + 1>
	</cfif>
<tr> 
              <td align=center valign="top" colspan="4" border=0> 
			  <CFIF start is not "1">
                  <a href='gemstone_jewelry_gallery.cfm?#sj#&category=#category#&start=#newstart#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#' ><img src="images/prevlist.gif" name="prev"  align="absbottom" border="0" style="display:inline;" /></a>
    ...
    <a name="byprice"></a><span class="category">#p#</span>:  
            <cfinclude template="searchforms.cfm"/>     &nbsp;&nbsp;&nbsp;&nbsp;
                  <CFIF #Evaluate(start + display-1)# LT #GetList.Recordcount#>          <!---  <b> <font size=4><i>(#evaluate(GetList.recordcount-enddisplay)# More)</i>/font></b> ---> 
				   <a href='gemstone_jewelry_gallery.cfm?#sj#&category=#category#&start=#evaluate(start + display)#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#' ><img src="images/nextlist.gif"  name="next"  border="0" align="absbottom" style="display:inline;"  /></a> 
     				<cfelse>
...
<strong><span class="" title="some random jewelry designs">Designs</span><br /><span class="" title="suggested jewelry to make sets"> &amp; Sets</span></strong></td></tr> 
 <tr><td class=""><a href="showearrings.cfm"><u>earrings</u></a></td>
<tr><td class=""><a href="showbracelets.cfm" ><u>bracelets</u></a></td></tr>
 <tr><td class=""><a href="showpendants.cfm"><u>pendants</u></a></td></tr>
 <tr><td class=""><a href="shownecklaces.cfm"><u>necklaces</u></a></td></tr>
...
<tr><td bgcolor="white">		<a href="jewelry_item.cfm"  >By Item No.</a><br>
</td></tr>		 
<tr><td bgcolor="white"><a  href="#byprice" >By Price</a><br>
</td></tr>		  <tr><td class="category" align="right" bgcolor="white"><cfif subcat is "pearl">Pearl and...<br>
...
Stone<cfelse><a href="apply.cfm">Sign Up</a></cfif><br>
</td></tr>
