...
<cfif form.paymode is "pp">
  <Cfquery datasource="gemssql" name="updatePayment">
    update cartstatus set paymode='pp' from cartstatus where cartid = #cartid# 
    </Cfquery>
...
<cfif isdefined("cartid")> 
 <cfif  url.couponcode eq 'young'>
  ...
  <tr> 
    <td align='left' bgcolor='white' colspan=3><img src='images/header.gif' width="309" height="57"></td>
  </tr>
</Table>
...
<cfoutput>    <tr> 
	...
	<CFQUERY DATASOURCE="gemssql" NAME="pippin">
      ...
      <tr onMouseOver="this.className='wishlist';" onMouseOut="this.className='table_row_';" > 
        ...
        <td> <cfif solditems.affiliateid neq 'regwsale'><cfif status is 3> <span class="error" >Sale!</span><br>
		<s>#decimalformat(price)#</s></cfif>
          ...
          <cfif solditems.affiliateid eq 'regwsale'>
            ...
            <cfelse>
            #dollarformat(price)# </cfif></div> ---></td>
        <td> <cfif optionid>
...
<cf_optiondetails option="#optionid#"  newitem='#itemid#' /></span></cfif><cfif storage is 'pippin' or storage is 'Angela'><b>WILL ARRIVE SEPARATELY<b><br></cfif> #description# </td>
        <td  ><a href="whensold.cfm?newitem=#itemid#" title="inventory is 10 less than qty shown here!" class="white">#inventory#</a><span class="inventory#inventory#" >[ ]</span>#storage#</td>
      </tr>
  ...
  <cftry>
   <cfset totalqty = totalqty + quantity />
    <cfset totalamount=rate*quantity + totalamount>
	 ...
	 <cfoutput>#dollarformat(totalamount*fraction)# (not including shipping).       <cfif solditems.affiliateid eq 'regwsale'><b>shipping:</b>$7.50</cfif> <strong> No. of Items:</strong> #totalqty#.</Td></tr>
	<tr><td>   ===================================================== </td></tr>
...
<span style="margin-left:50px;display:block;text-transform:capitalize;">
  ...
  <cfform action='itemsell.cfm' method="post">
    <table width="88%" border="1">
	 ...
	 <option value="pp">PayPal payment done</option>
