 ...
 <!-- header.cfm starts (including the html tag) -->
	...
	<head>
		...
		<cfelse>
			...
			<cfif getbasetemplatepath() contains 'index.cfm'>
			...
			<cfelse>
				<cfoutput>
					<article class="wrapper">
						...
						>
							<a href="/">
						<span class="logo"> SemiPrecious </span></a>  <cfif !mobile><h4 style="border: 1px blue solid"> Shipped Worldwide <br> Free US Shipping Over $ <cfoutput> #Application.retail_free_shipping# </cfoutput> </h4> </cfif>
