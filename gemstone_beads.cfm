...
Select disporder, newitem, m.CAT, subcat, datetaken, price, saleprice, status, wholesaleprice,  inventory, storage, thumblink, imagelink,
   buylink from items m, ltbstones s where s.cat = m.cat and s.stone=m.subcat and 
	newitem =(select top 1 newitem from items where cat=m.cat and subcat=m.subcat and inventory>0 and (STATUS = 0 OR STATUS=3)  AND M.CAT ='BEADS' order by datetaken desc )
	order by subcat
...
Wholesale Gemstone Beads Semiprecious Stone Beads</TITLE>
<meta name="keywords" content="Wholesale gem stones, beads, semiprecious beads, bulk beads, loose beads, lose beads">
<meta name="author" content="Anup Pandey" />
<meta name="description" content='wholesale gem stone beads and semiprecious stone beads from around the world. Loose cabachone and Faceted beads, large beads, small beads, briolletes we have them all. Bulk pricing, minimum purchase only $50.' >
</cfoutput>
...
<BODY  topmargin="0">
<div align="center">
Gemstone beads and semiprecious stones from around the world.  Sign up for newsletters, sales, specials.
...
<!---<span style="color:black;font-weight:bold;text-transform:capitalize;font-size:11px;">#p# <img src="/images/arrow_down.gif" style="display:inline;" border="0" hspace="0" vspace="0" align="absmiddle"  title="jewelry gemstone selection" /><br /></span>
...
<cfset rowsdisplayed = 0>
   <table border=0 align="center" cellspacing="0" cellpadding="3" style="margin-top:1px;background-color:##FFFFFF;">
   <cfif category is 'beads'>
<tr><td colspan=5><font size=+1>Minimum Purchase for Beads is $50 due to the prices we offer<br>
Over 900 wholesale gemstone and semiprecious bead strands at only $50 minimum purchase.  Enter each stone gallery by using the links below. Each link leads into section for bead strands of that stone. On the right is beads by color! On the left beads by price. There are faceted beads and large beads in each gallery</td></tr>
</cfif>
<tr  class="greenbutton"  align="center"><td colspan=2 align="left" style="border-top:2px ridge #dark#"> <cfif  start GT 1>
    	 <cfset newstart = start - display>
		 <cfif newstart LT 1>
		 <cfset newstart = 1>
         </cfif>
		<a href='gemstone_necklace.cfm?#sj#&category=#category#&start=#newstart#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(urldecode(advancedsearch))#&style=#style#' ><img src="images/prev.gif" name="prev" hspace="0" vspace="0" height="18"  border="0" align="absmiddle"></a>&nbsp;&nbsp;
		<cfelse>&nbsp;</cfif>[#getlist.recordcount# Designs]</td>
		<td style="border-top:2px ridge #dark#">&nbsp;<cfif category is 'necklaces'>Special: <a href=http://www.semiprecious.com/silver_bead_necklaces.cfm>Bali Necklaces</a></cfif></td>
		<td colspan="2" align="center"  valign="middle"  class="greenbutton" style="border-top:2px ridge #dark#">          
		<cfif find('price',url.sortorder)>
<a href='gemstone_jewelry_gallery.cfm?priceless=#priceless#&#sj#&category=#category#&sortorder=datetaken&subcat=#subcat#&color=#color#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#'><font color="black">Latest Additions</font></a><cfelse><a href='gemstone_jewelry_gallery.cfm?priceless=#priceless#&#sj#&category=#category#&sortorder=price&subcat=#subcat#&color=#color#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#'><font color="black">Sort On Price</font></a></cfif>&nbsp;&nbsp;&nbsp;<a href="##" onMouseDown="ShowHide('jumpstart'); return false;" style="color:black;">Pages</a>
 
<CFIF #Evaluate(start + display - 1)# LT #GetList.Recordcount#><!--- #Ceiling(evaluate(GetList.recordcount-enddisplay)/9)# --->
&nbsp;&nbsp;&nbsp;&nbsp;<a href='gemstone_necklace.cfm?#sj#&category=#category#&start=#evaluate(start + display)#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#&style=#style#' ><img src="images/nextlist.gif"  name="next" border="0" align="absmiddle" vspace="0" hspace="0" width="80" height="31"></a><cfelse>&nbsp;</CFIF>
</td></tr>
...
--->
  ...
  <cfset salestatus = 3>
	  ...
	  <CFLOOP QUERY="Getlist"		startrow="#start#"	endrow="#enddisplay#">
        ...
        <td class="rowb" valign=top align=center> 
          <cfif inventory GT 0 >
 ...
 <table border=2><tr height=120><td height=120>
 <a href='semiprecious-stone-beads.cfm?subcat=#subcat#' > 
              <img src ='images/#getlist.cat#/thumb/#newitem#.jpg' longdesc="http://www.semiprecious.com/longdesc.cfm?newitem=#newitem#"  border=0 name="img#newitem#" title="#subcat# #category#" width="120"></a><br>
</td></tr></table>
              <a href='semiprecious-stone-beads.cfm?subcat=#subcat#'>Enter #subcat# Gallery</a> <cfif category is 'all'>Jewelry<cfelse><cfif category is 'beads'><cfelse>#category#</cfif></cfif></b>
...
&nbsp;&nbsp;&nbsp;&nbsp;
    <a name="byprice"></a><span class="category">#category#</span>:  
            <cfinclude template="searchforms.cfm"/>     &nbsp;&nbsp;&nbsp;&nbsp;
