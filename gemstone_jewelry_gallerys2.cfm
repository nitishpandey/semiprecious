...
<select name="color" onChange="javascript:submit(this.form);">  <option selected value="">colored</option>
      ...
      <OPTION value="yellow">Yellow</option>
		...
		<cfif subcat neq ""><br>#subcat#</cfif><cfif getlist.subcat2 neq "">#subcat2#</cfif> <cfif #style# contains "silver">92.5% Silver</cfif><br>
			<cfset column = columns />
													<cfswitch expression="#status_array[column]#">
														...
														<cfdefaultcase>
															...
															<cfif not isdefined("session.bulkbuyer.id")>
																<a href='http://www.wholesale-gemstone-jewelry.com'>wholesale here</a>
																					</cfif>
		</cfsavecontent>				
