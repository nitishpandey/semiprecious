...
--->
<cfset header = '<table width=100% bgcolor="##bbbbFc" ><tr><td valign=top><font size="+3">Young Unlimited Jewelry</font><br />
<em>Authorize.Net Secure Payment Gateway</em></td></tr>	</table>' />
<cfset footer = '<table bgcolor="##bbbbfc" width="100%"><tr><td>In case of  any problem please call us or email us.<br /><a href="http://www.youngems.com/">More Shopping?</a></td></tr></table>' />
...
<FORM ACTION="https://secure.authorize.net/gateway/transact.dll" method="post" name="simForm"  style="display:inline;"> 
      ...
      <cfset session.cartid = application.cartid >
		...
		<input type="hidden" name="x_invoice_num" value="young<cfoutput>#session.cartid#</cfoutput>">
		<input type="hidden" name="x_method" value="CC" >
				<input type="hidden" name="x_header_html_payment_form" value='<cfoutput>#header#</cfoutput>' >
								<input type="hidden" name="x_footer_html_payment_form" value='<cfoutput>#footer#</cfoutput>' >
		<input type="hidden" name="x_type" value="AUTH_CAPTURE" >
		<cfif session.mail is "">
		<input type="hidden" name="x_description" value="Young online jewelry">
		<cfelse>
