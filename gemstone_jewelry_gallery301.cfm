...
<cfset newurl= "http://www.#CGI.SERVER_NAME##CGI.SCRIPT_NAME#?#CGI.QUERY_STRING#">
<cfelse>
<cfset newurl= "http://www.#CGI.SERVER_NAME##CGI.SCRIPT_NAME#">
</cfif>
<cfheader statuscode="301" statustext="Moved permanently">
<cfheader name="Location" value="#newurl#"> 
</cfif>

<cfsilent><cfparam name="metatitle" default="">
...
<cfelseif cgi.server_name contains "semiprecious.in">
 ...
 </cfif><!--- <cfcache action="clientcache"  protocol="http://" timespan="#createtimespan(0,1,0,0)#"> --->
...
<cfif category is 'beads'><cfset displayrows=7><cfset displaycolumns="4"></cfif>
<CFSET CATEGORY2=CATEGORY>

<CFPARAM NAME="subcat" DEFAULT= "">
<CFPARAM NAME="subcat2" DEFAULT= "">
<cfif subcat contains "smokey" or subcat contains "smoky"><cfset subcat ="smoky quartz"></cfif>
...
<cfsilent> 
<cfif category eq 'All'><cfset categ='jewelry'></cfif>
...
<CFOUTPUT>
	...
	<cfif metatitle neq "">#metatitle#<cfelse><cfif cgi.server_name contains 'wholesale-gemstone-jewelry.com'> Wholesale</cfif>
			#titleCase(color)# #titleCase(subcat)# #style# Gemstone #titlecase(p)#</cfif>
	</TITLE>
...
<cfif cgi.server_name does not contain "wholesale-gemstone-jewelry.com">
			...
			<table cellpadding="0" cellspacing=0>
											<tr bgcolor="##FFFFCC" bordercolor="##996600" align=left><td  align=left colspan="3">
...
<Tr valign="middle">
								<td valign="middle" style="color:##666600;" class="rowb" colspan=<cfoutput>#displaycolumns#</cfoutput>> 
<center><div name="wholesalebanner" > <font color=red size=2><b>WHOLESALE BUYERS MUST LOGIN FOR WHOLESALE PRICES</b></font></div></center></td></tr>
...
<CFIF jewelrysize neq "">&jewelrysize=#jewelrysize#</CFIF>
<cfif advancedsearch neq "">&advancedsearch=#URLEncodedformat(advancedsearch)#</cfif><cfif url.style neq "">&style=#url.style#</cfif><cfif groupname neq "">&groupname=#groupname#</cfif>' ><img src="/images/prevlist.gif" name="prev"  align="absbottom" border="0" style="display:inline;" width="80" height="31" /></a>&nbsp;&nbsp;
							<cfelse>
								&nbsp;
							</cfif>
							...
							<b><a href='/gemstone_jewelry_gallery.cfm?category=#category#&sortorder=lastbought'>Popular #categ#</a> ||
											

							<a href='/latest-#categ#.cfm'>New #categ#</a> || &nbsp;&nbsp;

							<a href='/cheap-#categ#.cfm'>Affordable</a> ||  &nbsp;&nbsp; <b><a href='/gemstone_jewelry_gallery.cfm?category=#category#&sortorder=storage'>Ships in 24 hr</a>  <i>#getlist.recordcount# Items, 20 per page</i></b>
...
&nbsp;&nbsp;&nbsp;&nbsp;<!---<a href='#currentfile#?category=#category#&start=#evaluate(start + display)#<cfif url.sortorder neq "">&sortorder=#url.sortorder#</cfif><cfif subcat neq "">&subcat=#subcat#</cfif><cfif color neq "">&color=#color#</cfif><cfif priceless neq "">&priceless=#priceless#</cfif><cfif pricegreater neq "">&pricegreater=#pricegreater#</cfif>
<CFIF jewelrysize neq "">&jewelrysize=#jewelrysize#</CFIF><CFIF salestatus neq "">&salestatus=#salestatus#</CFIF><cfif advancedsearch neq "">&advancedsearch=#URLEncodedformat(advancedsearch)#</cfif><cfif style neq "">&style=#style#</cfif><cfif groupname neq "">&groupname=#groupname#</cfif>' ><img src="images/nextlist.gif"  name="next" border="0" align="absmiddle" vspace="0" hspace="0"></a>--->
	<cfelse>	&nbsp;			</CFIF>
</td><td style="border-top:2px ridge #dark#">

<form action="gemstone_jewelry_gallery.cfm"> <input name="advancedsearch" type="text" size="20" /><input type="submit" name="submit" value="Search"></form>

						</td>
					</tr>
<cfif subcat is "">
<tr><td align="right" colspan="<cfoutput>#evaluate(displaycolumns)#</cfoutput>">
...
<cfinclude template="includes/searchearringdropdowns.cfm">
					...
					<cfif inventory GT 0><cfset itemlist=listAppend(itemlist, newitem)></cfif>
...
--->						
						<td class="rowb" style="border-left:0px solid black;" width="20%" valign=top>
							<cfsavecontent variable="smallContent">
								...
								<cfif getlist.storage EQ 'Pippin'>
									<a href=gem_stone_#cat#.cfm/#item_array[columns]#.htm>
										<img src ="#thumblink#" longdesc="http://www.semiprecious.com/longdesc.cfm?newitem=#newitem#" border='0' bordercolor='black'  name="img#newitem#" title="#subcat# #cat#" <cfif category is 'bracelets'>width="100"</cfif>>
									</a>
								<CFELSE>
									<table border=0><tr valign=top><td valign=top height="150" align=center>
									<a href='gem_stone_#cat#.cfm/#item_array[columns]#.htm'>
...
<!---		<img src ='images/#getlist.cat#/thumb/#newitem#.jpg' longdesc="http://www.semiprecious.com/longdesc.cfm?newitem=#newitem#" border='0' bordercolor='black' onClick="javascript:zoomImage('/images/#getlist.cat#/#newitem#.jpg')">		--->
											<table border=0><tr valign=center><td valign=center height="130" align=center>
		<a href='/gem_stone_#cat#.cfm/#item_array[columns]#<cfif grouping neq "">_#grouping#</cfif>.htm'><img src ='/images/#getlist.cat#/thumb/#newitem#.jpg' longdesc="http://www.semiprecious.com/longdesc.cfm?newitem=#newitem#" border='0' bordercolor='black'></a>
		</td></tr>
		<!---<img src='magnify.gif'  onClick="javascript:zoomImage('/images/#getlist.cat#/#newitem#.jpg')"/>&nbsp;&nbsp; <a href="javascript:showDetails('#itemCount#');">Info</a><br><a href='/gem_stone_#cat#.cfm/#item_array[columns]#.htm'>Details / Buy</a>--->
		<tr><td align=center valign=top>
		<a href='/gem_stone_#cat#.cfm/#item_array[columns]#<cfif grouping neq "">_#grouping#</cfif>.htm'><cfif subcat neq ""><br>#subcat#</cfif><cfif subcat2 neq ""> #subcat2#</cfif><cfif grouping neq ""> #grouping#</cfif> <cfif category neq 'healing' and categ neq 'jewelry'>#lcase(cat)#<cfelse>#lcase(categ)#</cfif></a><br><cfif #style# contains "silver">Sterling Silver</cfif></td></tr></table>
			<cfset column = columns />
	<cfif inventory gt 0>
			
			<font color=gray><cfif cgi.server_name contains "semiprecious.in">
			24 hr Ship. <cfelse>
			<cfif getlist.storage contains 'IN-'>6-8 days ship<cfelse>can ship in 24 hr</cfif></cfif></font></cfif><br>
			<font face="arial, verdana" color="##666633" size="2">#left(description, 70)#</font>..
													<cfswitch expression="#status_array[column]#">
														...
														<cfdefaultcase>
															...
															<br />Promotional Pricing Limited Time
														</cfdefaultcase>
													</cfswitch>
		</cfsavecontent>				
								...
								<div id="div#itemCount#" class="rowb" style="position:absolute; display:none; background-color:white; border:2px solid black; padding:4px;">
									<table cellpadding="2" cellspacing="0" border="0" width=300>
										<tr valign="top">
											...
											<td width="300">
											<a href='/gem_stone_#lcase(cat)#.cfm/#item_array[columns]#.htm'>Buy</a><br><br>
											<!---
												...
												<div aligh=left class="listdescr">
													...
													<br><br><br><a href='/gem_stone_#lcase(cat)#.cfm/#item_array[columns]#.htm'>Buy</a><br><br><span onMouseOver="div#itemCount#.style.display='none';"><a><font size=-1>close</font></a></span> 
...
<tr><td valign=bottom bgcolor=white colspan="#displaycolumns#" border=0>
</cfoutput><cfinclude template="includes/pagelist.cfm"></td></tr>
			<cfoutput>		
<tr>
						<td align=right valign="top" colspan="#displaycolumns#" border=0> 

			  <CFIF start is not "1">
                <a href='#currentfile#?category=#category#&start=#newstart#<cfif url.sortorder neq "">&sortorder=#url.sortorder#</cfif><cfif subcat neq "">&subcat=#subcat#</cfif><cfif color neq "">&color=#color#</cfif><cfif priceless neq "">&priceless=#priceless#</cfif><cfif pricegreater neq "">&pricegreater=#pricegreater#</cfif><CFIF jewelrysize neq "">&jewelrysize=#jewelrysize#</CFIF><CFIF salestatus neq "">&salestatus=#salestatus#</CFIF><cfif advancedsearch neq "">&advancedsearch=#URLEncodedformat(advancedsearch)#</cfif><cfif url.style neq "">&style=#url.style#</cfif><cfif groupname neq "">&groupname=#groupname#</cfif>' ><img src="/images/prevlist.gif" name="prev"  align="absbottom" border="0" style="display:inline;" width="80" height="31" /></a>
...
&nbsp; 
    <a name="byprice"></a><span class="category">#p#</span>:  
                 ...
                 <CFIF #Evaluate(start + display-1)# LT #GetList.Recordcount#>          <!---  <b> <font size=4><i>(#evaluate(GetList.recordcount-enddisplay)# More)</i>/font></b> ---> 
				   <a href='#currentfile#?category=#category#&start=#evaluate(start + display)#<cfif url.sortorder neq "">&sortorder=#url.sortorder#</cfif><cfif subcat neq "">&subcat=#subcat#</cfif><cfif color neq "">&color=#color#</cfif><cfif priceless neq "">&priceless=#priceless#</cfif><cfif pricegreater neq "">&pricegreater=#pricegreater#</cfif><CFIF jewelrysize neq "">&jewelrysize=#jewelrysize#</CFIF>
<CFIF salestatus neq "">&salestatus=#salestatus#</CFIF><cfif advancedsearch neq "">&advancedsearch=#URLEncodedformat(advancedsearch)#</cfif><cfif url.style neq "">&style=#url.style#</cfif><cfif groupname neq "">&groupname=#groupname#</cfif>' ><img src="/images/nextlist.gif"  name="next"  border="0" align="absbottom" style="display:inline;" width="80" height="31"  /></a> 
     				<cfelse>
...
<!---
	<center>
<cfinclude template="/googleadsforlist.htm"></center>--->
 </BODY>
</HTML>
