...
<cfsilent>
	...
	<cfquery name="contentbypage" datasource="gemssql" cachedwithin="#createtimespance(0,2,0,0)#"  >
...
<cfsavecontent variable="inheader">
	...
	<cfsavecontent variable="jsandcss">
									...
									<table>
										<tr>
											<cfif cgi.http_user_agent contains 'MSIE'>
												<cfset msie_or_not =	"right" />
											<cfelse>
												<cfset msie_or_not = "center" />
											</cfif>
												<td align="#msie_or_not#" >
