...
<cfif metatitle neq "">#metatitle#<cfelse>
	...
	<meta name="keywords" content=	<cfif cgi.server_name contains "wholesale-gemstone-jewelry.com">Wholesale </cfif><cfif metakeywords neq "">"#metakeywords#"<cfelse>"Affordable #color# #subcat#, Gem stone,  #p#"</cfif>>
	<meta name="author" content="Anup Pandey" />
	<meta name="description" content= 	<cfif cgi.server_name contains "wholesale-gemstone-jewelry.com">Wholesale</cfif> <cfif metadescription neq "">"#metadescription#"<cfelse>'#subcat# #style# #p# gem stone jewelry, retail and wholesale. <CFLOOP QUERY="Getlist" startrow="#start#"
		...
		<cfif category eq "rings">
					...
					<tr class="greenbutton"  align="center">
						...
						<!---		<cfif url.sortorder neq "lastbought desc">--->
							<a href='badpics.cfm?category=#category#&sortorder=lastbought'>Most Popular</a> ||
						<!---		<cfelse>--->
							<a href='badpics.cfm?category=#category#&sortorder=pricedesc'>Premium </a> || &nbsp;&nbsp;
						<!---	</cfif>--->
...
&nbsp;&nbsp;&nbsp;&nbsp;<a href='badpics.cfm?category=#category#&start=#evaluate(start + display)#'><img src="images/nextlist.gif"  name="next" border="0" align="absmiddle" vspace="0" hspace="0" width="80" height="31"></a>
	<cfelse>	&nbsp;			</CFIF>
						</td>
					</tr>
					...
					<CFIF getList.recordcount is 0>
						<div style="margin-top:10px;border : 1px solid ##ECCCC;	width:607px;text-align:justify;font-size:12px;color:maroon;"> 
							...
							<cfelse>
							    <!---  <cflocation url="badpics.cfm?&relocated=1&invstatus=-3&color=#color#&category=#category#&subcat=#subcat#&priceless=#priceless#"  addtoken="no" />
								--->
						    </cfif>
							Often designs and range is discontinued due to  declining     interest.     
							<form action="badpics.cfm" method="post"  style="display:inline;" ><br>
