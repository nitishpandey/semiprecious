...
<script language=JAVASCRIPT src="/javascript/indiadetail2.js" type="text/javascript" ></script>
<cfelse>
  ...
  <td valign=top align="center" >
      ...
      <tr  valign="top" >
        <td   valign="top" align="Center" ><CFSET folder = #LCASE(category)#>
          ...
          <cfoutput>
            <input type="hidden" name="ajaxcheck" value="1"  id="ajaxcheck"/>
            </cfoutput>
            <table  width="756px" bgcolr="#ff7777" cellspacing="0" cellpadding="0" border="0" align="center"  >
              <!--DWLayoutTable-->
              <tr valign="top" >
                 <!--- Main image --->
                <td width="560px" align="center" style="border:1px #CFFCCF groove;padding-top:2px;" >
				  <cfoutput>
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="padding:4px" >
                   ...
                   <div id="cart_add_msg" style="position:absolute;top:24px;left:10px;z-index:2;background-color:transparent;"></div> <!---  <br style="clear:both" >--->
...
This is out of stock, we restock most items within 6 weeks                          
                        ...
                        <cfif details.size neq "" >
                          <cfif details.size is 0 and details.storage neq 'Angela'>
                            <i>Customize size from drop down above 'Select button'</i>
                          </cfif>
...
Not Availble now
                  ...
                  select description, optionid, <cfif session.bulkbuyer.id neq "" or cgi.server_name contains "wholesale-gemstone-jewelry.com" >valueadd/2 <cfelse> valueadd </cfif>as _valueadd from options where itemid               = #newitem#  and inventory>0
                            ...
                            <img src=/images/addtocart.gif id="a2cb"  onClick="javascript:goProcess('add')" >	   
