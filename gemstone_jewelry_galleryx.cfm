...
Select  getdate() as lastbought, case 	when inventory>0 then '0' else '1'
   ...
   where storage='Angela' and inventory>0  <CFIF category NEQ "ALL">
	...
	<CFIF isdefined("session.bulkbuyer.id") or cgi.server_name IS "www.wholesale-gemstone-jewelry.com"> AND WHOLESALEPRICE >0 and (storage not like 'CM%')
	<CFELSE>
	and price>0 
	</CFIF>
	  <cfif subcat is not "">
...
<cfif metatitle neq "">#metatitle#<cfelse>
	...
	<meta name="keywords" content=<cfif metakeywords neq "">"#metakeywords#"<cfelse>"Affordable #color# #subcat#, Gem stone,  #p#"</cfif>>
	<meta name="author" content="Anup Pandey" />
	<meta name="description" content= <cfif metadescription neq "">"#metadescription#"<cfelse>'#subcat# #style# #p# gem stone jewelry, retail and wholesale. <CFLOOP QUERY="Getlist" startrow="#start#"
	...
	<table style="margin-left:0px;width:800px;background-color:##EDEDED;text-align:center;horizontal-align:center;margin-top:2px;"  border="0" cellspacing="0"  cellpadding="0">
		<tr style="width:800px;">
			<td valign="top" align="center" width="800px" nowrap class="grayplacard">
				...
				<cfif len(advancedsearch)><cfelse><!--- Selection:  ---><Cfif isnumeric(priceless)>&nbsp;Around #format(priceless)#<img src="/images/arrow_right.gif" style="display:inline;" border="0" hspace="0" vspace="0" align="absmiddle"  title="jewelry gem stone selection" width="15" height="15" /><a href="gemstone_jewelry_gallery.cfm?sortorder=#urlencodedformat(sortorder)#&#sj#&priceless=#priceless#&color=#color#&category=pendants" id="pendants_horiz">Pendants</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?sortorder=#urlencodedformat(sortorder)#&priceless=#priceless#&color=#color#&category=rings" id="rings_horiz">Rings</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?sortorder=#urlencodedformat(sortorder)#&#sj#&priceless=#priceless#&color=#color#&category=Earrings" id="earrings_horiz">Earrings</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?#sj#&priceless=#priceless#&color=#color#&category=Bracelets&sortorder=#urlencodedformat(sortorder)#" id="bracelets_horiz">Bracelets</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?sortorder=#urlencodedformat(sortorder)#&#sj#&priceless=#priceless#&color=#color#&category=Necklaces" id="necklaces_horiz">Necklaces</a>&nbsp;
	...
	<table id="container1" width="800px" cellspacing="1" cellpadding="0" border="0">
		<tr style="width:800px;" align="center">
			<td valign="top"  align="center" width="91px">
				...
				<cfelse>
					Newly Launched Beads Section. Call or email us with suggestions.
				</cfif>
			</td>
		...
		<cfif subcat neq "bulk lots" and (cgi.server_name IS "www.wholesale-gemstone-jewelry.com" or cgi.server_name IS "wholesale-gemstone-jewelry.com")>
					<tr><td colspan="<cfoutput>#displaycolumns#</cfoutput>" ><font color=red><b>FOR BULK LOTS CLICK</b></font>	 <a href=bulklots.cfm>HERE</a></font></td></tr>
		</cfif>
					<tr class="greenbutton"  align="center">
						...
						<!---		<cfif url.sortorder neq "lastbought desc">--->
							<a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=lastbought'>Most Popular</a> ||
						<!---		<cfelse>--->
							<a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=pricedesc'>Premium </a> || &nbsp;&nbsp;
						<!---	</cfif>--->
											
					<!---	<cfif url.sortorder neq "datetaken desc">--->
							<a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=datetaken'>New Arrivals</a> || &nbsp;&nbsp;
							<!---<cfelse>--->
							<a href='cheapjewelry.cfm'>Cheapest First</a> || 
							<!---</cfif>--->
&nbsp;&nbsp;&nbsp;				
	...
	<cfelse>	&nbsp;			</CFIF>
		...
		<cfif subcat neq ""><br>#subcat#</cfif><cfif subcat2 neq "">-#subcat2#</cfif> <cfif #style# contains "silver">92.5% Silver</cfif><br>
			<cfset column = columns />
								...
								<div id="div#itemCount#" class="rowb" style="position:absolute; display:none; background-color:white; border:2px solid black; padding:4px;">
									<table cellpadding="2" cellspacing="0" border="0" width=300>
										<tr valign="top">
											...
											<td width="300">
											<a href='gem_stone_#cat#.cfm/#item_array[columns]#.htm'>Zoom/Buy Page</a><br><br>
											<!---
												...
												<div aligh=left class="listdescr">
													...
													<br><br><br><a href='gem_stone_#cat#.cfm/#item_array[columns]#.htm'>Zoom/Buy Page</a><br><br><span onMouseOver="div#itemCount#.style.display='none';"><a><font size=-1>close</font></a></span> 
			  ...
			  <CFIF start is not "1">
                  <a href='gemstone_jewelry_gallery.cfm?#sj#&category=#category#&start=#newstart#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#&style=#style#&groupname=#groupname#' ><img src="images/prevlist.gif" name="prev"  align="absbottom" border="0" style="display:inline;" /></a>
                 <cfelse>  <a href="topselling.cfm" >Best Selling!</a>  </CFIF>
&nbsp;</td><td align=left valign="top" colspan="3" border=0> 
...
<cfset rowsdisplayed = 1>
				   ...
				   <tr><td colspan="4" align="center"  class="biggreenwhite" >Random Picks from Top  Selling Designs  Shown Below</td><td  align="center"><a href='gemstone_jewelry_gallery.cfm?#sj#&category=#category#&start=#evaluate(start + display)#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#&style=#style#&groupname=#groupname#' ><img src="images/nextlist.gif"  name="next" border="0" align="absmiddle" vspace="0" hspace="0" width="80" height="31"></a></td></tr>

				
<cf_simpleimages  cols="3"  colspan="2" rows="#evaluate(4 - rowsdisplayed)#"  boxclass="rowb" />
				   </cfif>   
				   <tr><td  colspan="6" align=middle>
				   <a href=http://www.handmadelaptopcase.com><img src=http://www.handmadelaptopcase.com/laptopbags/ads/400x80bags.jpg></a></td></tr>
  <cfinclude template="marketing/links.cfm">
                 </table >
    ...
    <td align="center" valign="middle"  > 
      ...
      <!---    <cfif isdefined("session.india") and session.India is 1>
          <a href='http://www.affiliatecurry.com/affiliate/trackingcode.php?aid=1244&linkid=B11'><img src='http://www.affiliatecurry.com/images/banner1.gif' border='0'></a><cfelse> 
			<cfif cgi.server_name neq "www.ornamentscollect.com">  
					  <font size=+3>NOW designer Gnyana laptop cases ON SEMIPRECIOUS.COM <a href=laptopcases.cfm'>CLICK HERE</a><!---<cfinclude template="googleadsforlist.htm">--->
			</cfif>
          </cfif>--->
             </td> </tr></cfif>
    </table>
