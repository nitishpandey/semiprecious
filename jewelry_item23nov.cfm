...
<BODY BGCOLOR="white" link="black" topmargin='0' leftmargin="0"  >
<div align="left">
...
Allow 2-4 weeks for shipping<br>
              ...
              <CFINPUT  type="text" SIZE="2"  id="quantity" Name="quantity" VALUE="#existqty#" REQUIRED="yes" Message="Please enter quantity" VALIDATE="integer" /><INPUT TYPE="button"  id="a2cb" class="greenbutton" onClick="javascript:goProcess('add')" VALUE="Add to Cart" /><input type="button" class="hidden" id="a2cw" value="Wait..." />
 	...
 	<a href='/jewelry_item.cfm/#nextpos#_#catn#.htm?thiswidth=#width#'  ><img  src="/images/#catn#/thumb/#nextpos#.jpg" border="1"  name="nimg" hspace="0" vspace="0"   alt="Next" height="#variables.ht#"   >
            ...
            <tr valign="bottom" > 
              <td valign="top" align="center"   colspan="1" ><a href="/jewelry_item.cfm/#prevpos#_#catp#.htm"><img border="0" src="/images/prev.gif" hspace="0" vspace="0"   align="absbottom" width="18" height="18" />PREV</a> <!--- <br> <br> <a href="/detailemailer3.cfm?description=#urlencodedformat('visit www.semiprecious.com for more details')#&newitem=#newitem#&cat=#category#&from=#cgi.HTTP_REFERER#" ><font face="Calisto MT" style="bold">Tell 
                a Friend</font></a> ---></td>
              <td align="justify" valign="top" > <div  class="category"  >#description#         <cfif optcount>
                  <br />
                  ...
                  </cfquery><span class="optionsinline"> Options: <select id="optionid" name="optionid"  style="display:inline;backgroun-color:orange;">
                    <cfloop query="opts">
<cfif url.optionid eq opts.optionid>
      <option value="#opts.optionid#" selected>$ #_valueadd# more for #description#</option>
<cfelse>
      <option value="#opts.optionid#">$ #_valueadd# more for #description#</option>
</cfif>
    ...
    (Dangling earrings with or without Hypo allergenic hooks available for most necklaces for $3/pair, call 1800 620 9849  or 
	  	...
	  	<tr><td  align="Left"><a href='/agate.htm'><i>Learn more about this and other semi precious stones</i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  style="color:maroon;font-size:11px;">In case of any problem,query or to order online call Toll Free 1800 620 9849</span></td></tr>
...
<div style="position:absolute;top:80px;left:790px;color:blue;z-index:2;"><a onClick="MM_showHideLayers('howto','','show');">?</a></div>
...
<ul><li> Options:Before adding/changing the quantity please see if any options/modification  are available for the jewelry. Options are shown at the bottom of the picture and are <span class="optionsinline">highlighted in this color</span>.
 ...
 </div><a onClick="MM_showHideLayers('howto','','hide');">Close Help</a></div>
