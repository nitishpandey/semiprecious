  ...
  <tr> 
    <td align='left' bgcolor='white' colspan=3><a href=index.cfm><img src='images/header.gif' width="309" height="57" border=0></a></td></tr></table>
	  <cfif newcartissues.recordcount>
		  <div style="width:600px;border:1px black ridge;padding:2px;">
		  <ol style="margin-left:2px;text-align:left;"><cfoutput query="newcartissues" group="status">
		  <li style="margin-left:2px;">#Status#</li>
		  <ul style="margin-left:-10px;text-align:left;">
		  <cfoutput>
		  <li style="margin-left:4px;text-align:left;">
		  <a href="http://www.semiprecious.com/tm/taskdetails.cfm?by=#tby#&doi=#urlencodedformat(tdtoi)#">#action# to complete by #pdc#</a>
		  </li>
		  </cfoutput></ul>
		  </cfoutput>
		  </ol>
...
<tr>	<td>
	...
	<cfif track.tracking1 neq "" and track.tracking2 eq ""><cfoutput><br><b>SHIPPING STATUS:</b> COMING FROM JEWELER TO AUSTIN <a href=http://wwwapps.ups.com/WebTracking/processInputRequest?HTMLVersion=5.0&loc=en_IN&Requester=UPSHome&amp;tracknum=#track.tracking1#&amp;ignore=&amp;track.x=44&track.y=3>Locate/Track</a></cfoutput><br>
		...
		<p><b>Track Package: Track. Number- </b><cfoutput><font color=white>#track.tracking1#--</font>#track.tracking2#<input name="origTrackNum" type="hidden" id="origTrackNum" value="#track.tracking2#" style="width:240px" tabindex="2"><input type="submit" value="Track"></cfoutput></form>
	</cfif>
<br>
	<cfelse>
	This order may not have shipped
	</cfif>
<cfif session.mail is application.admin_email>ENTER Tracking- : <cfoutput><a href=http://www.semiprecious.com/tm/newtask.cfm?cartid=#cartid#>Add Tracking/ Issue</a></cfoutput>		
	<cfif track.issue neq "">
	<div align="justify" style="width:100%;border:1px gray ridge;padding:2px;">Tracking Issue:<font color="red"><cfoutput>#track.issue#</cfoutput></font></div>
	</cfif>
</cfif>
...
<!---<a title="confirm this cart (if paid using pp,auth.net,check)" href="http://www.semiprecious.com/itemsell.cfm?cartid=#cartid#&paymode=#q_ship.paymode#&returntocarts=1">---><b><font color=red>#cartid#</font></b><!---</a>---> | <strong>Date:</strong> <a href="cartstatus21.cfm" >#dateformat(solditems.datebought,'dd-mmm-yy')#</a><strong> | Affiliate: </strong><font color=red>#solditems.affiliateID#</font>; Payment : #q_ship.paymode#, #q_ship.shippingdetails# </cfoutput>  
	  <!--- remove <cfif session.mail is application.admin_email or session.mail is "info@silverscorpio1.com"> Assign To: <cfoutput><a href=itemsell.cfm?assignto=harish&cartid=#cartid#>Harish</a> | <a href=itemsell.cfm?assignto=Acemat&cartid=#cartid#>ACEMAT</a> | <a href=itemsell.cfm?assignto=new&cartid=#cartid#>AUSTIN</a> --->|| <cfoutput> Status: <font color=red>#q_ship.status#</font></cfoutput>	

	<cfoutput>  <a href=itemsell.cfm?cartid=#cartid#&amp;statustonew=1>Make New</a> </cfoutput>|
	</td>
    </tr><cfoutput>
...
<cfoutput query="giftq">#note#</cfoutput><br>
    ...
    <div  style="width:460px;border:1px green solid"> 
...
<span style="margin-left:20px;display:block;text-transform:capitalize;">
    ...
    <hr />
     </td><td align=left width=320 style="border:1px blue dashed;"><b>Return Label</b> (Include reason/requests to customize):<p>
<font size="+2">
<b>Dynamic Web<br>
1512 Anise Dr<br>
Austin, TX 78741</b>
	  ...
	  <a href="www.handmadeLatopcase.com">Trend Setting Handmade Latop Bags</a>
	  	  </textarea>
