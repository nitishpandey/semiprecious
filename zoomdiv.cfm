...
Wholesale
    ...
    <cfoutput>#details.color#gem stone#details.style##category##itemnumber#</cfoutput>
    </cfsavecontent>
    <cfelse>
    <cfset folder="rings" />
...
<cfoutput>
  ...
  <script language="JavaScript" src="/js/macromediafuncs.js" type="text/javascript"></script>
  <!---
...
vCurrentInventory = #invent#;
						...
						function swapMainImage(pImage){
							...
							if(height>400){
								document.getElementById('mainimage').height = '400';
							}
							else{
...
<div style="filter:alpha(opacity = 70); position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:rgb(122,80,100);opacity:0.7;display:none;z-index:5;" id="curtain"> <span style="height:28px;position:relative;top:50%;left:50%;color:white;font-weight:700">Loading ... <img  src="/images/ajax.gif" alt="loading indicator" /> </span> </div>
