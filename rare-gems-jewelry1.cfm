...
<h2 align="center" style="font-size:14px;font-weight:bold;color:#CC0000;">ALL GEMSTONES LISTED IN ALPHABETICAL SEQUENCE<br></h2>
...
<table cellspacing="0" cellpadding="0" border="0">
  <tr >
    ...
    <cfset itemlist = 0>
	<cfset a = 'A' /><cfoutput>	
<td class="greenbutton" colspan="#displaycolumns#"><h2>#a#</h2></td>
</cfoutput>	  <CFLOOP QUERY="Getlist">
	<cfif a neq left(subcat2,1)>
<td colspan="#displaycolumns-columns#">&nbsp;</td></tr><tr><cfoutput>	
<td class="greenbutton" colspan="#displaycolumns#"><h2>#left(subcat2,1)#</h2></td>
</cfoutput></tr><cfset columns = 1>	 
