...
<cfset rowsdisplayed = 0>
   <table align="center" cellspacing="0" cellpadding="1" style="margin-top:1px;background-color:##FFFFFF;">
   <cfif category is 'beads'>
<tr><td colspan=6><font color=green>beads being added daily Nov to January end! Come back every day</font></td></tr>
</cfif>
					<tr class="greenbutton"  align="center">
						<td colspan=<cfoutput>#displaycolumns#</cfoutput> align="center" style="border-top:2px ridge #dark#">
							<cfif start GT 1>
...
#cgi.QUERY_STRING# . 
    ...
    Often designs and range is discontinued due to  declining     interest.     <form action="semiprecious-stone-beads.cfm" method="post"  style="display:inline;" >
      <br>
  ...
  <cfset salestatus = 3>
	  ...
	  <CFLOOP QUERY="Getlist"		startrow="#start#"	endrow="#enddisplay#">
        ...
        <td class="rowb" valign=top  > 
          ...
          <table border=1><tr height=120><td height=120>
 <a href='gem_stone_#cat#.cfm/#item_array[columns]#.htm' > 
              <img src ='images/#getlist.cat#/#newitem#.jpg' longdesc="http://www.semiprecious.com/longdesc.cfm?newitem=#newitem#" border='0' bordercolor='black'  name="img#newitem#" title="#subcat# #category#" width="250"></a>
</td></tr></table>
...
<a href="np/match/cluster.cfm?list=1&target=#newitem#&category=#cat#">Ad2Clus</a>
			...
			<cfswitch expression="#status_array[column]#">
                  ...
                  <b>Zoom</b></a>&nbsp;&nbsp;&nbsp;#price_array[column]#, <font color=black>Size:</font>#size# mm</font>&nbsp;&nbsp;&nbsp;<a href='gem_stone_#cat#.cfm/#item_array[column]#.htm' ><b>Buy</b></a>
				  <br /><br> </cfcase>
				  <cfcase value="0"><font color="##000099"><a href='gem_stone_#cat#.cfm/#item_array[column]#.htm' >
                  <b>Zoom</b></a>&nbsp;&nbsp;&nbsp;#price_array[column]#</font>&nbsp; <br />&nbsp;<font color="##FF4444">
				  Sold Out</font>
...
<tr> 
              <td align=center valign="top" colspan="<cfoutput>#displaycolumns#</cfoutput>" border=0> 
			  <CFIF start is not "1">
...
<TR><TD> <cfif category neq 'beads'><script type="text/javascript"><!--
