...
<div align="center" >
		  <cfinclude template="/#session.country#/header.cfm" >
	<span  style="height:12px;text-decoration:none;position:relative;left:-100;font-size:14px;" >
              ...
              <tr valign="top" >
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="padding:1px" >
					...
					<cfif not len(width)>
                         ...
                         <a class="side_link" href='#session.gallery#?#session.filter####newitem#_anchor' style="text-decoration:underline;" >&larr;To Gallery</a></span>
						<div   style="form_heading">
						<h3 align=left><cfif cgi.server_name contains 'wholesale'>Wholesale </cfif>#titlecase(details.subcat)# #titlecase(details.grouping)# 
						<cfif details.subcat2 neq ""> #titlecase(details.subcat2)#</cfif> 
						<cfif details.cat neq 'healing'>#titlecase(left(details.cat, len(details.cat)-1))#</cfif></a>
						</h3>          
							</div></cfif><table style="margin-top:1px;width:100%" cellpadding="1px;"><tr><td width="40%" align="center">
						<cfif len(cart_msg)>
				...
				<td nowrap="" width="" valign="top" align="right" style="background-color:transparen;">
                  ...
                  <cfif details.morepics eq 0 or details.morepics eq "" >  
                      <img style="float:left;margin-left:4px" src=/images/#category#/thumb/#newitem#.jpg />
                      	...
                      	<div align="left"  >
                      		<iframe src="http://www.facebook.com/plugins/like.php?href=http%3A%2F%2Fwww.semiprecious.com%2Fjewelry_item.cfm%3Fnewitem%3D#NEWitem#&amp;layout=standard&amp;show_faces=true&amp;width=150&amp;action=like&amp;colorscheme=light&amp;height=40" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:150px; height:40px;" allowTransparency="true"></iframe><br>
                    ...
                    <CFIF price eq 0 and (len(session.bulkbuyer.id) is 0 )>
                      ...
                      <cfif status eq 0 or status eq 3 >
                        ...
                        <cfif details.basecost >
							 Store Price
							#round_format(8.18*details.basecost/application.exchangerate)# </cfif>
							<cfif len(session.bulkbuyer.id)>
							<br />Wholesale:
                          <cfelse>
...
<a class="addthis_button" href="http://www.addthis.com/bookmark.php?v=250&amp;username=anuppandey"><img src="http://s7.addthis.com/static/btn/v2/lg-share-en.gif" width="125" height="16" alt="Bookmark and Share" style="border:0"/></a><script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js##username=anuppandey"></script>
<!-- AddThis Button END -->               <br /><!--- unclutter the zoom page
                  <cfif category is 'beads'>
...
--->        
		  ...
		  <cfif 1> <!--- if width variable set by cfinvoke add is set to thumb then next column --->
             <!--- End right side? --->
			  <!--- 4th column --->
                 <td align="center" >&nbsp;&nbsp;&nbsp;&nbsp;<cfoutput><a title="Check Cart and start checkout" href="/#session.cart#?country=#urlencodedformat(session.address.country_code)#&amp;pehp=3e.2210&amp;cartid=#session.cartid#" ></cfoutput><img alt="shopping cart and start checkout" src=/images/add_to_cart_icon.jpg></a><br>&nbsp;&nbsp;&nbsp;&nbsp;<b>CART</b><br><br>
