...
<cfset width = 'thumb' /> 
	...
	<cfelse>
		...
		<cfif trim(added.response.newitem.optionid.XmlText) neq '0'>
			<cfset cart_msg= cart_msg & " [Option number "&  added.response.newitem.optionid.XmlText & "]" />
		</cfif> 
	</cfif>
              ...
              <tr valign="top" >
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="padding:2px" >
	                <tr  valign="middle" >
						...
						<cfif len(cart_msg)>
								<Div id="cart_summary" style=";margin-top:13px;border:2px solid red;padding:2px 1px 1px 1px;">
									<div style="background-color:##F3F3F3;;padding:2px;color:red;font-size:1.2em;font-weight:bold;">#cart_msg#&nbsp;</div>&nbsp;[Cart Total: #format(session.grandtotal)#] <span   style="positio:absolute;top:10px;left:2px;z-index:1;background-color:transparent;" > 
                          &nbsp;<a class="LOGIN_link" href='#session.gallery#?#session.filter####newitem#_anchor' style="text-decoration:underline;" >&larr; Back to Gallery</a> 
								...
								| <span class="" style="color:black;padding:2px;"><a href="/#session.cart#?cartid=#session.cartid#"   onClik="goProcess('cart summary');return;">Go to cart &rarr;</a></span>
				<cfelse>
				       <div>  <img  src="/images/spacer_.gif" height="240px;" style="float:left;height:200px;width:1px;display:inline;" />
                   		 </cfif> <table><tr><td>
                    <img id="mainimage" style="display:block;" src ='/images/#folder#/#width#/#imagename#'   alt="unique #subcategory# #category# Jewelry"  border="0" /></td><td>
