...
Pic[0] = '<cfoutput>images/bags/#newitem#.jpg</cfoutput>'

<cfloop index = "LoopCount" from = "1" to = "#evaluate(details.morepics*1)#">
    <cfoutput>
Pic[#LoopCount#]=  'images/bags/laptopbags/laptopbag-#newitem#-#loopcount#.jpg';</cfoutput>
</cfloop> 
...
<tr>
<td id="VU" height=500>
<img src="/images/bags/#newitem#.jpg" name='SlideShow' width=400 height=400></td>
</tr>
</table>
       </td>
...
<br><a href="/contactus.cfm?newitem=#newitem#&folder=#folder#">Ask Us</a>
			...
			<br><br><br><a href=/bagcart.cfm><img src=../images/jewelrycart.jpg border=0></a>
            </td>
	...
	<img  src="/images/#catn#/thumb/#nextpos#.jpg" border="1"  name="nimg" hspace="0" vspace="0"  alt="Next" height="#variables.ht#"   >
            ...
            <tr valign="top" > 
              <td valign="top" align="center"   colspan="1" ><a href="/laptop-case.cfm/#prevpos#_#catp#.htm"><img border="0" src="/images/prev.gif" hspace="0" vspace="0"   align="absbottom" width="18" height="18" />PREV</a> <!--- <br> <br> <a href="/detailemailer3.cfm?description=#urlencodedformat('visit www.semiprecious.com for more details')#&newitem=#newitem#&cat=#category#&from=#cgi.HTTP_REFERER#" ><font face="Calisto MT" style="bold">Tell 
                a Friend</font></a> ---></td>
              <td align="left" valign="top" > <div align="justify"  > <cfif prevpic GT 0><a href=laptop-case.cfm?newitem=#newitem#&picnumber=#evaluate(picnumber - 1)#>Previous Pic</a> | </cfif><cfif #details.morepics# neq ""><a href=laptop-case.cfm?newitem=#newitem#&picnumber=#evaluate(picnumber)#>See Pic #evaluate(picnumber + 1)#</a> | </cfif> #description# 
