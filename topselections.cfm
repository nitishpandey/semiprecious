...
<div style="text-align:center;z-index:3;position:relative;top:250px">
<cfelse>
<div style="text-align:center;z-index:3;position:relative;top:50px">
</cfif>
...
<cfoutput query="topselection" maxrows="1">
	<div class="jewelry_box_home" style="width:120px;text-align:center;" >
       	<div class=heading> 
		    	<div class=URL> 
		...
		<div class="content" >
						<div class="big_image" >
			     		<a href="/gem-stone-#category#.cfm" >
								 <img src="#img#" width="50" alt="gemstone in silver" /></a>
						</div>
				</div>			  
...
<div class="retail_price">
	<cfif category neq 'beads'>
				...
				<cfelse>
				<div style="width:50px;height:14px;">&nbsp;</div>
	        </cfif>
