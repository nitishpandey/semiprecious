...
<cfif category neq 'cufflinks'>
  ...
  <!--- Start color popup button --->
	...
	<body>
		<div id="containerMenu" <cfif cgi.SERVER_NAME contains 'wholesale'>style="margin-top:50px"</cfif>>
		<!-- BEGIN Menu -->
...
<li><a href="/india_jewellery_online.cfm?style=beaded" ><b>Beaded Jewelry</b></a></li>
		...
		<cfif cgi.server_name  does not contain 'wholesale'>
			<li style="background-color:#990000"><a href="/jewelry-gemstone-clearance.cfm" ><b>CLEARANCE</b></a></li>
	</cfif>
			</ul>
