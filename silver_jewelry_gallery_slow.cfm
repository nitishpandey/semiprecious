								...
								<td valign="top">
									...
									<!---
										...
										---> </div>
																...
																<span style="font-family:arial san serif,color:purple;font-size:12px;"> #contentbypage.description# 								</span> 								</cfoutput> 								</div> 								</cfif>
																<h1 class="found_header"> 								<cfoutput> #count_of_designs# #titlecase(color)# #titlecase(subcat)# 								<cfif groupname neq ""> #titlecase(groupname)#
								 ...
								 &nbsp; &nbsp; &nbsp; &nbsp; <cfif
									((category neq "jewelry" and category neq "All" and (not findnocase(category,GetFileFromPath(GetBaseTemplatePath())))) or (subcat neq "" and (not
