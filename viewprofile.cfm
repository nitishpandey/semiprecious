...
<h1><cfif not rank is "NA">#rank#</cfif> #recordset.full_name#</h1>
  ...
  <tr > 
	 ...
	 <tr> 
	     <td align="left" valign="top" nowrap class="columnname"><div >About </div></td> 
...
<span class="contact" >Click Here to Contact <cfif not rank is "NA">#rank#</cfif> #recordset.full_name# </span></a></font></div></td> 
   </tr> 
  <tr> 
