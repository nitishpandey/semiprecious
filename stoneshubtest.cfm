...
<table id="container1" width="1000px" cellspacing="0" cellpadding="0" border="0" style="padding:0 10px 0 10px">
  ...
  <table style="margin-left:0px;width:800px;background-color:##EDEDED;text-align:center;horizontal-align:center;margin-top:2px;padding:5px 5px 5px 10px"  border="0" cellspacing="0"  cellpadding="0">
    ...
    <tr>
      <td align="left" valign="top" colspan="2" ><cfoutput> <img src="/images/stoneshub/#subcat#.jpg" style="float:left;padding:10px" > <span style='font-size:10pt;font-family:"Palatino Linotype","serif";color:black'>
          <CFINCLUDE TEMPLATE="/info/#subcat#.cfm">
          </span> </cfoutput> </td>
    </tr>
    ...
    <cfif getdesigner.recordcount GT 0>
      <tr>
      <td bgcolor="#FFFFFF" colspan="2" bgcolor="black" height="20" >
        <cfoutput> Designer #subcat# Jewelry </cfoutput>
      </td>
    ...
    <tr  bgcolor="white">
      <td align="center" height=30  colspan="2"><cfoutput><a href=#subcat3#.cfm>SEE RANDOM #subcat# JEWELRY</cfoutput></a></td>
    </tr>
    <!--- End Matt Bayuk - SGM --->
    ...
    <cfoutput>
      ...
      <tr>
        <td  align=middle  colspan="2"><a href=http://www.handmadelaptopcase.com><img src=http://www.handmadelaptopcase.com/laptopbags/ads/400x80bags.jpg></a>
