...
--->
<meta name="description" content="Unique <cfoutput>#subcategory# of #category#</cfoutput>, affordable semiprecious gemstone jewelry item. We sell rings, pendants, necklaces, earrings, bracelets.  We sell retail and wholesale. We sell Tiger eye, lapis lazuli, pearl, garnet, malachite, turquoise, aventurine, jasper, moss agate, agate, quartz, peridot etc. and other healing crystals, Austin based">
<meta name="keywords" content="<cfoutput> #category#, #subcategory#</cfoutput>,semi precious, gem-stones"> 
...
<td align="center"><a onClick="MM_showHideLayers('howto','','show');" style="color:maroon;margin-bottom:2px;"><img src="/images/help.gif" border="0" vspace="0" hspace="0" align="absmiddle" width="43" height="30" /></a></td>              	
   ...
   <cfif optcount>
                 <div  class="optionsinline" align="right" style="width:100%;horizontal-align:right"> <b>Options</b>: <select id="optionid" name="optionid"   >
		  ...
		  <table><tr><td>
			  <div align="justify"  >#ucase(subcategory)# #ucase(details.subcat2)# <cfif category neq 'healing'>#ucase(left(Category,len(category)-1))#<cfelse>#ucase(category)#</cfif>: #description# 
			  <cfif details.size neq ""><b>Size:</b><cfif details.size LT 100>#details.size# <cfif category is "necklaces" or category is "bracelets" or category is "bags">inches<cfelseif (category is "pendants"or category is "earrings") and details.size LT 5>inches<cfelse>mm</cfif><cfelse> #Round(evaluate(details.size/25.4))# inches</cfif>
			  </cfif>
			  ...
			  <cfif category is 'beads'> ** Unless specified differently, all strands are 16 inches.</cfif>
	...
	<cfif category eq "necklaces"><a href='http://www.qvc.com/jw/jw_necksizeguide.html' class="highlightred">Necklace Size Guide by QVC</a> 
		...
		<cfif cgi.server_name neq "63.135.126.234" and cgi.server_name neq "www.ornamentscollect.com">
	  	<tr><td  align="Left"><cfif stonename NEQ ""><a href='/<cfoutput>#stonename#</cfoutput>.htm'><i>Learn more about this and other semi precious stones</i></a></cfif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  style="color:maroon;font-size:11px;">
			...
			For more information within 15 min to 12 hrs on this item: <a href="/contactus.cfm?newitem=#newitem#&folder=#folder#">Ask Us</a>
		</span></td></tr>
...
<cfif details.morepics GT 0>
		  <script language="Javascript" src="http://crecon.com/dropin.js">
		</script>
		<div id="dropin" style="position:absolute; left:200px; top:100px; 
		width:500px; height:300px; visibility: hidden;">
		...
		style="padding:4px">
		<cfoutput><img  src ='/images/jewelry/#category#/<CFIF #NameID# is "">#newitem#-1.jpg<CFELSE>#NameID#</CFIF>'  alt="unique #subcategory# #category# Jewelry"  border="0"></cfoutput>
		</td>
		</tr>
		</table>
		</td></tr>
		
		<tr><td height=12><font size=2>Made with <a
		href=http://www.crecon.com>Creative
		Connectivity's Drop-In Maker</a></FONT></td></tr>
		...
		<cfoutput>
		<script language="Javascript">
		DropIn('##FFFFFF','Arial',14,'##000000','<img  src ="/images/jewelry/#category#/<CFIF #NameID# is "">#newitem#-1.jpg<CFELSE>#NameID#</CFIF>" alt="unique #subcategory# #category# Jewelry"  border="0"> <p>','200','300',	'67','67','##000000','solid',1,0,true);
		</script>
		</cfoutput>
</CFIF>
<!---
