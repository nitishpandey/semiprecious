...
<cfinclude template="includes/themes.cfm">
 ...
 <cfif color neq "">
  ...
  <table id="container1" width="928px" cellspacing="0" cellpadding="0" border="0" style="padding:1px 1px 0 1px" >
...
</div> <div style="width:770px;float:right;background-color:white;">
