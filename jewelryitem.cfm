...
<cfoutput> 
  <TITLE>#subcategory# #category# Jewelry </TITLE>
...
<BODY BGCOLOR="white" link="black" topmargin='0' leftmargin="1" >
 <!---<table  border="0" cellspacing="2" cellpadding="0">
  <tr>
    <td valign="top"><a href='/index.cfm'><img src='/logobw.jpg' border=0></a>&nbsp;</td><td background="/images/bottom_bg.gif">&nbsp;<cfinclude template="/adminfooter.cfm"></td>
   <td valign="middle" nowrap>
	<cfinclude template="/searchformsforjewelry_item.cfm" > </td>
  </tr>
</table>---><div align="left">
<cfinclude template="headerforlist.cfm">
 <table border="0"  align='left'  cellspacing="0"  width="800" cellpadding="0" style="margin-top:1px;margin-left:1px;">
   		  <tr  valign="top" align="center"> 
	  <td width=1 align="right" rowspan="4">&nbsp; 
 ...
 <CFFORM ACTION="" METHOD="POST" NAME="wishbuy" onSubmit="javascript:goProcess('add');"> 
		<table  width="800"  cellspacing="0" align="center" style="border:1px gray solid;" >
        <!--DWLayoutTable-->
          <tr valign="top"> 
            <td valign="middle" align="center" width="120" bgcolor='#ffffff'> <!--- the left blank column of the image tab --->
			  <cfoutput><a href='/gemstone_jewelry_gallery.cfm?#session.filter#'  class="table_row_over" > Back  to Gallery </a><br>
 <INPUT TYPE="button" class="greenbutton" onClick="javascript:goProcess('Add to Wish List')" VALUE="Add To Wish List">
                <br>
...
<!---
<cfoutput>
          <a href='/gemstone_jewelry_gallery.cfm?#session.filter#'  class="headerfont" ><font face="Calisto MT" color="##FFFFFF" style="bold">Back  to Gallery</font></a> <br><a href="/wish.cfm"  class="headeranchor"><font face="Calisto MT" color="##FFFFFF" style="bold">My Wish List</font></a>
--->
		<!---
   		  		  <a href='/necklaces.cfm'><b><font face="Calisto MT"  color="##FFFFFF">Necklaces</font></b></a><br> 
              <a href='/bracelets.cfm'><b><font face="Calisto MT" color="##FFFFFF">Bracelets</font></b></a><br> 
              <a href='/earrings.cfm'><b><font face="Calisto MT" color="##FFFFFF">Earrings</font></b></a><br> 
              <a href='/pendants.cfm'><b><font face="Calisto MT"  color="##FFFFFF">Pendants</font></b></a><br> 

              <br>   <b> <font face="Calisto MT" color="##FFCC33" >\</font><a href='/cart.cfm' class="cart"><font face="Calisto MT" color="##FFCC33" ><span class="cart">Cart</span></font></a><font face="Calisto MT" color="##FFCC33" >/</font></b>
            --->
	
<!---		  <br><font face="Calisto MT" color="##FFFFFF" style="bold">Read About:</font><br><cfif isdefined("stones2")>
--->
    <!---  <a href='/gemstone_jewelry_gallery.cfm?category=necklaces&sortorder=price&subcat=#URLEncodedformat(stones2)#'><b><font face="Calisto MT"  color="##FFFFFF">Necklaces</font></b></a><br>
                  <a href='/gemstone_jewelry_gallery.cfm?category=bracelets&sortorder=price&subcat=#URLEncodedformat(stones2)#'><b><font face="Calisto MT"  color="##FFFFFF">Bracelets</font></b></a><br> 
              <a href='/gemstone_jewelry_gallery.cfm?category=earrings&sortorder=price&subcat=#URLEncodedformat(stones2)#'><b><font face="Calisto MT"  color="##FFFFFF">Earrings</font></b></a><br> 
              <a href='/gemstone_jewelry_gallery.cfm?category=pendants&sortorder=price&subcat=#URLEncodedformat(stones2)#'><b><font face="Calisto MT"  color="##FFFFFF">Pendants</font></b></a><br> 
              <br>
                 <b> <font face="Calisto MT" color="##FFCC33" >\</font><a href='/cart.cfm'><font face="Calisto MT" color="##FFCC33" ><span class="cart">Cart</span></font></a><font face="Calisto MT" color="##FFCC33" >/</font></b>
             
			   <br>
                  <br> --->
<!---    
            <cfloop list="#stones2#" index="st">
                     <a href="/#st#.htm" class="headerfont"><font face="Arial"  color="##FFFFFF" ><span style="text-transform: capitalize;">#replace(st,"_"," ")#</span></font></a><font face="Arial"  color="##FFFFFF" >,</font><br>
         </cfloop>  
				</cfif>  <a href='/healing_properties.htm' class="headerfont"><font face="Arial"  color="##FFFFFF" >Healing 
</font></a> 
         <br><br>      <a href="/contactus.cfm?newitem=#newitem#" class="headerfont"> 
          <font face="Arial"  color="##FFFFFF" >More Info?
            </font></a> 			<!--- note : clustercount is like this. 1 for look/style type cluster exists, 2 for 'set' type cluster exists, 3 for both look type and set cluster exist --->

              <br />
			
			 <cfif session.mail is ""  and  not (isdefined("session.bulkbuyer.id"))>
<br><a href="/apply.cfm" class="headerfont"><font face="Calisto MT" color="##FFFFFF" style="bold">Get Discount</font></a></cfif> 
<br>
<br>	  </cfoutput>
--->
		</td>
	...
	<cfelse>
			...
			<cfset width = 350>
              ...
              <cfoutput> <img width="#width#"  src ='/images/#folder#/<CFIF #NameID# is "">#newitem#.jpg<CFELSE>#NameID#</CFIF>' alt="100% Satisfaction Guaranteed"  border="0">
...
<!-- 			<td background="/images/lg2whitebg.jpg" rowspan="2">&nbsp;</td> -->
   ...
   <table><Tr><Td align="center">
      <cftry> 	
		...
		<span  class="look">
		<a href="/gemstone.cfm?itemid=#newitem#&type=look" >More Items <br>Like This</a></span><br>
  </cfif>
			<cfcatch type="any">
...
update items set clustercount =  0  where newitem = #details.newitem#
 </cfquery></cfcatch></cftry>
			   		  <div class="details">
                <B>Item Id : #newitem# &nbsp;&nbsp;</B><br>
				<cfif status eq 0 or status eq 3 >
				    <FONT verdana > 
		                 Retail price: <strike>#format(round(evaluate(price*1.5*(1+(newitem mod 150)/1000))))#</strike><br>
                </font> 
	 <font color="black">Your Price: <b>#format(price)#</b> </FONT> <br>
	    <cfif not isdefined("session.bulkbuyer.id")>  
	                   <CFIF  status eq 3>
                      <b><font color="red">Sale!</font>: #format(saleprice)#</b> 
					              </CFIF>
				</cfif>
                ...
                <CFIF invent GT 0>
	             <INPUT TYPE="hidden" NAME="bought" VALUE="buy">
                  <br>
                  Qty: 
                 <CFINPUT type="text" class="inputtext" SIZE="3" Name="quantity" VALUE="#existqty#" REQUIRED="yes" Message="Please enter quantity" VALIDATE="integer">                                <INPUT TYPE="button" class="greenbutton" onClick="javascript:goProcess('add')" VALUE="Add to Cart"><br>
                  [Can Change Later]<br>                         <br>
  <!---<i><font color=brown>Shipping</font></i>: Free for 
                  any three items, $0.50 for two items, $1.95 for one item. <br>
--->
                  <cfelse>
                  <p class="error1">Sorry, item Sold out.</p>
				  You may Order.
				   <br>
Allow 2-4 weeks<br>
 for shipping
                  ...
                  <br>
                  Qty: 
                 <CFINPUT type="text" class="inputtext" SIZE="3" Name="quantity" VALUE="#existqty#" REQUIRED="yes" Message="Please enter quantity" VALIDATE="integer">                                <INPUT TYPE="button" class="greenbutton" onClick="javascript:goProcess('add')" VALUE="Add to Cart">
                  <br>
                </cfif>
                ...
                <INPUT TYPE="hidden" NAME="price" VALUE="<CFIF status is 3>#saleprice#<cfelse>#price#</cfif>">
		  ...
		  <tr valign="bottom"> 
            <td valign="bottom" align="center" bgcolor='#FFFFFF'>      <!-- change this to darkgreen when putting image back -->
    ...
    <cfset catp =	session.filterarray[prevpos][2]>
            ...
            <!---                              <cfset imgname ="d:\inetpub\semiprecious\images\#catp#\#prevpos#.jpg">
              ...
              </cfoutput></td> <td  valign="bottom" align="center">&nbsp;
              <!--- <a href="#cgi.HTTP_REFERER#"> 
				...
				<cfif arraylen(session.filterarray) GT 2>
                    ...
                    <cfif thispos>               
					  ...
					  <cfif imageinfo.width GT imageinfo.height >
                            <cfset width1 =  120>
                            <cfset ht = round((imageinfo.height*120)/imageinfo.width)>
					                            <cfelse>
                            <cfset ht =  120>
                       </cfif>
					   <cfcatch type="any">
 	...
 	<a href='/jewelry_item.cfm/#nextpos#_#catn#.htm'  ><img  src="/images/#catn#/thumb/#nextpos#.jpg" border="1"  name="nimg" hspace="0" vspace="0"   alt="Next" height="#variables.ht#"   >
								</a></cfoutput> ---->
					<!--- 	<cfelse>
            ...
            <tr valign="bottom" > 
              ...
              <td align="justify" valign="top"  > <span >#description#                 <cfif optcount>
                  ...
                  </cfquery><span class="lookinline">              Options:<select name="optionid"  style="display:inline;backgroun-color:orange;">
                    <cfloop query="opts">
          ...
          <!---<br><b>To place order by phone 24x7 call 512-589-9009</b>--->
            ...
            <!---<br><b>To place order by phone 24x7 call 512-589-9009</b>--->
              ...
              <td  align='center' valign="top"     bgcolor="##FFFFFF"  colspan="1" > 
                <a href="/jewelry_item.cfm/#nextpos#_#catn#.htm">NEXT <img  border="0" src="/images/next.gif" hspace="0" vspace="0"  align="absbottom" width="18" height="18" /></a><!--- <br /> <br /> <a href="/gift_certificatenew.cfm?description=visit%20www.semiprecious.com%20to%20know%20more">Gift 
