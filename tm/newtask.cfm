...
<div align="center"><table class="table1" width="800"><tr>
	  ...
	  <cfif  isdefined("form.action")>
		...
		<cfif isNumeric(trim(form.subject)) >
	...
	<cfelse><br>
		...
		<cfform name="form1" method="post" action="newtask.cfm" enctype="multipart/form-data">
            ...
            <tr> 
              ...
              <td width="55%"> <input type="hidden" value="#url.cartid#" name="cartissue_flag" />
                <cfinput type="text" name="subject" value="#url.cartid#" required="yes">(Use cartid if cart issue)</td>
                <td width="11%">PDC</td><cfset newdate = dateAdd("d",5,now()) />
