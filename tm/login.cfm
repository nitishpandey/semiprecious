...
<cflocation   url = "http://www.semiprecious.com/tm-tm/mainmenu.cfm"   addToken = "no">
</cfif>
       ...
       <form action="mainmenu.cfm"  method="post">
	      <table width="55%" border="1" align="center" cellpadding="2" class="tmbody">
            <tr> 
              ...
              <td>Id:</td>
            <td><input name="j_username" type="text" id="appt" size="20" maxlength="9"></td>
          </tr>
          <tr> 
            <td>Password:</td>
            <td><input name="j_password" type="password" id="password" size="20" maxlength="9"></td>
          </tr>
          <tr> 
              <td colspan="2">Forgotten Password ? contact Nitish. New Users <a href="register.cfm">Click 
                Here</a>. </td>
          </tr>
          <tr> 
