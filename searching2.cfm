...
<cfoutput>#advancedsearch1#</cfoutput>
...
<!---<cftry>--->
<cfoutput>
 <cfinclude template="getrecords.cfm">
 </cfoutput>
	...
	<tr><td align="center"><a href="cart.cfm"><img src=http://www.semiprecious.com/images/smallcart.gif border="0" width=25></a><br><a href=cart.cfm>Cart</a></td></tr>
		...
		<cfif category eq "rings">
					...
					<tr class="greenbutton"  align="center">
						...
						<!---		<cfelse>--->
							<a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=pricedesc'>Premium #categ# </a> || &nbsp;&nbsp;
						<!---	</cfif>--->
											
					<!---	<cfif url.sortorder neq "datetaken desc">--->
							<a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=datetaken'>New Arrivals in #categ#</a> || &nbsp;&nbsp;
							<!---<cfelse>--->
							<a href='cheap-#categ#.cfm'>Cheaper #categ#</a> || 
