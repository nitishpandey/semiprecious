...
<cfif contentbypage.recordcount >
...
<cftry>
 <cfif category neq "ALL">
  <cfquery DATASOURCE="gemssql"  name="getlist">
	select  distinct stone as subcat2, sum(inventory)  as inventory from CatSubCatInStock  where cat='#category#' and inventory>0 and stone <>'bulk lots'  and stone <>'fabric' and stone<>'silk thread'  group by stone  order by <cfif sortby eq 'stone'> stone<cfelse> inventory desc</cfif>  
	</cfquery>
<cfelse>
  <cfquery DATASOURCE="gemssql"  name="getlist">
...
<h2 align="center" name="alpha_list" style="font-size:14px;font-weight:bold;color:#CC0000;">ALL GEMSTONES LISTED IN ALPHABETICAL SEQUENCE<br></h2>
...
<cfset alpha_list = "" />
<cfoutput>	
<td class="greenbutton" colspan="#displaycolumns#" >		<cfset a = left(subcat2,1)>
<a name="#a#" style="text-decoration:none;" ><h2 style="display:inline;">#a#</h2></a></td>
</cfoutput>	  <CFLOOP QUERY="Getlist">
	<cfif a neq left(subcat2,1)>
		<cfset a = left(subcat2,1)>
<cfset alpha_list = listappend(alpha_list,a) />
<cfset columns = 1>	 

<td colspan="#displaycolumns-columns#">&nbsp;</td></tr><tr><cfoutput>	
<td class="greenbutton" colspan="#displaycolumns#"><a href="##alpha_list" style="display:inline;">Back to Top</a>&nbsp;<a name="#a#" style="text-decoration:none;" ><h2  style="display:inline;">#a#</h2></a></td>
</cfoutput></tr>
	</cfif>
...
<cfif  category eq "all" or category eq "beads">
   <cfelse>
	...
	</cfif>		<td class="stoneslisting"><cfoutput><img src=/images/#category#/thumb/#getbest.bestitemid#.jpg width=65 alt="#subcat2# gemstone thumbnail"><br><a class="reg_price" href='/#replace(lcase(subcat2)," ","",'all')#<cfif category neq "ALL">_#category#</cfif>.cfm'>#ucase(subcat2)# <cfif category is "ALL">JEWELRY<cfelse>#ucase(category)#</cfif></a> (#inventory#) </cfoutput> </td>
	</cfif>
...
<cfoutput>  <cfif pagedescription neq "" or session.mail is application.admin_email>
  ...
  </cfif><tr><td colspan="#displaycolumns#">
...
<div  style="border:1px orange gray;position:absolute;top:145px;padding-left:20px;">
<cfloop index="a" list="#alpha_list#">
	<a href="###a#">#a#</a>&nbsp;
</cfloop>
</div>
</cfoutput>  
