...
Select  case 	when inventory>0 then '0' else '1'
		end as instock,
...
<tr><td colspan=6><font size=6 color=green>Hundreds and then thousands of beads coming mid November!! To get an email announcement of our launch, subscribe <a href='apply.cfm'><font size=6>here</font></a>	.</font></td></tr>
</cfif>
<tr  class="greenbutton"  align="center"><td colspan=2 align="left" style="border-top:2px ridge #dark#"> <cfif  start GT 1>
		...
		<cfelse>&nbsp;</cfif>[#getlist.recordcount# Designs]</td><td colspan="4" align="center"  valign="middle"  class="greenbutton" style="border-top:2px ridge #dark#">          
