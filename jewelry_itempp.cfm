...
alert("Aha! Photo Stealing eh? Bhag yahaan sey, chal phut!");
return false;
}
return true;
} 
...
<cfif details.storage EQ 'pippin'>
               <img width="#width#"  src ='#details.imagelink#' alt="100% Satisfaction Guaranteed"  border="0">
<cfelse>
...
<cfelse>
	...
	<cfif category eq "necklaces"><a href='http://www.qvc.com/jw/jw_necksizeguide.html' class="highlightred">Necklace Size Guide by QVC</a> 
        ...
        <br />
	  	...
	  	<tr><td  align="Left"><cfif stonename NEQ ""><a href='/<cfoutput>#stonename#</cfoutput>.htm'><i>Learn more about this and other semi precious stones</i></a></cfif>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span  style="color:maroon;font-size:11px;">For more information, reporting an erorr or to order online call Toll Free <cfoutput>#Application.tollfree#</cfoutput></span></td></tr>
