...
select indate, cat, cartstatus.cartid as cartid, itemid, optionid, quantity from buyingrecord, items,cartstatus  where buyingrecord.cartid = cartstatus.cartid and items.newitem = buyingrecord.itemid  and ( MAKEONDEMANDNOTE LIKE '#form.code#I2U%') and buyingrecord.cartid > 97300 order by indate asc
