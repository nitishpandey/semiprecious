...
select indate, cat, cartstatus.cartid as cartid, itemid, optionid, quantity ,size,size2,WEIGHT,metalwt from buyingrecord, items,cartstatus  where buyingrecord.cartid = cartstatus.cartid and items.newitem = buyingrecord.itemid and inventoryatsale = -1 and  ( MAKEONDEMANDNOTE LIKE '#supcode#SHI%') and quantity > 0 and buyingrecord.cartid > 97300 order by indate asc
...
</td><td>#Quantity#</td><td>#size#</td><td>#size2#</td><td>#WEIGHT#</td><td>#metalwt#</td>
<td>
#replacenocase(d.makeondemandnote,"#supcode#SHI","")#
</td>
<td>#e.indate#</td>
<td>
<!---
<a href="http://www.semiprecious.in/myproject/MOO/CancelMOO.aspx?itemid=#itemid#&cartid=#cartid#&optionid=#optionid#&date=#e.indate#" target="_blank"> Cancel (30 hours)</a>
<a href="http://www.semiprecious.in/myproject/MOO/modlist.cfm?action=cancel&itemid=#itemid#&cartid=#cartid#&optionid=#optionid#&date=#e.indate#" target="_blank"> Cancel (30 hours)</a>
--->

<td/>
<td><a href="http://www.semiprecious.in/myproject/MOO/modlist.cfm?action=cancel&itemid=#itemid#&cartid=#cartid#&optionid=#optionid#" target="_blank"> New</a> </td>
</tr>
</cfoutput>

</table>
<cfset myStringVar = "#supcode#SHI#Now()# ">
...
&nbsp;&nbsp;<a href="http://www.semiprecious.in/myproject/MOO/UndoModlist.cfm">To Undo an item marked as shipped please click here</a>
</form>
</div>
<br/>
<br/>
