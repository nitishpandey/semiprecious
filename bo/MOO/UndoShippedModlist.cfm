...
<head>
 <title>
	Undo Shipped Items - Managing Semiprecious Orders
</title>
...
<br/>
<div align="center" id="msg" style="padding-left:40px;font-size:bold;align:center;color:Blue;">UNDO SHIPPED ITEMS </div>
<br/>
<cfparam name="form.code" default  = '#supcode#WIP' />
<br/>
<cfif isdefined("form.ship") >
		<cfloop list="#form.ship#" index="ind" >
				...
				<cfquery  datasource="gemssql" >
					...
					update  moo set SHIDate=NULL  where cartid = #cartid_# and itemid = #itemid_# and optionid = #optionid_#
...
<div id="msg1" style="padding-left:40px">
...
select indate, cat, cartstatus.cartid as cartid, itemid, optionid, quantity from buyingrecord, items,cartstatus  where buyingrecord.cartid = cartstatus.cartid and items.newitem = buyingrecord.itemid and inventoryatsale = -1 and ( MAKEONDEMANDNOTE LIKE '#supcode#SHI%') and quantity > 0 and buyingrecord.cartid > 97300 order by indate asc
...
<td>ITEM ID</td><td>DESCRIPTION</td><td>QUANTITY</td><td>SELECT ?</td><td>DATE ORDER</td></tr>
<cfoutput query="d">
<tr>
