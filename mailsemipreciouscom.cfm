...
<cfparam default="1" name="Caller.mailerror" type="numeric">
...
<cfhttpparam name="HTMLTextBox1" value="#Attributes.mailcontent#" type="formfield">
<cfhttpparam name="HTMLBox1" value="#Attributes.mailcontent#" type="formfield">
