...
<td align="center" valign="top"><cfset themedesc = "">
...
<cfif category neq "all" and category neq "">
    ...
    where cat='#category#'
    and (hubsequence <> 99)
    order by  hubsequence 
<cfelse>
    select distinct GroupName, description, hubsequence, cat  from Groupings 
  ...
  <table cellpadding="0" cellspacing="0" style="padding:5px 5px 5px 10px">
    ...
    <cfif subcat eq "">
      ...
      <cfif category eq "bracelets">
        <tr>
          ...
          <cfset themeimage = "/images/bracelets/thumb/581.jpg">
          <CFINCLUDE TEMPLATE="hubs-themeitem.cfm">
          ...
          <cfset themeimage = "/images/bracelets/thumb/1053.jpg">
          <CFINCLUDE TEMPLATE="hubs-themeitem.cfm">
        </tr>
        <cfset itemcount = 2>
        <cfset imagesUsedList = "581,1053">
      </cfif>
    </cfif>
...
--->
    ...
    FROM Items 
     ...
     INNER JOIN ItemsByGroup
    
    ON  ItemsByGroup.itemid = Items.newitem
    WHERE
    (
    ...
    ORDER BY Items.g2i desc
          ...
          <cfoutput>#vcount#XXX#Groups.Groupname#=#Groups.description#<br  /><br  /><br  /><br  /></cfoutput>
