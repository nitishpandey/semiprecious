...
<cfif cgi.server_name does not contain "wholesale-gemstone-jewelry.com" or category eq "beads">
        ...
        <tr>
              <td height="225" align="center" valign="top" colspan=<cfoutput>#displaycolumns#</cfoutput> class="<cfoutput>#replace(subcat," ","_")#</cfoutput>_header"><table width="90%" border="0" cellspacing="0" cellpadding="0">
                <tr>
<cfif subcat  neq "moonstone" and subcat neq "crystal" and subcat neq "chain-silver" and subcat neq "amber" and subcat neq "chalcedony" and subcat neq "quartz" and subcat neq "turquoise">
                  <td height="120" align="left" valign="bottom" class="white_txt11"><cfoutput>#metatitle#</cfoutput></td>
					...
					<cfif getlist.cat is 'earrings'><cfset earringsdone="yes"><cfset getlist.style=""></cfif>
						...
						Select top 1 newitem from items where cat='#cat#' and style like '%#getlist.style#%' and subcat='#subcat#' order by newitem desc
						</cfquery>
						<cfoutput><table border=0 ><tr align="center" valign="center" ><td align="center" valign="center" height=150 width=150>
						<a href='list.cfm?subcat=#subcat#&category=#cat#&style=#getlist.Style#'><img src=images/#cat#/thumb/#getfirstitem.newitem#.jpg border=0 <cfif cat is "beads" or cat is "necklaces" or cat is "bracelets">width=120</cfif>></a>
						</td></tr></table>
						</cfoutput>
						...
						<a href='list.cfm?subcat=#subcat#&category=#cat#<cfif getlist.style neq "">&style=#getlist.Style#</cfif>'><b>[#inventory# designs]</b></a><p>
						</cfoutput></td>
					  
						
						<cfif columns EQ displaycolumns>
							<cfset rowsdisplayed = rowsdisplayed + 1>
							</tr><tr><td height=10 colspan="<cfoutput>#displaycolumns#</cfoutput>" bgcolor=black></td></tr>
							<CFSET columns=1>
						<cfelse>
