...
<cfoutput>
  <table border="0" width="800" cellpadding="0" cellspacing="0"  >
    <tr  >  <td width="93" valign="top" bordercolor="##999933" bgcolor="white"   >
  <table width="93" border="0" cellpadding="0" cellspacing="0"  bgcolor="##D3D3AA" >
        <tr >          <td     >
		  		  <b><font face="Geneva, Arial, Helvetica, sans-serif" color="##000000"><span class="category">#Category#<br>
              Available In</span></font></b>
			</td>
<cfset category = ""><cfinclude template="subcatvertical.cfm">
</table> </td>
    <td valign="top" align="center"> &nbsp;&nbsp;&nbsp; <span class="row2">If you have any comments, queries, requests 
      call us at 001-512-589-9009 or write to us <a href="contactus.cfm">here.</a></span>
	...
	<table align="center" >
      <tr valign="top">
        ...
        <td valign="top" align="left">
		 ...
		 <Table cellpadding="2" cellspacing="0" width="706"  >
 ...
 <cfset session.filterarray = arraynew(2)>  
		...
		--->
            ...
            <tr  > 
              <cfloop from="1" to="#columns#" index="indx">
                <td  class="row3" nowrap><a href='detail.cfm/#item_array[Indx]#.htm' >
                  <b>Zoom</b></a>&nbsp;&nbsp;&nbsp;
				  <cfswitch expression="#status_array[indx]#">
				  <cfcase value="1"> <font color="##000099">#price_array[indx]#</font>&nbsp; &nbsp;&nbsp;<a href='detail.cfm/#item_array[Indx]#.htm' > 
                  <b>Buy</b></a></cfcase>
				  <cfcase value="-1"><font color="##000099" ><s>#price_array[indx]#</s></font>&nbsp; &nbsp;&nbsp; <a href='detail.cfm/#item_array[Indx]#.htm'  > 
