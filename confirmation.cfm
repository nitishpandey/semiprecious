...
>>>>>>> 517cdd0b57a55d33c250fd80a427d5856e5c669c
		          ...
		          <td colspan="1" style="padding:4px;font:16px;font-family:courier;border:red 2px dashed;color:black;">
		            ...
		            <td align="right"><strong>Yes</strong>	<!--- value being added and shown as shipping #format(GiftWrap)# ---></td>
		        </tr>
      <cfelse>
		      <cfset gw = "">
				    <tr>
    ...
    <cfif isdefined("session.giftid")>
      <cfif session.giftamt GT 0>
        ...
        <tr>
          <td colspan="2" align="center" class="headerfontsmall">GIFT AMOUNT REDUCED
...
alert("For whole sale purchase pse make purchases of atleast $200 (after discount) before you can check out.");
        ...
        <cfelse>
        <tr>
          <td colspan="2" align="right"  ><cfset bbdf = 0 />
            <cfif amount GT 1999>
