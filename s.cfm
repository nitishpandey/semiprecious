...
<!--- End all the queries.  Start actual html --->
      ...
      <h3 class="toggler"> <span style="cursor:pointer" border="0px" align="center"  class="green_bg side_hd" onClick="flipDisplay('LeftGemstoneDisplay')"  style="padding:0px;text-transform:capitalize;"><cfoutput>#categ# by&nbsp;Gemstone</cfoutput></span>
	  </h3>
...
<cfoutput>
    <cfif category neq "" and category neq "ALL">
			<a  href='/#categ#.cfm' class="side_link" >All #categ#</a><br />
    <cfelse>
			<a  href='/jewelry.cfm' class="side_link" >All stones</a><br />
     </cfif>
...
#subcat2# <cfif len(subcat2) LT 10>#lcase(categ)#</cfif><font color=grey size=-2>(#inventory#)</font><cfif style neq "">-#style#</cfif></a><br />
...
#subcat2#<cfif style neq "">-#style#</cfif></a>			<br />
		<cfelse>
		<a  href='/#subcat3#_#category#.cfm<cfif style neq "">?style=#style#</cfif>' class="side_link" id="#subcat2#" >
...
<br />
		...
		<!---<cfif category eq "" or category eq "ALL">--->
<a href=/rare-stones/rare-gems-<cfoutput>#categ#</cfoutput>.cfm><b>More Gemstones</b></a>
		<!---</cfif>--->
	</cfoutput>
 </div>
