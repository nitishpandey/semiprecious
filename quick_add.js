		...
		//alert(3);
						...
						if (method*1 == 0)
							...
							if (method*1 == -1)
							{
								...
								document.getElementById(k).innerHTML = "<img src='/added.png' height='16px' />";
							...
							document.getElementById(k).innerHTML ="<img src='/added.png' height='16px' />";
							document.getElementById(qty_id).selectedIndex = 0;
							document.getElementById(over_thumb).innerHTML = "<DIV style='background-color:white;'>" + method +" added to cart </DIV> [<a href='/cart.cfm' style='cursor:pointer;background-color:white;text-decoration:underline;'>view  cart</a>]";
							try {
								// better leaving it there for user to have an anchor			document.getElementById(options_id).selectedIndex = 0;
								} catch(e){ 
									// do  nothing because all may not have an option  drop down
