...
<cfmail from="cs@semiprecious.com" subject="wholesale jewelry affiliation programme" to="#trim(urldecode(url.resendmail))#" bcc="scorpionitish@yahoo.com"  server="mail23.webcontrolcenter.com" type="html" failto="nitish@semiprecious.com">
...
<cfmail from="cs@semiprecious.com" subject="Your registration at wholesale store" to="#trim(urldecode(url.resendmail))#" bcc="scorpionitish@yahoo.com"  server="mail23.webcontrolcenter.com"  failto="nitish@semiprecious.com">
...
<!---THIS CHANGED BY ANUP, BULKBUYER IS STILL IN MYSQL---> 
	  <CFQUERY datasource="sptm" name="purchaserinfoinmemory"	cachedwithin="#createTimespan(0,0,15,0)#">
		
		<cfquery name="purchaserinfo" dbtype="query" >
  SELECT name as firstname, address as address1, phoneno as phonenumber, address2, city, state, country, zip FROM purchaserinfoinmemory
...
<script language="JavaScript" type="text/javascript" src="/js/global.js?ver=1.2">
</script>
...
document.cartform.SpecialHandling.options[1]=new Option("Priority Mail $4.99","4.99");
document.cartform.SpecialHandling.options[2]=new Option("USPS Express Mail $24.99","24.99");

break;

default:
document.cartform.SpecialHandling.options[0]=new Option("Select Shipping Method","");
document.cartform.SpecialHandling.options[1]=new Option("USPS Express Mail $34.99","34.99");
document.cartform.SpecialHandling.options[2]=new Option("DHL Express $55","55");
break;
...
//alert('i called successfully');
 ...
 //alert(url);
   ...
   if (qty == 0 )
	...
	if(document.getElementById('x_ship_to_country').value != '' && document.getElementById('SpecialHandling').value == '-1'){
...
<span style="margin-left:80px;">REVIEW FOR YOUR ORDER (ORDER ID:</span> <font color="black"><cfoutput>#session.cartid#</cfoutput></font>)</span></div>
<!--- <cfif len(cart_msg)><div align="center" class="green_band_ticked"><cfoutput>#cart_msg#</cfoutput></div></cfif>
 ---></div><p>&nbsp;
<p>
<TABLE bordercolor="#FFF" border="0" width="772px" style=" <cfif checkout eq 'yes'>display:none;</cfif>border:1px #fff solid" cellspacing="0">
 <cfoutput><tr class="grayplacard" >
<!--- <TH width="18%" >	<cfif checkout is 'no'><img src="/images/que.gif" style="display:inline;" onClick="MM_showHideLayers('look_set_hint','','show')" />We Suggest</cfif>  </TH> --->
  <TH width="150px" colspan="1">	<cfif checkout is 'no'>Edit Cart</cfif></TH  >
  <TH width="39%" colspan="2">Design</TH  >
  ...
  <TH width="12%">Amt (#session.currency#)</TH>
    ...
    <CFQUERY NAME="qprice" DATASOURCE="gemssql" >
           SELECT	storage, subcat+ ' ' + cat as description,status,storage,thumblink,orderonrequest,inventory, 
                    optionid,newitem,quantity,buyingrecord.rate as rate,cat as category  
           FROM		Items, buyingrecord 
           WHERE    items.newitem=buyingrecord.itemid
           AND		newitem IN (#lstItemsInCart#)
		...
		<tr class="#rowb#" id="#newitem##optionid#" >
			<td   style="text-align:center;padding-right:6px;">
				<cfif checkout is 'no'>
    				...
    				<cfif quantity GT 1>
						<a href="javascript:reduce_item(#newitem#,#optionid#,1,#rate#);">  
                        	<font color="##CC2020">
                            	Reduce Qty
                            </font>
                        </a> 
                        <img src="/images/dnarrow.gif" width="13" height="13" alt="reduce"><br>
					</cfif>
                    <a href="javascript:reduce_item(#newitem#,#optionid#,0,#rate#);">
            ...
            <cfset TotalQty=quantity+TotalQty>
          	<td  align="center">
                ...
                <cfelse>
              	...
              	#decimalformat(value_convert(rate))# </span>
              	<input type="hidden" name="price#j#" Value="#DecimalFormat(rate)#">
            </td>
            <td  align="center">  <span id="added_#newitem##optionid#">#quantity#</span>
            </td>
            
            <td  align="center"><span id="amount_#newitem##optionid#">#decimalformat(value_convert(amounts))#</span>
              <input type="hidden" name="amount#j#" id="amount#newitem##optionid#" Value="#amounts#">
            </td>
			</tr>
<cfif qprice.inventory LT 1 and qprice.orderonrequest is 1><td colspan=6 align=center bgcolor=white><font color=red><strong>THE ABOVE ITEM IS CUSTOM MADE FOR YOU, THIS WILL DELIVER IN 3-5 WEEKS</stong></font>
...
<cfelse>
<td colspan=6 align=center><font color=purple>ABOVE ITEM SHIPS IN 24 to 48 hrs</font>
</td></tr></cfif> 
...
<cfelse>
	<cfif checkout is 'no'><div style="padding:1px;background-white;border:1px red ridge;width:115px;margin:2px;"><div style="background:red;color:white;padding:4px;" align="center" ><a style="color:white;"  href="/cartcontrol/cartmonitor.cfc?method=emptycart" onClick="javascript:return confirm('All items will be removed from the cart!');">Click Here To Empty Your Cart</span></a></div></div></cfif>
			      <cfif quantity GT invent or (pendant GT chain )>
	You could pick up a <a href="chains.cfm?cart_suggest=1">silver chain from here</a> for the pendant you have picked.
      </cfif>
	</cfif>
</td>
...
<tbody style="display:;">
 ...
 slowing down the page tremendously
				...
				</font></td><tr><td align="right" style="padding-bottom:40px; <cfif checkout eq 'yes'>display:none</cfif>" colspan="2" nowrap="true"> 			     <font size=+1>
...
Shipping Discount for Orders over #format(application.retail_free_shipping)# [Free within US]<br />--->
 ...
 <img src=/images/startcheckout.jpg></a></a></td></tr>
<cfif cgi.server_name contains 'wholesale'>   <tr >
		...
		<br />
 <tr><td colspan="2" align="center"><a href="https://<cfoutput>#cgi.server_name#</cfoutput>/cart.cfm?cartid=#cartid#&country=<cfoutput>#session.address.country_code#</cfoutput>&checkout=yes">
 <img src=/images/startcheckout.jpg></a></a></td></tr>
...
<cfabort>
	...
	<table style="z-index:4;background-color:purple;width:390px;border:1px solid orange;position:absolute;top:160px;left:260px;"><tr><td>  <form style="background-color:white;" method="post" name="frmUpdAddress">
...
<br />		 
   <img src="/images/moreshopping.gif" style="border:2px gray ridge;width:120px;cursor:pointer" onClick="javascript:goProcess('buy more')" > &nbsp;
		...
		<tr ><td colspan=2 align="center">	 <tr ><td colspan=2 align="center" >   <img src="/images/moreshopping.gif" style="border:2px gray ridge;width:120px;cursor:pointer" onClick="javascript:goProcess('buy more')" > &nbsp;
				...
				<tr>
                	<td colspan="2" bgcolor="##603082" style="color:##FFFFFF" height="20px">
                    	<strong>
                        	Shipping Details.. 
                        </strong>
					...
					<tr>
				  	...
				  	<tr>
                  		...
                  		<select name="x_ship_to_country" id="x_ship_to_country" onchange="javascript: dropdownlist(this.options[this.selectedIndex].value);">
                            ...
                            <option value="AUSTRALIA">AUSTRALIA (2 to 4 weeks)</option> 
...
<cfinclude template="/includes/countries_drop_down.htm" />&nbsp;
			    ...
			    <tr>
                	<td  align="right"><b>Email(<span class="form_heading">Optional</span>): </b></td>
                	<td  align="left">
...
<option value="">Select Shipping</option>
              ...
              <cfoutput>
               ...
               <cfif IsDefined('session.mail') AND session.mail neq ''>
			    ...
			    <tr <cfif checkout eq 'yes'>style="display:none"</cfif>><td colspan=2 align="center">   <img src="/images/moreshopping.gif" style="margin-top:2px;border:2px gray ridge;width:120px;cursor:pointer" onClick="javascript:goProcess('buy more')" > &nbsp;
				<font color="##603082" size=+1><b>OR CONTINUE CHECKOUT BELOW</b></font>  
				</TD>
				<tr><td colspan="2" bgcolor="##603082" style="color:##FFFFFF" height="24px"><strong>Shipping Details.. <cfif IsDefined('session.mail') AND session.mail neq ''><br>{Same As Registered ?}<input type="checkbox" name="sameas" id="sameas" onClick="fnFillForm(this);" style="background-color:##603082;border-color:##603082"></cfif></strong></td></tr>
            	  ...
            	  <table style="border-collapse:collapse" align="left" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <select id="x_ship_to_country" name="x_ship_to_country" onChange="fnGetShipInfo(this,'#varCartTotal#')">
                ...
                <tr>
                	<td  align="left"> <b>Shipping Options</b>: <br />
                	</td>
                	<td  align="left" >
                    <div id="tdShipInfo">
                        <select name="SpecialHandling" id="SpecialHandling">
			  ...
			  <cfelse>
			  <tr>
           	    <td align="left"><b>Email</b><cfif 1 or url.country eq "USA">(<span class="form_heading">Optional</span>)</cfif>: </td>
...
<span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=hF33DTtyM65nCwzDN0SwqGGgTQPxn3o4Ym0uzkuDY7OQkc0HNahexOlJ"></script>
--->
		   <span style="color:gray;">Coupon or Gift Code (If Any):</td><td> <input name="couponcode" type="text" class="detail" value="" size="12" maxlength="18">   &nbsp;&nbsp;&nbsp; Agent Code, if any: <input name="agentcode" type="text" class="detail" value="" size="12" maxlength="8"><br />	    
</td>
      </tr>
			      <tr>
	              ...
	              <tr id="giftmsg">
	                ...
	                <td align="left" nowrap ><textarea rows=3 cols=50  name="giftmsg"  onClick="javascript:this.value='';return;" VALUE="" MAXLENGTH="245" ></textarea>
								 ...
								 <tr>
	                <td align="left">  
                    	<b>Comments/Special Instructions:</b> 
                    </td>
	                <td align="left" nowrap >
                    	<textarea rows=5 cols=50  name="txtAreacomments" VALUE="" MAXLENGTH="450" onClick="javascript:this.value='';return;">
			  ...
			  <cfif len(session.mail) and session.loyalty_points and session.mail contains '@'>
		                <tr>
		                  <td align="left">  <b>Loyalty Discount</b><a href="viewinvitecredits.cfm" ALT="friends invited for jewelry site">[?]</a>:</td>
     				  ...
     				  <cftry>
						...
						<cfcatch type="any">
						                <cfmail to="stacyanup@gmail.com" from="cs@semiprecious.com" subject="at cart Could not reverse " server="mail23.webcontrolcenter.com" type="html">
      ...
      <tr>
	    ...
	    <cfoutput>
			...
			<tr><td style="padding-top:4px;" align='center' colspan="2">
                ...
                <input class="inputtext" name="GrandTotal" type="hidden" id="grandtotal"  value="#decimalformat(subTotal + shipping)#" size="6" maxlength="9"> <div class="green_band" style="padding:4px;">Any Applicable Discounts Will Be Calculated On Confirmation Of Cart &nbsp;&nbsp;</div>
           </cfoutput>     
                <cfset session.grandtotal = subTotal  />
		...
		<input type="submit" style="font-weight:bold;font-size:1.1em;display:inline;cursor:pointer;padding:4px;height:34px;" class="action_button" onlick="javascrip:goProcess('Proceed to Checkout')" value="Save Cart / Select Payment Method  &rarr; " />   
		         </cfif>
...
<font size=+1>OR 	
			 START CHECKOUT BELOW</font>			</TD>
			  ...
			  <tr border=1>
			  <td colspan="2" align="center">	
				 <cfoutput><form name="formname" action="/#session.cart#?cartid=#session.cartid#&country=#session.address.country_code###checkout" method="get" ></cfoutput>
