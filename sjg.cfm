...
<!---<div style="color:white;background:##666666;font-size:16; VERDANA,arial;line-height:2;width:350;text-align:center;font-weight:bold">
		LABOR DAY SALE <span style="padding:10;background:black">30% off all items!</span></div>--->
         ...
         <span class="found_header">Showing
				<cfoutput>
		...
		<cfif ((category neq "jewelry" and category neq "All" and (not findnocase(category,GetFileFromPath(GetBaseTemplatePath())))) or (subcat neq "" and (not findnocase(subcat,GetFileFromPath(GetBaseTemplatePath())))) or groupname neq "" or pricegreater neq "0" or priceless neq "" or (color neq "" and (not findnocase(color,GetFileFromPath(GetBaseTemplatePath())))))>
