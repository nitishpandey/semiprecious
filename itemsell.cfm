...
<cfparam name="cartid" default="" type="integer" />
...
<cftry>
	  ...
	  <cfif newcartissues.recordcount>
		...
		<cfloop query="viewdetails" >
  	     ...
  	     <cfinvoke  component="tm.cfc.task" method="getnewcartissues" returnvariable="newcartissues">
            <cfinvokeargument name="cartid" value="#cartid#"/>
          </cfinvoke>
	  <cfif newcartissues.recordcount>
		  <div style="width:900px;height:100px;overflow-y:scroll;border:0px black ridge;padding:2px;">
...
<cfif url.couponcode is 'india'>
	...
	RK Puram, Sec 13<br />
	New Delhi - 22
	<cfelse>Anup Pandey<br>1512 Anise Drive<br />
Austin, TX 78741<br />
</cfif></font></td></tr></table>

      <div  cols="100" ROWS="5" NAME="promo" id="promo">
	  Please check out other great products from us:
	  <a class="side_link" href="http://www.elinamira.com">Trendy fine affordable jewelry by Eina Mira</a> (www.ElinaMira.com)
	  	  </div>
