 ...
 displaycolumns = 4;
		...
		select * from items with (nolock) where newitem = 7130
						...
						<cfcatch type="any">
							...
							<cfset getlist2.cat = category /> <cfset getlist2.recordcount = 0 /> <cfset getlist.recordcount = 0 /> <cfmail to="anup@semiprecious.com"  server="mailA40" subject="nothing in getrecords...gallery reporting" from="service@semiprecious.com"
 type="html" >
 #cgi.HTTP_REFERER#
