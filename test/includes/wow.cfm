...
<cfset k = arraynew(1) />
 <cfquery datasource="sptm" name="coll">
	select   collection_id, link_to_page from collection_id_map where status = 'active' and start_date <= #now()# and end_date >=#now()#
</cfquery>
...
<cfset i_count = 0 />
var i_count = #i_count#;
<cfset _location= '/images/crings'>
var pics_array = [
<cfloop from=1 to=4 index="i_count">
'#LOCATion#/pic#i_count#.jpg',
...
<cfset _location = '/images/crings'>
<cfset i_count = 0 />
<cfloop from=0 to=7 index="i_count">
Pic[#i_count#] = '#replace(location,"\","/","All")#/pic#i_count#.jpg';
</cfloop>
</cfoutput>

Pic_text[1] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">You Get to</div>';
Pic_text[2] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">Mix and Match</div>';
Pic_text[3] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">Citrine or Iolite or ...?</div>';
Pic_text[0] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">Silver or Gold?</div>';
Pic_text[4] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">No Limits</div>';
Pic_text[5] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">Choose The Stone</div>';
Pic_text[6] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">Choose The Design</div>';
Pic_text[7] = '<div style="text-decoration:none;text-align:center;border:;color:brown;">We Make it Just for You!</div>';
