...
Select top 2000 weight, size, totalqtysold, itemnumber as optcount, grouping, color, getdate() as lastbought, case 	when inventory>0 then '0' else '1'
   ...
   buylink ,  orderprice from (SELECT  top 4 weight, size, 0 as orderbuy,  totalqtysold, itemnumber,  grouping, color, lastbought, restockdate, disporder, disporderwhole, newitem, CAT, style, subcat, subcat2, datetaken,   NameID,  price, basecost, saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
   ...
   items  </cfif>
     where storage='Angela' and inventory>-1 <CFIF category NEQ "ALL">
