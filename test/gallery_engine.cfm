	  ...
	  <cfswitch expression="#status#">
		...
		<cfelse>
           ...
           <cfif not len(session.bulkbuyer.id)>
			<div class="sale">
            <span class="sale_price"><span  title="Black Friday" style="color:white;background:black">BF Sale!</span> <span class="reg_price">#format(price)#</span> #format(saleprice*session.sale_factor)#</span>
                                	...
                                	<cfif (inventory LTE 0) and orderonrequest>
            	                     ...
            	                     <cfif getgallery.storage contains 'IN-'>
                                         <div style="margin-top:5px">
                                            <font color=red><b>5 week delivery</b></font>
                                       </div>
                	             <div style="margin-top:-5px;">
                                    <cfelse>
                                     <div style="margin-top:5px;">
