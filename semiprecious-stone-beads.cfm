...
<CFINCLUDE TEMPLATE="setup.cfm">
		...
		<cfelse>
			<CFPARAM NAME="url.sortorder" DEFAULT="lastbought desc" >
		</cfif>
...
orderbuy, disporder, newitem, CAT, subcat, datetaken,  NameID,   size,  price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
   buylink ,  orderprice from (SELECT 0 as orderbuy, lastbought, restockdate, disporder, newitem, CAT, subcat, datetaken,   NameID,    size, price  , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink,
...
<!---<cfif jewelrysize NEQ ""> and size>19</cfif> --->
  ...
  <CFIF advancedsearch is not "">
    UNION lastbought, SELECT 1 as orderbuy, disporder,newitem, CAT, subcat, datetaken, NameID,   size,    price    , saleprice, status, wholesaleprice, Description, inventory,  storage, thumblink, imagelink, buylink, case status when 3 then saleprice else price end  as orderprice from Items where (inventory>#invstatus#)
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#'             )
      </CFIF>
  ...
  <CFIF advancedsearch is not "">
    UNION lastbought , SELECT 2 as orderbuy, disporder, newitem, CAT,  subcat, datetaken, NameID,   size,    price    , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink,imagelink, buylink,case status when 3 then saleprice else price end as orderprice from Items where (inventory>#invstatus#)
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#' 
     )
  ...
  <CFIF advancedsearch3 is not "">
    UNION SELECT 3 as orderbuy,  disporder, newitem, CAT,  subcat, datetaken, NameID,  size,     price    , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink, buylink, case status when 3 then saleprice else price end as orderprice from Items where (inventory>#invstatus# )
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#' 
         )
  ...
  <CFIF advancedsearch1 is not "">
    UNION 	lastbought, SELECT 4 as orderbuy,disporder, newitem, CAT,  subcat, datetaken, NameID, size,     price    , saleprice, status, wholesaleprice, Description, inventory, storage, thumblink, imagelink, buylink, case status when 3 then saleprice else price end as orderprice from Items where (inventory>#invstatus# )
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#' 
      )
...
<cfif isdefined("form.submit5")>
  ...
  select disporder, newitem, CAT, subcat, NameID,  storage, thumblink, imagelink, size,  price  , saleprice, status, wholesaleprice, Description, subcat, inventory, buylink  case status when 3 then saleprice else price end as orderprice from Items 
  <cfif isdefined("form.submit5")>
    where (saleprice 
...
<cfif subcat is 'amber'><cfinclude template="pippinindex.htm"></cfif>
...
<TITLE style="text-transform:capitalize;">  
 <cfif category is "ALL" or category is "">    <cfset p = "Jewelry">    <cfelse><cfset p = category>   </cfif> #titleCase(color)# semiprecious Gem Stone #titleCase(subcat)# #style# #titlecase(p)#</TITLE>
<meta name="keywords" content="affordable #color# Gem stone, #subcat#, #p#, semiprecious">
<meta name="author" content="Anup Pandey" />
<meta name="description" content='#subcat# #p# wholesale from around the world, over 1000 stone beads shipped from Austin, TX. Semiprecious large and small beads.<CFLOOP QUERY="Getlist" startrow="#start#"
...
<tr style="width:800px;" align="center"> 
	...
	<td  style="border-bottom:1px black solid;width:91px;"><CFINCLUDE TEMPLATE="subcatverticalbeads.cfm">
	 </td></tr></table>
...
<tr><td colspan=6 align=center><cfif subcat neq ""><font size=+1>#SUBCAT# Beads</font><br></cfif><font size=+1>Minimum Purchase for Beads is $50 due to the prices we offer<br>
<font color=green>Always adding new beads!</font></td></tr>
</cfif>
					<tr class="greenbutton"  align="center">
						<td colspan=2 align="left" style="border-top:2px ridge #dark#">
							<cfif start GT 1>
								<cfset newstart = start - display>
								<cfif newstart LT 1>
									<cfset newstart = 1>
								</cfif>
								<a href='semiprecious-stone-beads.cfm?#sj#&category=#category#&start=#newstart#&sortorder=#url.sortorder#&subcat=#subcat#&color=#color#&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(urldecode(advancedsearch))#&style=#style#' ><img src="images/prev.gif" name="prev" hspace="0" vspace="0" height="18"  border="0" align="absmiddle"></a>&nbsp;&nbsp;
							<cfelse>
								&nbsp;
							</cfif>
							<cfif url.sortorder neq "lastbought desc">
							<a href='semiprecious-stone-beads.cfm?category=#category#&sortorder=lastbought'>Purchased by others</a>
							<cfelse>
							<a href='semiprecious-stone-beads.cfm?category=#category#&sortorder=pricedesc'>Premium First</a>
							</cfif>
 ...
 <!---     To see and order any out of stock items please click here <a href="semiprecious-stone-beads.cfm?invstatus=-3&color=#color#&category=#category#&subcat=#subcat#&priceless=#priceless#&#sj#">SEE 
...
#cgi.QUERY_STRING# . 
      ...
      <cfelse>
    <!---  <cflocation url="semiprecious-stone-beads.cfm?&relocated=1&invstatus=-3&color=#color#&category=#category#&subcat=#subcat#&priceless=#priceless#&#sj#"  addtoken="no" />
	--->
    </cfif>
    <!---Often designs and range is discontinued due to  declining     interest.   
	  <form action="semiprecious-stone-beads.cfm" method="post"  style="display:inline;" >
      <br>
...
--->
  ...
  <cfset salestatus = 3>
      <CFQUERY DATASOURCE="gemssql" NAME="GetList">
      select lastbought, disporder, newitem, CAT, storage, thumblink, imagelink, subcat, NameID,    size,   price      , saleprice, status, wholesaleprice, Description, subcat, inventory, buylink from Items 
      where (1=1  <cfif isdefined("session.bulkbuyer.id")> and wholesaleprice >0</cfif>     <cfif advancedsearch is "">
        and (CAT = '#category#' 
         )
      </cfif>
      <CFIF salestatus is 3>
	  ...
	  <CFLOOP QUERY="Getlist"		startrow="#start#"	endrow="#enddisplay#">
        ...
        <td class="rowb" valign=top  > 
          ...
          <table border=1 ><tr height=120><td bgcolor=black  height=120>
...
<a href="np/match/cluster.cfm?list=1&target=#newitem#&category=#cat#">Ad2Clus</a>
			...
			<cfswitch expression="#status_array[column]#">
                  ...
                  <b>Details / Buy</b></a>&nbsp;&nbsp;&nbsp;#price_array[column]#, #size# mm</font>
				  <br /><br> </cfcase>
				  <cfcase value="0"><font color="##000099"><a href='gem_stone_#cat#.cfm/#item_array[column]#.htm' >
                  <b>Details</b></a>&nbsp;&nbsp;&nbsp;#price_array[column]#</font>&nbsp; <br />&nbsp;<font color="##FF4444">
				  Sold Out</font>
				  <!---<a href='gem_stone_#cat#.cfm/#item_array[column]#.htm' ><font color="##CC3300">Order</font></a>--->
                    </cfcase>
               <cfdefaultcase >
			   <a href='gem_stone_#cat#.cfm/#item_array[column]#.htm'  > 
...
<br /><a href='gem_stone_#cat#.cfm/#item_array[column]#.htm' ><font color="##CC3300">Buy</font></a></cfdefaultcase>
				  </cfswitch> </td>	
...
<tr> 
			  ...
			  <CFIF start is not "1">
                 ...
                 <cfelse>  </CFIF><!---  <a href="topselling.cfm" >Best Selling!</a> 
&nbsp;&nbsp;&nbsp;&nbsp;
...
<cfset rowsdisplayed = 1>
				   ...
				   <a href=laptopcases.cfm><img src=http://www.semiprecious.com/images/bags/thumb/7523.jpg></a><br>
				   <a href='laptopcases.cfm'><font color=orange size=+1>Now shop within this sites shopping cart, designer novel handmade laptopbags</font></a>
				   </td></tr>
...
<table cellpadding="0" bgcolor=white   align="right" cellspacing="0" style="horizontal-align:right;text-align:right;text-transform:capitalize;border:1px <cfoutput>#light# ridge;border-left:solid 1px #light#</cfoutput>; ">
  <TD> <cfif category neq 'beads'><script type="text/javascript"><!--
...
<tr><td>
<cfinclude template="beads/beadsbycolor.htm">
</td></tr>		  <tr><td>&nbsp;</td></tr>
...
<form action="semiprecious-stone-beads.cfm" name="pearlform" method="get" style="display:inline;">
...
<tr bgcolor="white"  >
    ...
    <td align="center" valign="middle"  > 
        <cfinclude template="adminfooter.cfm">
		  ...
		  <!---<cfinclude template="googleadsforlist.htm">---></cfif>
             </td> </tr></cfif>
    </table>
