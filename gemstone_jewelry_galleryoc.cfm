...
<CFINCLUDE TEMPLATE="setup.cfm">
 		<cfif cgi.server_name IS "www.wholesale-gemstone-jewelry.com" or cgi.server_name IS "wholesale-gemstone-jewelry.com" or isdefined("session.bulkbuyer.id")>
		...
		<cfelse>
			<cfif dateformat(now(),"dddd") eq "Sunday"> 
				...
				<CFPARAM NAME="url.sortorder" DEFAULT="datetaken asc" >
				...
				<CFPARAM NAME="url.sortorder" DEFAULT="lastbought asc" >
				<cfelse>
				<CFPARAM NAME="url.sortorder" DEFAULT="datetaken" >
			</cfif>
		</cfif>
...
<TR><TD> 
<cfif category neq 'beads' and server_name neq "www.ornamentscollect.com">
...
<tr bgcolor="white"  >
    ...
    <td align="center" valign="middle"  > 
        ...
        <cfif cgi.server_name neq "www.ornamentscollect.com"> <font size=+3>NEW NEW NEW - BEADS LAUNCHED ON SEMIPRECIOUS.COM <a href='beads.cfm'>CLICK HERE</a></cfif>
