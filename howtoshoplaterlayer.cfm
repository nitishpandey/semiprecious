...
<div style="font-family:Arial;font-size:14px;font-color:blue;padding:4px;visibility:hidden;width:440px;background-color:white;border:2px ridge black;">
<p><span style="font-weight:bold">How to continue shopping  later ?</span><br>
  ...
  When you return to shop  from same or different computer you can <span style="background-color:orange">use this cart id to fill 
