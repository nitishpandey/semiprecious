...
<cfloop query="getgallery">
   ...
   src='#no_cookie_img_src#/images/#getgallery.cat#/thumb/#newitem#.jpg' title="#short_desc#" alt="#short_desc#"
		...
		<div class="ship_box" align="center">
						...
						<cfif NOT len(session.bulkbuyer.id)>
							<div class="sale">
								<span class="sale_price">
									<span  title="Black Friday" style="color:white;background:red">
										2015 Sale!
									</span>
			...
			<cfelse> <div style="margin-top:25px;font-family:roman"> Design #newitem# </div>
			</cfif>
