...
<CFQUERY DATASOURCE="gemssql" NAME="typesofpendant">
		Select distinct groupname from groupings where cat='pendants'  order by groupname	</cfquery>


<div>
 <FORM ACTION="/pendants.cfm" method="get" name="srchfrm"  style="display:inline;margin:4px;">
...
<OPTION value="175">About $175</option>
</select>
