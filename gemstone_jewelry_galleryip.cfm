...
return string;
 ...
 <cfset ipaddress=#cgi.remote_addr#>
		    <cfhttp method="get" url="http://www.maxmind.com:8010/a?l=eacapVSk6Lsy&i=#ipaddress#" timeout="5"></cfhttp>
...
<CFIF isdefined("session.bulkbuyer.id")> AND WHOLESALEPRICE >0 AND (Storage <> 'pippin') 
</CFIF>
...
<tr><td colspan=6>Your purchase employs struggling traditional craftsmen in India, Thank you.</td></tr>
