...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
 <CFPARAM NAME="displaycolumns" DEFAULT="4"><CFPARAM NAME="display" DEFAULT="40">
...
<HTML>
<HEAD>
<TITLE>Buy Jewelry, Necklaces, Bracelets, Earrings of India Buy Wholesale. <CFOUTPUT >#subcat# 
  #category# </CFOUTPUT> from Beaded Jewelry Designs</TITLE>
<meta name="description" content="<CFOUTPUT>#subcat# #category#</CFOUTPUT>,
...
<table align="center" width=100%>
	...
	<td valign=top align=left>
		...
		<CFSET invent=inventory>
              ...
              <td class="row1" valign="top" align='center'  width=200> 
                <!----			<CFIF getList.status is 3> --->
                <CFIF getList.saleprice is "" or getList.Saleprice eq 0>
                  <CFSET Saleprice = 0.80*price>
                </cfif> <cfif not isdefined("url.filter")> <a href='detail.cfm/#newitem#.htm?filter=#urlencodedformat(QUERY_STRING)#'>	
                <cfelse><a href='detail.cfm/#newitem#.htm?filter=#urlencodedformat(url.filter)#' > </cfif> 
			...
			<a href='detail.cfm?subcategory=#subcat#&category=#getList.cat#&newitem=#newitem#&price=#price#&description=#URLEncodedFormat(description)#&newitem=#newitem#&invent=#invent#'>
                ...
                <img src = 'images/<cfif getlist.cat is "sets">necklaces<cfelse>#lcase(getlist.cat)#</cfif>/thumb/#newitem#.jpg'  border='0' bordercolor='black'  name="img#newitem#" alt="image of #subcat# #category#"></a><br> 
                <font verdana size='1'> 
                <cfif status is 3 and session.mail neq 'pandey@aol.com'>
                  <img src=images/sale.gif width="80" height="120"> <B>#dollarformat(saleprice)#</B>&nbsp;Regular 
                </cfif>
                <!--- 
			<b><font color="##000080">#Dollarformat(price)#</font></b><br><font face="Verdana" verdana size="1">
			#description#</font> --->
                <br>
                ...
                <cfif inventory is 0>
                  <font color='red' size='2'>Sold Out!</font> 
                </cfif>
                <!--- <font verdana size='2'>
		...
		<td class="row2">#descr_array[Indx]#<br /><font color="##000099">#price_array[indx]#</font>,<font verdana size='2'>
			<cfif not isdefined("url.filter")>
			<a href='detail.cfm/#item_array[Indx]#.htm?filter=#urlencodedformat(QUERY_STRING)#' >
			<cfelse>
			<a href='detail.cfm/#item_array[Indx]#.htm?filter=#urlencodedformat(url.filter)#' >
			</cfif>
			<b>Zoom/Buy</b></a></font></td>
		</cfloop>
		</tr>
		<tr><CFSET columns=1>
		<!---</table>
...
<CFSET columns=0>
<!--- code of 19 aug 04 --->
<cfoutput><td colspan="#displaycolumns#">&nbsp;</td></cfoutput>
</tr></table>
</cfif>
<CFIF (#GetList.cat# is "Sets")>
<CFSET #category# = "Sets">
...
<CFIF #Evaluate(start + display-1)# LT #GetList.Recordcount#>
<a href='struclist.cfm?category=#category2#&start=#evaluate(start + display)#&sortorder=#sortorder#&subcat=#URLEncodedformat(subcat)#&color=#color#&&priceless=#priceless#&pricegreater=#pricegreater#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#'><b><font size=4>Next <i>#evaluate(GetList.recordcount-enddisplay)#</i> <font color=red>more</font></font><b></a>
<CFELSEIF start is not "1">
<a href='struclist.cfm?category=#category2#&start=1&sortorder=#sortorder#&subcat=#URLEncodedformat(subcat)#&color=#color#'>Show First Page</a>
</CFIF>
<br>
      <font size="2" face="Arial, Helvetica, sans-serif">&nbsp;</font>&nbsp;<br>
</CFOUTPUT> 
