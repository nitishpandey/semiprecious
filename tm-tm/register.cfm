...
<cfinclude template="tmheader.cfm">
 <cfif listfindnocase("leena,anup,ravi,nitish",session.apptt)>

<div align="center"><table class="table1" width="100%"><tr>
      <td height="397" align="center" nowrap> 
...
<!---  User <cfoutput>#form.apptt# registered with the password #form.password1#</cfoutput>.
    ...
    <cfelse>
   <table><tr style="background-color:white;padding:2px"><td> you are not authorised to register a new user. Please contact nitish. Thank you.
   </td></tr></table>
    </cfif>
