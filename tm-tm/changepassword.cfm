...
function validateForm()
 ...
 {
 alert("Your New Password are not big!");
 return false;
 }
 return true;
 }</script>
...
<cfif form._email neq form.email>
	  <cfinvoke component="cfc.registrar" method="change" returnvariable="answer">
			  <cfinvokeargument name="tablefield" value="emailaddress">
			  <cfinvokeargument name="newvalue" value="#form.email#">
	   </cfinvoke>
</cfif>
	  </cfif>
        ...
        <table width="51%" border="1" cellpadding="2">
          ...
          <tr> 
		   ...
		   <tr> 
            ...
            <td>:
			<cfinput type="hidden" name="_email" bind="cfc:cfc.registrar.get(tablefield='emailaddress')" bindonload="yes" />
              <cfinput required="no"  type="text" name="email" bindonload="yes"  bind="cfc:cfc.registrar.get(tablefield='emailaddress')"></td>
            <td><input type="submit" name="Submit" value="Submit"></td>
          </tr>
            <tr > 
