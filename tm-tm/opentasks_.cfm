          ...
          <cfif isdefined("url.actionby")>
            ...
            <cfoutput query="globalviewRet"> 
              ...
              <tr class="#status#" > 
                ...
                <td>#subject#<a href="taskdetails.cfm?by=#tby#&doi=#urlencodedformat(tdtoi)#">View Details</a>/<cfif task_type is "cart_issue"><a target="cart" href="/itemsell.cfm?cartid=#subject#">View Cart</a></cfif>&nbsp;
