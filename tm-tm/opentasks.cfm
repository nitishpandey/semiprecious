...
<div align="center"><table class="table1" width="800"><tr>
     ...
     <table width="100%" border="1" cellspacing="0" cellpadding="1">
         <cfoutput>
	            ...
	            <td ><a href=http://www.semiprecious.com/tm-tm/opentasks.cfm?type=#url.type#&amp;&amp;order=0&amp;orderby=tdtoi>Initiated Date</a></td>        
	    ...
	    <cfinvoke  component="tm.cfc.task" method="globalview" returnvariable="globalviewRet">
          ...
          <cfif isdefined("url.actionby")>
            ...
            <cfoutput query="globalviewRet"> 
              <cfif pdc LTE createodbcdate(Now())>
                <cfset bc = 'red'>
                <cfelse>
                <cfset bc = 'blue'>
              </cfif>
              <tr class="#status#" > 
                ...
                <td>#subject#<a href="taskdetails.cfm?by=#tby#&doi=#urlencodedformat(tdtoi)#">View Details</a>/<cfif isnumeric(subject)><a target="cart" href="/itemsell.cfm?cartid=#subject#">View Cart</a></cfif>&nbsp;
				<br />[#left(detail,60)#]...&nbsp;</td>
                <td>#Action#&nbsp;</td>
          ...
          <cfinvoke  component="tm.cfc.task" method="globalview" returnvariable="globalviewRet">
            ...
            <cfoutput query="globalviewRet"> 
              ...
              <tr class="#status#" > 
				...
				<td>#tby#</td>
                <td>#subject#<a href="taskdetails.cfm?by=#tby#&doi=#urlencodedformat(tdtoi)#">View Details</a><cfif task_type is "cart_issue"><a target="cart" href="/itemsell.cfm?cartid=#subject#">View Cart</a></cfif>&nbsp;</td>
                <td>#Action#&nbsp;</td>
                <td><a href="pdchistory.cfm?by=#tby#&doi=#urlencodedformat(tdtoi)#"><font color="#bc#">#dateformat(PDC,'dd/mm/yyyy')#</font></a>&nbsp;</td>
                <td>#info#&nbsp;</td>
                <td>#status#</td>
