...
<cfparam name="session.tm.task_list_filter" default="order=0&orderby=action&amp;actionby=#session.apptt#" />
            ...
            <cfoutput> 
              <table width="100%" border="1" cellspacing="0" cellpadding="1">
                <tr> 
                  ...
                  <td>  
                    <cfif (session.apptt is by) or (session.apptt is action)>
