...
<cftry>
  ...
  NameID,     price  , saleprice, status, wholesaleprice, Description, inventory,
   buylink ,  iif(status=3, saleprice,price) as orderprice from Items where  (inventory>#invstatus#
  ...
  <CFIF advancedsearch is not "">
    UNION SELECT 1 as orderbuy, disporder,newitem, CAT, subcat, datetaken, NameID,       price    , saleprice, status, wholesaleprice, Description, inventory, buylink, iif(status=3, saleprice,price) as orderprice from Items where (inventory>#invstatus#
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#'             )
      </CFIF>
  ...
  <CFIF advancedsearch is not "">
    UNION SELECT 2 as orderbuy, disporder, newitem, CAT, subcat, datetaken, NameID,       price    , saleprice, status, wholesaleprice, Description, inventory, buylink, iif(status=3, saleprice,price) as orderprice from Items where (inventory>#invstatus#
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#' 
     )
  ...
  <CFIF advancedsearch3 is not "">
    UNION SELECT 3 as orderbuy,  disporder, newitem, CAT, subcat, datetaken, NameID,       price    , saleprice, status, wholesaleprice, Description, inventory, buylink,iif(status=3, saleprice,price) as orderprice from Items where (inventory>#invstatus# 
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#' 
         )
  ...
  <CFIF advancedsearch1 is not "">
    UNION SELECT 4 as orderbuy,disporder, newitem, CAT, subcat, datetaken, NameID,      price    , saleprice, status, wholesaleprice, Description, inventory, buylink, iif(status=3, saleprice,price) as orderprice from Items where (inventory>#invstatus# 
    <cfif advancedsearch is "">
      <CFIF category NEQ "ALL">
        and (CAT = '#category#' 
      )
...
<cfif isdefined("form.submit5")>
  <CFQUERY DATASOURCE="semiprecious" NAME="GetList">
  select disporder, newitem, CAT, subcat, NameID,     price  , saleprice, status, wholesaleprice, Description, subcat, inventory, buylink  iif(status=3, saleprice,price) as orderprice from Items 
  <cfif isdefined("form.submit5")>
    where (saleprice 
    ...
    <cfif subcat eq 'silver' or isdefined("url.silverjewelry") or listfindnocase(evaluate('application.silver.#category#tones'),subcat)>
      <cfif len(cgi.QUERY_STRING)>
        ...
        <cfif subcat neq 'silver' and listfindnocase(evaluate('application.silver.#category#tones'),subcat)>
          <span style="display:inline;padding-left:2px;border-right:1px black ridge;border-left:1px black ridge;padding-left:2px;width:799px;padding-right:1px;">
		  <span class="biggreen">Silver 
            Filter:</span><cfif isdefined("url.silverjewelry")> 
			<cfif url.silverjewelry> 
            <font color="maroon">Showing Sterling Silver #subcat# #p#</font><font color="##666600">&nbsp;|&nbsp;</font> <a href="list.cfm?#cleanedqSTRING#&silverjewelry=0"> 
            <font color="black">Check for non-Silver #subcat# #p#</font></a> 
            <cfelse>
            <a href="list.cfm?#cleanedqSTRING#&silverjewelry=1"><font color="black">See 
            #subcat# #p# in Sterling Silver</font></a> <font color="##666600">&nbsp;|&nbsp;</font><font color="maroon">Showing 
            NON-Silver #subcat# #p# <font></font> </cfif> 
            <cfelse>
            <a href="list.cfm?#cleanedqSTRING#&silverjewelry=1"><font color="black">See 
      ...
      </form>&nbsp;|&nbsp;<form action="list.cfm?silverjewelry=0&category=#p#" method="get" style="display:inline;" >     
...
<cfelse>Member: #session.mail#</cfif>
    </cfif>
...
<cfset display = displaycolumns*displayrows>
 ...
 <table style="margin-left:93px;display:block;width:#tw#;position:relative;top:2px;"  border="0" cellspacing="0" >
    <tr   class="topnavigator"><td valign="top" align="center" style="border-left:1px black ridge; border-top:1px black ridge;border-right:1px black ridge;">
...
<cfset displaycolumns = 2>
    ...
    <div style="position:relative;margin-left:93px;margin-top:30px;border:1px black inset;text-align:justify;"> 
      ...
      <br>
      To see and order out of stock items in this section please click here <a href="list.cfm?invstatus=-3&&category=#category#&subcat=#subcat#&advancedsearch=#urlencodedformat(advancedsearch)#">SEE 
	 ...
	 <cfif start is 1 >
               	<table cellspacing="0" style="margin-left:93px;display:block;width:#tw#;border-left:1px ##666600 groove;border-right:1px ##666600 groove">
...
<cfif category is 'ornaments'>
	...
	<Tr valign="middle"><td valign="middle" style="color:##666600"> 
	  ...
	  <CFLOOP QUERY="Getlist"	>
			 ...
			 <CFINCLUDE TEMPLATE="jumpstart.cfm"></cfif>
   <table style="margin-left:93px;display:block;width:#tw#;border-left:1px groove ##666600;border-right:1px groove ##666600;border-bottom:1px ridge ##CCCCCC;">
	...
	<CFELSE>
          ...
          <!---  <cfset price_array[columns] = #format(price)#> --->
          <cfset descr_array[columns] = description  />   <CFIF Edit Is "MAMAMIA">
       ...
       </td>	<td class="row2">#descr_array[columns]#</td>	
...
<cfif isdefined("url.silverjewelry")>
  ...
  <!---  <script type="text/javascript"><!--
   ...
   --->            </td> </tr></table>
 	   <table width="#tw#"   style="margin-left:91px;"BORDER=0>
		 <tr bgcolor="white"  >
      <td align="center" valign="middle"  style="row3"  >&nbsp;  <a href="http://www.myexhibition.com" class="error1" target="artwindow">Love Art?</a> </td>
	...
	<table style="position:absolute;top:124px;left:0px;display:inline;" ><tr ><Td>
		 <span  class="leftstonelist"  >
		 <span style="width:88px;border-right:1px black ridge;border-top:1px black ridge;">
<span class="category">#p#<br>
              Available In</span></span></span>
