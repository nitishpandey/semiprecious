...
<cfset ShippingOverseas=decimalformat(orderweight.orderweight*0.12)>
...
document.cartform.SpecialHandling.options[1]=new Option("Priority Mail $14.99","14.99");
				...
				<tr>
					...
					<tr>
                    	...
                    	<td>
                            ...
                            >
														<div id="totalsbox" style="position:relative;left:100px;font-size:14;font-color:black;font-weight:bold;"><cfoutput>#dollarformat(subtotal)#</cfoutput></div>
                        </td>
                    </tr>
					<tr>
                    	<td align="right">
...
<cfinclude template="/includes/countries_drop_down.htm" />&nbsp;
			    ...
			    <tr>
                	<td  align="right"><b>Email(<span class="form_heading">required</span>): </b></td>
                	<td  align="left">
...
<option value="">Select Shipping</option>
              ...
              <cfoutput>
               ...
               <cfif IsDefined('session.mail') AND session.mail neq ''>
				...
				<tr><td colspan="2" bgcolor="##603082" style="color:##FFFFFF" height="24px"><strong>Shipping Details.. <cfif IsDefined('session.mail') AND session.mail neq ''><br>{Same As Registered ?}<input type="checkbox" name="sameas" id="sameas" onClick="fnFillForm(this);" style="background-color:##603082;border-color:##603082"></cfif></strong></td></tr>
            	  ...
            	  <table style="border-collapse:collapse" align="left" border="0">
					...
					<tr>
                    	...
                    	<td>
                        	<div style="position:relative;top:10px"><input type="text"  style="font-size: 14px;" name="x_ship_to_city" id="x_ship_to_city" maxlength="50" size="20"
                            <cfif IsDefined('session.x_ship_to_city')>
                                value = "#session.x_ship_to_city#"
                            </cfif>
                            > </div><div id="totalsbox" style="position:relative;floating;left:300px;font-size:22;font-color:black;font-weight:bold;">YOUR ITEMS TOTAL:<cfoutput>#dollarformat(subtotal)#</cfoutput></div>
                        </td>
                    </tr>
					<tr>
                    	<td>
                    	...
                    	<td>
                        	<div style="position:relative;top:-10px"><input type="text"  style="font-size: 14px;" name="x_ship_to_state" id="x_ship_to_state" maxlength="50" size="20"
                            <cfif IsDefined('session.x_ship_to_state')>
                                value = "#session.x_ship_to_state#"
                            </cfif>
                            ></div>
                ...
                <tr>
                	<td  align="left" height=30> <b>Shipping Options</b>: <br />
                	</td>
                	<td  align="left" >
                    <div id="tdShipInfo">
                        <select name="SpecialHandling" id="SpecialHandling">
			  ...
			  <cfelse>
			  <tr>
           	    <td align="left"><b>Email</b><cfif 1 or url.country eq "USA">(<span class="form_heading">required</span>)</cfif>: </td>
                
					<td  align="left">
					<cfif url.country neq "USA">
              				<cfinput required="true" message="Please provide a valid email id."  type="text" name="email" value="" size="40">
						<cfelse>
         					<cfinput required="true"   type="text" name="email" value="" size="40">
		  			</cfif>
							</td>
              	</tr>
              </cfif>
...
<span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=hF33DTtyM65nCwzDN0SwqGGgTQPxn3o4Ym0uzkuDY7OQkc0HNahexOlJ"></script>
--->
		   <span style="color:red;">Coupon or Gift Code (If Any):</td><td> <input name="couponcode" type="text" class="detail" value="" size="12" maxlength="18">   &nbsp;&nbsp;&nbsp; Agent Code, if any: <input name="agentcode" type="text" class="detail" value="" size="12" maxlength="8"><br />	    
</td>
      </tr>
			      <tr>
