...
<CFINCLUDE TEMPLATE="leftmenus.cfm">
     ...
     <!---  <CFINCLUDE TEMPLATE="hubs-byrows.cfm">--->
     <CFINCLUDE TEMPLATE="hubs-bythemetest.cfm"> 
  ...
  <table width="800"    align="center" border="0">
    ...
    <!--- Start BBB row --->
    <tr>
      <td colspan="2"><table cellpadding="0" bgcolor=white   align="right" cellspacing="0" style="horizontal-align:right;text-align:right;text-transform:capitalize;border:1px <cfoutput>#light# ridge;border-left:solid 1px #light#</cfoutput>; ">
          <tr>
            <td align="center"><a href=/designer_jewelry_angela.cfm>Designer Section</a><br />
              <a href="/showsets.cfm"><u>Matching Sets</u></a> </td>
