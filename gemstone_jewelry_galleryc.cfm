				...
				<table align="center" cellspacing="0" border="0" cellpadding="3" style="margin-top:1px;background-color:##FFFFFF;">
					...
					<tr class="greenbutton"  align="center">
						<td colspan=2 align="left" style="border-top:2px ridge #dark#">
							...
							[#getlist.recordcount# Designs]&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp; <cfif url.sortorder neq 'lastbought desc'><a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=lastbought'>Purchased by others</a><cfelse><a href='gemstone_jewelry_gallery.cfm?category=#category#&sortorder=pricedesc'>Premium Items First</a></cfif>
						</td><cfif url.sortorder  is "lastbought"><cfset url.sortorder = 'lastbought desc'></cfif>
						...
						<td colspan="3" align="center"  valign="middle"  class="greenbutton" style="border-top:2px ridge #dark#">
							<cfif find('price',url.sortorder)>
								<a href='gemstone_jewelry_gallery.cfm?priceless=#priceless#&#sj#&category=#category#&sortorder=datetaken&subcat=#subcat#&color=#color#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#'><font color="black">Latest Additions</font></a>
							<cfelse>
								<a href='gemstone_jewelry_gallery.cfm?priceless=#priceless#&#sj#&category=#category#&sortorder=price&subcat=#subcat#&color=#color#&salestatus=#salestatus#&advancedsearch=#URLEncodedformat(advancedsearch)#'><font color="black">Sort On Price</font></a>
							</cfif>&nbsp;&nbsp;&nbsp;<a href="##" onMouseDown="ShowHide('jumpstart'); return false;" style="color:black;">Pages</a>
						...
						<td class="rowb" style="border-left:1px solid black;" width="30%" onClick="hideAll(); div#itemCount#.style.display = 'block';">
							<cfsavecontent variable="smallContent">
								...
								<CFIF Edit Is "MAMAMIA">
									...
									<cfif url.subcat is "">#subcat#</cfif>	<br>#price_array[columns]#
							</cfsavecontent>
