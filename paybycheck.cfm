...
<h2 style="float:left;margin-left:1180px;top:50px">Pay By Cheque</h2><br /><br />
...
<cfmail server="MailA40.webcontrolcenter.com" from="#trim(form.contact)#" to="anup@semiprecious.com,semiprecioushelp@gmail.com" subject="Check payment at semiprecious.in"  >
...
<br>
  <div class="details"> 
    <p>Your payment details recorded. The items in your cart will be reserved 
      for you for next 9 days.<br>
      <br />
      Check or Draft in favour of <strong>Pragati Exports</strong> should be mailed to :<br>
B-67 triveni nagar<br>
Near gopalpura bye pass<br>
...
The discount code/coupon code will be generated for you now</strong> when you submit the form given
    ...
    1)  The check or DD  should be for <cfoutput>#format(url.amt)#</cfoutput> in favour of  Pragati Exports, payable at Jaipur. Please mention your cartid and name behind the cheque.
      Mail the Check/DD to:  <p>
	<div align=center><b> B-67 Triveni Nagar<br>
	 Near gopalpura by-pass<br>
	 Jaipur 302018<br>
Rajasthan<br></b></div>
 <p>
