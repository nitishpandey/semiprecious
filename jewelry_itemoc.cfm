...
<CFIF cgi.server_name eq "63.135.126.234" or cgi.SERVER_NAME eq "www.ornamentscollect.com" >
					Call 410-988-3808<br> to buy for

	<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_xclick">
<input type="hidden" name="business" value="anup@semiprecious.com">
<input type="hidden" name="item_name" value="#newitem#">
<input type="hidden" name="amount" value="#format(price)#">
    ...
    <cfset catp =	session.filterarray[prevpos][2]>
 	...
 	<a href='/jewelry_item.cfm/#nextpos#_#catn#.htm?thiswidth=#width#'  ><img  src="/images/#catn#/thumb/#nextpos#.jpg" border="1"  name="nimg" hspace="0" vspace="0"  alt="Next" height="#variables.ht#"   >
            ...
            <tr valign="top" > 
			  ...
			  <cfif category is 'beads'> ** Unless specified all strands are 16 inches.</cfif>
