...
<cfinclude template='india_jewellery_online.cfm'>
<cfabort>
</cfif>
...
<cfoutput>
  <TITLE><cfif url.start GT 1>Gallery starting from #url.start#th item. </cfif>#titlecase(metatitle)# <cfif ringsize neq "">Rings #ringsize# </cfif><cfif cgi.server_name contains 'wholesale'>Wholesale </cfif>#titleCase(subcat)# #style#<cfif color neq ""> #titleCase(color)#</cfif> <cfif groupname neq ""> #titlecase(groupname)#</cfif> </TITLE>
  <cfif occasion eq "oos"><meta name="robots" content="noindex,nofollow"></cfif>
	<meta name="keywords" content="<cfif cgi.server_name contains 'wholesale'> Wholesale</cfif><cfif color neq "">#color# </cfif><cfif subcat neq "">#subcat# </cfif><cfif groupname neq "">#groupname# </cfif> #p#, #metakeywords#">
...
<cfif category is "jewelry"><cfif url.category neq ""><cfset category=url.category><cfelse><cfset category=""></cfif></cfif>
...
<cfif priceless neq ""><cfset sortorder='price desc'> <cfset url.sortorder =sortorder></cfif>
<!--- <cfoutput>url.sortorder is #url.sortorder#</cfoutput> --->
...
<!---	<cfif not find( expand ,Form.search_criteria)>
	...
	<cfset occasionmenu = "Searched #form.search_criteria#"/>
...
<cfoutput>
	  ...
	  <meta name="description" content="Our <cfif p is 'jewelry' or p is 'necklaces' or p is 'pendants'>handcrafted<cfelse>handmade</cfif> <cfif groupname neq ""> #groupname#</cfif><cfif color neq ""> #color# gemstone</cfif><cfif subcat neq ""> #subcat#</cfif> #p# <cfif p is "jewelry">comes<cfelseif p is "healing"> items come<cfelse>come</cfif> in many varieties. We are your source for<cfif groupname neq ""> #groupname#</cfif><cfif color neq ""> #color# stone</cfif><cfif subcat neq ""> #subcat#</cfif> #p# in silver, beads, necklaces, pendants, rings, earrings, bracelets & healing.<cfif url.start GT 1>Gallery starting from #url.start#th item.</cfif>">
</cfoutput>
...
LABOR DAY SALE <span style="padding:10;background:black">30% off all items!</span></div>--->
  <cfset tw =  606>
  <div id="container2">
  <h1  align="center" style="font-size:12;font-weight:bold;font-color:gray;width:928px;margin-top:4px;height:22px;" nowrap >&nbsp;
        ...
        <cfif len(advancedsearch)>
            ...
            <Cfif isnumeric(priceless)>
              &nbsp;Around #format(priceless)#<img src="/images/arrow_right.gif" style="display:inline;" border="0" hspace="0" vspace="0" align="absmiddle"  title="jewelry gem stone selection" width="15" height="15" /><a href="#currentfile#?sortorder=#urlencodedformat(sortorder)#&priceless=#priceless#&pricegreater=#pricegreater#&color=#color#&category=pendants" id="pendants_horiz">Pendants</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?sortorder=#urlencodedformat(sortorder)#&pricegreater=#pricegreater#&priceless=#priceless#&color=#color#&category=rings" id="rings_horiz">Rings</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?sortorder=#urlencodedformat(sortorder)#&pricegreater=#pricegreater#&priceless=#priceless#&color=#color#&category=Earrings" id="earrings_horiz">Earrings</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?priceless=#priceless#&color=#color#&category=Bracelets&sortorder=#urlencodedformat(sortorder)#" id="bracelets_horiz">Bracelets</a>&nbsp;<a href="gemstone_jewelry_gallery.cfm?sortorder=#urlencodedformat(sortorder)#&pricegreater=#pricegreater#&priceless=#priceless#&color=#color#&category=Necklaces" id="necklaces_horiz">Necklaces</a>&nbsp;<br />
						...
						<b>#titlecase(style)# #titlecase(subcat)##titlecase(color)# Gemstone #titlecase(groupname)# #titlecase(categ)# <cfif style is ""> in Sterling Silver or Beaded</cfif></b><br>
            <cfif len(trim(subcat)) >
						
			                <cfset subcat3 = replace(trim(replace(trim(subcat),"_",""))," ","")>
			              <img src="/images/dots1.gif" style="display:inline;" />
						<a href="/#subcat3#.cfm" id="jewelry" title="jewelry from this stone">#subcat# home</a>&nbsp;&nbsp;&nbsp;<img src="/images/dots1.gif" style="display:inline;" />
			    
						<cfif listfindnocase(Application.cufflinkstones,subcat)>
			              <a href="/#subcat3#_cufflinks.cfm" id="cufflinks_horiz" title="cufflinks of this stone">#subcat# cufflinks</a>&nbsp;<img src="/images/dots1.gif" style="display:inline;" />
			              </cfif>
            ...
            <cfif category EQ "All" >
              <span style="color:maroon;background-color:#light#;font-size=12 px;">All Categories</span>&nbsp;
            </cfif>
						</cfif>
          </cfif>
          &nbsp;  
	...
	<cfif pricegreater neq 0 or priceless neq "">
            ...
            <cfelse>
                <!--- <span style="font-weight:bold;font-family:verdana san serif,color:purple;font-size:16px;"> --->
                    ...
                    <!--- <cfloop list="#kws#" delimiters="_-/" index="kw"> ---><!--- </cfloop> ---> 
                <!--- </span> ---> 
            </cfif>
	  </cfif> 
	  </span>
...
<cflocation URL="#cgi.sever_name#/sterling-silver-jewelry.cfm">
     <div  style="margin-top:10px;margin-left:50px;padding:20px;border : 1px solid #ECCCC;	width:627px;text-align:justify;font-size:12px;color:maroon;">
     	<cfoutput>
     OOPS! Sorry, we are out of #subcat# #category# #advancedsearch# #color# 			 <cfif salestatus is 3>
			 on sale
			 </cfif><cfif pricegreater GT 0>
			 #format(priceless)# to #format(pricegreater)#.</cfif>  <br />
...
<cfabort />
	 ...
	 <cfif (Not len(session.name) or session.mail eq application.admin_email) and start lt 2>
					<br><br>
          <cfoutput>
       		<div align="left" style="width:100%; border-collapse:collapse; border:thin;position:relative;top:-20px">
                  <span style="font-family:verdana san serif,color:purple;font-size:12px;">
                      #contentbypage.description#
                  </span>
              </div>
          </cfoutput>
		</cfif>
...
<div align="left" style="margin-left:5px;">  
	<br>	<b><font size=+1 color=purple>Showing:</b> <cfoutput>#Getlist.recordcount# <font <cfif color neq 'white'>color=#color#</cfif>>#titlecase(color)#</font> #titlecase(subcat)#<cfif groupname neq ""> #titlecase(groupname)#</cfif> #titlecase(url.style)# <cfif len(category) GT 3> #titlecase(category)#<cfelse> Items</cfif><cfif pricegreater neq "0"> Over #format(pricegreater)#</cfif><cfif priceless neq ""> Under #format(priceless)#</cfif>
		</cfoutput></font>&nbsp; 

 <cfinclude template="/includes/searchdropdowns.cfm" /> <cfif subcat neq "" or groupname neq "" or pricegreater neq "0" or priceless neq ""><a href=<cfoutput>#GetFileFromPath(GetBaseTemplatePath()
)#</cfoutput>
...
<cfoutput><cfif occasion is 'oos'>OUT OF STOCK ITEMS, REQUEST REMAKING FROM ZOOM PAGE</cfif></cfoutput>
</cfif>
...
<div align="center" id="cart_summary" style="z-index:6;"></div>
  ...
  --->
    ...
    <tr>
		<td>
    		<table id="container1" width="910px" cellspacing="0" cellpadding="0" border="0"  style="padding:0 2px 0 2px" align="center">
    			<tr>
                    <td valign="top">
   						...
   						<div style="float:left;display:inline;width:158px;">
							...
							<cfif category neq 'gems' and category neq "cufflinks">
					 			<CFINCLUDE TEMPLATE="leftmenus.cfm">
					 		</cfif><!---<p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p>
<cfif session.country neq 'india'>							
...
<cfinclude template="/includes/grouplist.cfm">
	...
	<div align="center" id="cart_summary" style="z-index:6;"></div>
        ...
        <tr>
            <td>
                <table id="container1" width="900px" cellspacing="0" cellpadding="0" border="0"  style="padding:0 2px 0 147px" align="center">
                    <tr>
                        <td>
                            <div align="center" style="margin-top:30px;">
                                <!--- Paging links --->
...
<div>						 <cfoutput> <a href="http://#cgi.server_name#/admintools/contentadder.cfm?pagename=#right(currentfile, len(currentfile)-1)#">Contend Edit</a></cfoutput>
</div
</cfif>
</div><!---
			 							      <cfinclude template="/googleadsforlist.htm">--->
